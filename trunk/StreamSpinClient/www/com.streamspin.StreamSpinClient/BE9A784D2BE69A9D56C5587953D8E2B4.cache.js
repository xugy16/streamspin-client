(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var m='',Cb=' ',ge="' border='0'>",ce=') no-repeat ',D=', Size: ',Bc='-',qc='0',ld='0.0',ad='0px',u='100%',A='1000px',x='100px',p='1px',Ed='4BF90CCB5E6B04D22EF1776E8EBF09F8.cache.png',xd='50%',dd='548CDF11D6FE9011F3447CA200D7FB7F.cache.png',B=':',zd='<\/div>',yd="<div class='vsplitter' style='text-align:center;'>",ee="<img src='",Bb='BODY',vb='DOMMouseScroll',C='Index: ',s='Item one',t='Item two',ib='JavaScriptObject$;',gb='Object;',w='This is some contence that should show how the widget handles stuff, wwwwwwwwwww wwwwwwwwww wwwwwwwwww wwwwew rw er',eb='Widget;',hb='[Lcom.google.gwt.core.client.',cb='[Lcom.google.gwt.user.client.ui.',fb='[Ljava.lang.',gc='absolute',uc='align',nd='alpha(opacity=0)',Bd='auto',id='background',Cc='blur',gd='border',qb='border-left-width',rc='border-top-width',mc='bottom',z='buhu',ac='button',sc='cellPadding',pc='cellSpacing',kc='center',hd='change',Ab='className',fe="clear.cache.gif' style='",sd='click',bb='com.streamspin.client.StreamSpinClient',wb='contextmenu',Dd='dblclick',hc='div',tb='error',md='filter',n='focus',bc='gwt-Button',jc='gwt-HTML',ic='gwt-Label',wc='gwt-ListBox',Ac='gwt-MenuBar',vd='gwt-TextArea',wd='gwt-VerticalSplitPanel',pd='height',q='hidden',bd='hideFocus',Ec='horizontal',xb='html',he='input',y='keydown',db='keypress',jb='keyup',Db='left',kb='load',lb='losecapture',ed='margin',yb='margin-left',zb='margin-top',zc='menubar',nc='middle',F='moduleStartup',mb='mousedown',nb='mousemove',ob='mouseout',pb='mouseover',rb='mouseup',ub='mousewheel',td='none',od='offsetHeight',ab='onModuleLoadStart',r='online stuff',kd='opacity',xc='option',Fc='outline',Ad='overflow',fd='padding',Fb='position',qd='px',de='px ',be='px; background: url(',ae='px; height: ',Cd='relative',lc='right',yc='role',sb='scroll',l='select',E='startup',cc='submit',ec='table',fc='tbody',tc='td',o='text',ud='textarea',Eb='top',oc='tr',cd='true',dc='type',v='value',Dc='vertical',vc='verticalAlign',jd='white',rd='width',Fd='width: ';var _;function ku(a){return this===(a==null?null:a)}
...
_=bt.prototype=new pg();_.tI=0;function dt(a){a.d=fq(new dq());a.c=en(new cn());a.i=Bq(new kq());a.h=sn(new rn());a.a=up(new tp());a.e=Cn(new zn());a.b=xl(new tl());a.f=nn(new mn());a.g=nm(new mm());nf((hf(),a.f.l),r);fn(a.c,a.b);fn(a.c,a.e);wn(a.h,s,s,-1);wn(a.h,t,t,-1);a.h.l.size=6;a.h.l.style[rd]=u;a.a.l[v]=w!=null?w:m;ip(a.i,a.h);ip(a.i,a.a);a.i.l.style[pd]=x;nf(a.g.l,z);gq(a.d,a.g);gq(a.d,a.i);gq(a.d,a.f);gq(a.d,a.c);a.d.l.style[pd]=A;a.d.l.style[rd]=u;ml((xo(),Ao(null)),a.d);return a}
function ct(){}
