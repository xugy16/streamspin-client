...
function xT(i){var a,c,d,e,f,g,h,j;try{j=(nP(),CR(oP,i.k));h=ft(zQ((BR(),j.a.documentElement)),21);e=DQ(new CQ(),h.a.getElementsByTagName(ae)).a.length;g=ft(FQ(DQ(new CQ(),h.a.getElementsByTagName(ae)),0),21);d=ft(FQ(DQ(new CQ(),h.a.getElementsByTagName(be)),0),21);f=DQ(new CQ(),h.a.getElementsByTagName(be)).a.length;yL(i.b,h.a.nodeValue);$wnd.alert(h.a.nodeValue+ce+h.a.getAttribute(de)+fe+h.a.nodeName+fe+FQ(DQ(new CQ(),d.a.childNodes),0)+fe+d.a.nodeName+fe+g.a.getAttribute(ge)+he+e+ul+f);h.a.nodeValue;h.a.nodeName;h.a.getAttribute(de);g.a.nodeName;FQ(DQ(new CQ(),g.a.childNodes),0);g.a.getAttribute(ge);DQ(new CQ(),h.a.getElementsByTagName(ae)).a.length}catch(a){a=by(a);if(it(a,20)){c=a;$wnd.alert(ie+c.E()+fe+As(Dx,0,31,0,0))}else throw a}$wnd.alert(i.k)}
