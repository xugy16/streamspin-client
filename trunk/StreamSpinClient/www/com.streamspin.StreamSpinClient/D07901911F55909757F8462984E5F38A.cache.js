(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var wp='',ce='\tContent : ',ae='\tHeadline : ',le='\tId : ',ie='\tLatitude: ',he='\tLongtitude: ',ge='\tName : ',ne='\tName: ',qe='\tScript Url: ',oe='\tService id: ',te='\tStartURL: ',pe='\tXml Script: ',se='\tid: ',be='\n',Eg='\n\n',ud='\n ',Ed='\nContent\n',fe='\nLocation\n',je='\nProfile\n',me='\nServiceProfile\n',re='\nStartService\n',oo=' ',rh=' out of range',nd='"',ld='&',md='&amp;',qd='&apos;',vd='&gt;',sd='&lt;',eg='&pw=',od='&quot;',kd='&semi;',xf='&serviceid=',cg='&un=',zf='&unique=',pd="'",gd="' border='0'>",hb='(',hd='(?=[;&<>\'"])',qo='(null handle)',cd=') no-repeat ',sb='): ',yg='*',cp=', ',hp=', Size: ',zg='-',gg='------------------------------\n--- User Information ---\n------------------------------\n',zd='-->',og='-9223372036854775808',yf='/ by zero',dg='0',wb='0px',xe='100%',ye='100px',ze='300px',sg='30px',mg='310px',ng='320px',jc='548CDF11D6FE9011F3447CA200D7FB7F.cache.png',lf='65px',th=':',lp=': ',id=';',rd='<',yd='<!--',wd='<![CDATA[',Af='<\/br><center><font size="6" face="Times" color="Green">Loading...<\/font><\/br><\/br><\/br><img border="0" src="',Cf='<\/center>',Ff='<b>Login<\/b>',ed="<img src='",vh='=',td='>',wf='?userid=',fb='@',ue='@StreamSpin',pj='AbsolutePanel',vj='AbstractCollection',xn='AbstractHashMap',An='AbstractHashMap$EntrySet',Bn='AbstractHashMap$EntrySetIterator',Dn='AbstractHashMap$MapEntryNull',En='AbstractHashMap$MapEntryString',ij='AbstractImagePrototype',wj='AbstractList',Fn='AbstractList$IteratorImpl',wn='AbstractMap',ao='AbstractMap$1',bo='AbstractMap$1$1',Cn='AbstractMapEntry',zn='AbstractSet',ep='Add not supported on this collection',fp='Add not supported on this list',pg='An Error occurred while retrieving and parsing the list of your friends\n\n',bi='Animation',ei='Animation$1',Dh='Animation;',Dl='AnswerWrapper',Be='Application encountered a problem contacting StreamSpin\nPlease reload the application\n\nIf the problem persist StreamSpin may be down for maintenance\n\n',dn='ArithmeticException',xj='ArrayList',fn='ArrayStoreException',kl='AttrImpl',gn='Boolean',rf='Both username and password has to be filled out',fc='Bottom',tj='Button',rj='ButtonBase',nl='CDATASectionImpl',sc='CENTER',io='CSS1Compat',vo="Can't overwrite cause",lg='Cancel',uo='Cannot set a new parent without first clearing the old parent',uj='CellPanel',tp='Center',ll='CharacterDataImpl',sf='Check',kn='Class',ln='ClassCastException',yj='ClickListenerCollection',kj='ClippedImagePrototype',al='CommandCanceledException',bl='CommandExecutor',dl='CommandExecutor$1',el='CommandExecutor$2',cl='CommandExecutor$CircularIterator',ol='CommentImpl',oj='ComplexPanel',hc='Content',Ai='ContentFetchedHandler$ContentFetchedEvent',El='ContentPopup',Fl='ContentPopup$1',ob='DIV',ql='DOMException',si='DOMImpl',ui='DOMImplOpera',ti='DOMImplStandard',hl='DOMItem',yn='DOMMouseScroll',rl='DOMParseException',fg='Damn!!\nAn Exception getting content from streamspin..\n\n',Bj='DecoratedPopupPanel',Cj='DecoratorPanel',sl='DocumentFragmentImpl',tl='DocumentImpl',fj='DocumentRootImpl',mn='Double',Ei='DynamicHeightFeature',wl='ElementImpl',qg='Empty Friend List',df='Enable debug Mode',cj='Enum',Bi='Event$2',yi='EventObject',li='Exception',Dg='Exception!\nCould not parse content update: \n\n',ef='Exit',Ad='Failed to parse: ',qj='FocusWidget',oh='For input string: "',bm='Friend',ig='GPS Default: ',jg='GPS Threshhold: ',Fi='Gadget',Fj='HTML',ak='HasHorizontalAlignment$HorizontalAlignmentConstant',bk='HasVerticalAlignment$VerticalAlignmentConstant',co='HashMap',fo='HashSet',ck='HorizontalPanel',Fd='INPUT',vf='Id: ',on='IllegalArgumentException',pn='IllegalStateException',dk='Image',ek='Image$State',fk='Image$UnclippedState',gp='Index: ',en='IndexOutOfBoundsException',yp='Inner',aj='IntrinsicFeature',bj='IntrinsicFeature$2',oi='JavaScriptException',pi='JavaScriptObject$',Ej='Label',sp='Left',gk='ListBox',cm='Location',Ef='Login Screen',go='MapEntryImpl',kf='Menu',hk='MenuBar',jk='MenuBar$1',kk='MenuBar$2',lk='MenuBar_MenuBarImages_generatedBundle',mk='MenuItem',ec='Middle',rg='No Friends have been retrieved from StreamSpin',cf='No Interests Profiles found',Fe='No Predefined Locations',af='No Service Subscriptions found',ho='NoSuchElementException',il='NodeImpl',xl='NodeListImpl',mo='Null widget handle. If you are creating a composite, ensure that initWidget() has been called.',qn='NullPointerException',hn='Number',rn='NumberFormatException',uc='ONE_WAY_CORNER',Fh='Object',vn='Object;',De='Off',Ce='On',nj='Panel',pk='PasswordTextBox',Bb='Popup',qk='PopupListenerCollection',Aj='PopupPanel',rk='PopupPanel$AnimationType',sk='PopupPanel$ResizeAnimation',uk='PopupPanel$ResizeAnimation$1',yl='ProcessingInstructionImpl',dm='Profile',up='Right',vk='RootPanel',xk='RootPanel$1',wk='RootPanel$DefaultRootPanel',mi='RuntimeException',ap='Self-causation not permitted',kg='Send Message',em='ServiceProfile',gf='Set Location',jf='Set Profile',ro="Should only call onAttach when the widget is detached from the browser's document",so="Should only call onDetach when the widget is attached to the browser's document",zj='SimplePanel',yk='SimplePanel$1',tn='StackTraceElement;',hf='Start Service',fm='StartService',of='Status: <b>Offline<\/b>',mf='Status: <b>Online<\/b>',gm='StreamSpinClient',qm='StreamSpinClient$1',rm='StreamSpinClient$2',sm='StreamSpinClient$3',tm='StreamSpinClient$3$1',um='StreamSpinClient$4',vm='StreamSpinClient$5',mm='StreamSpinClient$mainTopWindowListBoxContentupdate',nm='StreamSpinClient$mainTopWindowListBoxContentupdate$1',hm='StreamSpinClient$setLocation',im='StreamSpinClient$setLocation$1',km='StreamSpinClient$setProfile',jm='StreamSpinClient$startService',om='StreamSpinClient$startUpLoadingScreen',pm='StreamSpinClient$startUpLoadingScreen$1',xm='StreamSpinClientGadgetImpl',ym='StreamSpinContact',zm='StreamSpinContact$1',Am='StreamSpinContact$2',ic='String',wi='String;',sn='StringBuffer',ii='StringBufferImpl',ji='StringBufferImplAppend',no='Style names cannot be empty',bf='TBODY',we='TR',zk='TextArea',ok='TextBox',nk='TextBoxBase',ml='TextImpl',xg='The Message was not sent:\n\n',vg='The Msg Ans: ',to="This widget's parent does not implement HasWidgets",ki='Throwable',di='Timer',fl='Timer$1',dc='Top',lj='UIObject',un='UnsupportedOperationException',Ee='Use GPS',hg='User id: ',Bm='UserInfo',Cm='UserMessage',Dm='UserMessage$1',Em='UserMessage$2',Fm='UserMessage$3',an='UserMessage$4',Ak='VerticalPanel',mj='Widget',Ck='Widget;',Dk='WidgetCollection',Fk='WidgetCollection$WidgetIterator',ff='Write Message',zl='XMLParserImpl',Bl='XMLParserImplOpera',Al='XMLParserImplStandard',cn='XmlParser',bp='[',jn='[C',Ch='[Lcom.google.gwt.animation.client.',Bk='[Lcom.google.gwt.user.client.ui.',vi='[Ljava.lang.',dj='[[D',dp=']',xd=']]>',Ae='__gwt_gadget_content_div',ee='_blank',ag='a problem.. the google url-translation feature has failed..',xc='absolute',Fo='align',Eb='aria-activedescendant',nc='aria-haspopup',ph='blur',aq='bottom',zo='button',qp='cellPadding',pp='cellSpacing',Ep='center',Ah='change',nh='class ',jo='className',fd="clear.cache.gif' style='",gi='click',vc='clip',eh='cmd cannot be null',ac='colSpan',ai='com.google.gwt.animation.client.',ni='com.google.gwt.core.client.',hi='com.google.gwt.core.client.impl.',qi='com.google.gwt.dom.client.',Di='com.google.gwt.gadgets.client.',zi='com.google.gwt.gadgets.client.event.',ci='com.google.gwt.user.client.',ej='com.google.gwt.user.client.impl.',gj='com.google.gwt.user.client.ui.',jj='com.google.gwt.user.client.ui.impl.',pl='com.google.gwt.xml.client.',gl='com.google.gwt.xml.client.impl.',Cl='com.streamspin.client.',Bh='com.streamspin.client.StreamSpinClient',Cg='content',eo='contextmenu',ri='dblclick',dh='defaulton',ip='div',bn='error',wg='false',Ci='focus',Fg='friend',sh='g',Ao='gwt-Button',gc='gwt-DecoratedPopupPanel',vp='gwt-DecoratorPanel',Ap='gwt-HTML',kb='gwt-Image',zp='gwt-Label',mb='gwt-ListBox',rb='gwt-MenuBar',Ab='gwt-MenuBarPopup',kc='gwt-MenuItem',rc='gwt-PasswordTextBox',jp='gwt-PopupPanel',Dc='gwt-TextArea',pc='gwt-TextBox',nf='gwt-uid-',Bg='headline',lo='height',ul='hidden',xb='hideFocus',ub='horizontal',de='http://',bg='http://webclient.streamspin.com/Default.aspx?type=',Dd='http://www.mozilla.org/newlayout/xml/parsererror.xml',Fb='id',Bf='images/ajax-loader.gif" /> ',Df='images/daisy.gif',lb='img',mh='interface ',Eh='java.lang.',xi='java.util.',hj='keydown',sj='keypress',Dj='keyup',uf='lat',wo='left',ik='load',ch='location',bh='locations',tf='lon=',tk='losecapture',zb='menuPopup',qb='menubar',lc='menuitem',Ec='message',ib='middle',yh='moduleStartup',Ek='mousedown',jl='mousemove',vl='mouseout',am='mouseover',lm='mouseup',nn='mousewheel',Ag='msg',tg='msg=',ko='must be positive',tc='name',Cp='normal',Dp='nowrap',Db='null',gb='offsetHeight',ve='offsetWidth',zh='onModuleLoadStart',nb='option',vb='outline',fi='overflow',Cd='parsererror',qc='password',kp='popupContent',yo='position',jh='profile',ih='profiles',op='px',dd='px ',Ac='px)',zc='px, ',bd='px; background: url(',ad='px; height: ',qh='radix ',ug='rcv',yc='rect(',Bc='rect(0px, 0px, 0px, 0px)',wc='rect(auto, auto, auto, auto)',Fp='right',pb='role',wm='scroll',ke='select',mc='selected',lh='serviceprofile',kh='serviceprofiles',hh='startservice',gh='startservices',xh='startup',cc='subMenuIcon',Cb='subMenuIcon-selected',Bo='submit',Do='table',Eo='tbody',xp='td',oc='text',Bd='text/xml',Cc='textarea',jd='toString',xo='top',rp='tr',fh='treshhold',yb='true',Co='type',ah='uid',pf='uid=',bc='vAlign',qf='value',tb='vertical',jb='verticalAlign',mp='visibility',np='visible',Bp='whiteSpace',po='width',Fc='width: ',uh='{',wh='}';var _,bq=[0,-9223372036854775808],cq=[16777216,0],dq=[4294967295,9223372032559808512];function i6(a){return this===(a==null?null:a)}
...
function aY(){}
_=aY.prototype=new g6();_.gC=eY;_.tS=fY;_.tI=72;_.a=null;_.b=0;_.c=null;function w0(b){var a;s0(b);zs((ns(),b.n.y),C0(B0)+ue);sK(b.g,b.f);sK(b.g,b.n);sK(b.g,b.a);lI(b.g,b.f,(aK(),dK));lI(b.g,b.n,bK);lI(b.g,b.a,eK);b.g.y.style[po]=xe;a=AY(new zY(),b);pF(a,25000);nJ(b.j,vY(new pY(),b));b.j.y.size=20;b.j.y.style[po]=xe;yR(b.k,b.j);b.k.y.style[lo]=ye;b.k.y.style[po]=xe;u0(b,(r3(),t3));yR(b.h,b.g);yR(b.h,b.k);yR(b.h,b.i);b.h.y.style[lo]=ze;b.h.y.style[po]=xe;uH((wP(),AP(null)),b.h);AP(Ae);$wnd._IG_AdjustIFrameHeight()}
function s0(p){var a,c,d,e,f,g,h,i,j,k,l,m,n,o;g=null;try{g=F2((e3(),p.m.a))}catch(a){a=AB(a);if(fw(a,19)){d=a;$wnd.alert(Be+C7(d))}else throw a}c=eM(new wL(),true);gM(c,hN(new gN(),Ce,p.l));gM(c,hN(new gN(),De,p.l));m=eM(new wL(),true);gM(m,hN(new gN(),Ee,p.l));if(g.c.b==0){gM(m,hN(new gN(),Fe,p.l))}for(f=D9(new B9(),g.c);f.a<f.b.Ab();){e=cw(a$(f),20);gM(m,hN(new gN(),e.c,tZ(new nZ(),e.b,e.a)))}o=eM(new wL(),true);if(g.f.b==0){gM(o,hN(new gN(),af,p.l))}for(l=D9(new B9(),g.f);l.a<l.b.Ab();){k=cw(a$(l),21);gM(o,hN(new gN(),k.a,DZ(new CZ(),k.b,k.c)))}n=eM(new wL(),true);if(g.d.b==0){gM(n,hN(new gN(),cf,p.l))}for(j=D9(new B9(),g.d);j.a<j.b.Ab();){i=cw(a$(j),22);gM(n,hN(new gN(),i.b,yZ(new xZ(),i.a)))}h=eM(new wL(),true);gM(h,iN(new gN(),df,c));gM(h,hN(new gN(),ef,p.l));gM(h,hN(new gN(),ff,p.o));gM(h,iN(new gN(),gf,m));gM(h,iN(new gN(),hf,o));gM(h,iN(new gN(),jf,n));gM(p.f,iN(new gN(),kf,h));p.f.b=false;p.f.y.style[po]=lf}
function u0(b,a){if(a.a){b.i.y.innerHTML=mf}else{b.i.y.innerHTML=of}}
...
function DY(){var a;a=new vW();a.a=null;q1(n1(new b1()),2,a,xv(wB,0,1,[pf+A0]));pF(kZ(new dZ(),a,this.a).c,500)}
function zY(){}
_=zY.prototype=new gF();_.gC=CY;_.vb=DY;_.tI=76;_.a=null;function FY(b,a){b.a=a;return b}
function bZ(){return vz}
function cZ(a){if(gt(this.a.e.y,qf).length>0&&gt(this.a.d.y,qf).length>0){B0=gt(this.a.e.y,qf);z0=gt(this.a.d.y,qf);wH((wP(),AP(null)),this.a.c);q1(n1(new b1()),8,this.a.m,xv(wB,0,1,[]));h0(new b0(),this.a)}else{$wnd.alert(rf)}}
function EY(){}
...
function iZ(){var a,b,c;if(this.a.a.a!=null){mF(this);rL(this.a.b.j,sf,this.a.a.a,-1);if(this.a.a.a.length){c=D2((e3(),this.a.a.a));for(b=D9(new B9(),c);b.a<b.b.Ab();){a=cw(a$(b),23);rL(this.a.b.j,a.b,a.a,-1)}}}}
function eZ(){}
_=eZ.prototype=new gF();_.gC=hZ;_.vb=iZ;_.tI=78;_.a=null;function tZ(c,b,a){c.b=b;c.a=a;return c}
function vZ(){var a,b;a=new vW();q1(n1(new b1()),5,a,xv(wB,0,1,[tf+this.b,uf+this.a,pf+A0]));b=(qZ(),nF(),new oZ());pF(b,1000)}
...
function AZ(){$wnd.alert(vf+this.a)}
function BZ(){return Az}
function xZ(){}
_=xZ.prototype=new g6();_.F=AZ;_.gC=BZ;_.tI=81;_.a=0;function DZ(c,b,a){c.a=b;c.b=a;return c}
function FZ(){this.b=this.b+wf+A0+xf+this.a+zf+DC(pC((new Date()).getTime()));$wnd.open(this.b,ee,null)}
function a0(){return Bz}
function CZ(){}
_=CZ.prototype=new g6();_.F=FZ;_.gC=a0;_.tI=82;_.a=0;_.b=null;function h0(d,c){var a,b,e;d.a=c;xO(d);d.l=false;eP(d);b=d;a=tJ(new sJ());a.y.innerHTML=Af+$moduleBase+Bf+Cf||wp;kR(a,wp+oH().clientWidth*0.95,wp+oH().clientHeight*0.9);hQ(d,a);DO(d);e=d0(new c0(),d,b);pF(e,1000);return d}
...
function c0(){}
_=c0.prototype=new gF();_.gC=f0;_.vb=g0;_.tI=84;_.a=null;_.b=null;function l0(a){a.h=xR(new vR());a.g=rK(new pK());a.k=xR(new vR());a.j=nL(new mL(),false);a.f=dM(new wL());a.i=gL(new fL());a.n=tJ(new sJ());a.c=xR(new vR());a.e=EQ(new yQ());a.d=wN(new vN());a.b=cI(new DH());a.a=aL(new xK(),$moduleBase+Df);a.m=new vW();a.l=new hY();a.o=new lY();a.ib(new hu());a.jb(new qu());zs((ns(),a.n.y),Ef);a.b.y.innerHTML=Ff;nJ(a.b,FY(new EY(),a));yR(a.c,a.n);yR(a.c,a.e);yR(a.c,a.d);yR(a.c,a.b);uH((wP(),AP(null)),a.c);return a}
...
function p1(k,f,d){var a,c,e,g,h,i,j,l;c=wp;for(h=d,i=0,j=h.length;i<j;++i){g=h[i];c+=ld+g}if(!k.a){$wnd.alert(ag)}l=bg+f+cg+B0+eg+z0+c;try{yu(l,su(new ru(),i1(new h1(),k)),10)}catch(a){a=AB(a);if(fw(a,19)){e=a;$wnd.alert(fg+C7(e))}else throw a}}
...
function E1(){var q,r,s,t,u,v,w,x,y;u=gg;u+=hg+this.g+be;for(r=D9(new B9(),this.c);r.a<r.b.Ab();){q=cw(a$(r),20);u+=rX(q)}u+=ig+this.a+be;u+=jg+this.b+be;for(w=D9(new B9(),this.f);w.a<w.b.Ab();){v=cw(a$(w),21);u+=dY(v)}for(t=D9(new B9(),this.d);t.a<t.b.Ab();){s=cw(a$(t),22);u+=xX(s)}for(y=D9(new B9(),this.e);y.a<y.b.Ab();){x=cw(a$(y),24);u+=DX(x)}return u}
function s1(){}
_=s1.prototype=new g6();_.gC=D1;_.tS=E1;_.tI=0;_.a=null;_.b=0;_.g=0;function v2(c){var a,b;xO(c);c.l=false;c.g=rK(new pK());c.h=xR(new vR());c.d=rK(new pK());c.e=vQ(new uQ());c.j=dI(new DH(),kg);c.a=dI(new DH(),lg);c.f=nL(new mL(),true);c.b=p_(new o_());c.i=c;a=new vW();q1(n1(new b1()),6,a,xv(wB,0,1,[pf+A0]));b=b2(new a2(),c,a);pF(b,1000);return c}
function y2(f){var a,c,d,e;sK(f.g,f.a);sK(f.g,f.j);yR(f.h,f.e);yR(f.h,f.g);sK(f.d,f.f);sK(f.d,f.h);kR(f.d,mg,ng);nJ(f.j,g2(new f2(),f));nJ(f.a,l2(new k2(),f));if(f.c.length){try{f.b=E2((e3(),f.c))}catch(a){a=AB(a);if(fw(a,19)){c=a;$wnd.alert(pg+C7(c))}else throw a}}if(f.b.b==0)rL(f.f,qg,rg,-1);else{for(e=D9(new B9(),f.b);e.a<e.b.Ab();){d=cw(a$(e),25);rL(f.f,d.b,wp+d.a,-1)}}kR(f.f,ye,wp+oH().clientHeight*0.8);f.f.y.size=14;kR(f.e,xe,wp+(oH().clientHeight*0.8-30));kR(f.g,xe,sg);kR(f.d,xe,xe)}
function z2(b,c){var a,d;a=new vW();q1(n1(new b1()),3,a,xv(wB,0,1,[tg+b,ug+c,pf+A0]));d=q2(new p2(),a);pF(d,1000)}
...
function j2(b){var a;for(a=0;a<(ns(),this.a.f.y).options.length;++a){if(sL(this.a.f,a)){z2(gt(this.a.e.y,qf),b6(qL(this.a.f,a),10,-2147483648,2147483647))}}}
function f2(){}
