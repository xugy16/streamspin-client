...
function a0(e,d){var a,c,f;if(!e.a){$wnd.alert(kh)}f=lh+d+mh;$wnd.alert(f);try{yv(f,sv(new rv(),zZ(new yZ(),e)),10)}catch(a){a=kC(a);if(ex(a,20)){c=a;$wnd.alert(nh+t5(c))}else throw a}}
