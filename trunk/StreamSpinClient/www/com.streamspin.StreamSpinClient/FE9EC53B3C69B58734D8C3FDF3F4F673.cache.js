...
function j0(a){k0();kN(a,false);a.e=aJ(new EI());a.f=oQ(new mQ());a.b=aJ(new EI());a.c=jP(new iP());a.h=jG(new dG(),De);a.a=jG(new dG(),hg);a.d=CJ(new BJ(),true);a.g=a;bJ(a.e,a.a);bJ(a.e,a.h);pQ(a.f,a.c);pQ(a.f,a.e);bJ(a.b,a.d);bJ(a.b,a.f);aQ(a.b,hp+(oF(),qF).clientWidth*0.9,hp+qF.clientHeight*0.85);CH(a.h,FZ(new EZ(),a));cK(a.d,ig,ig,-1);cK(a.d,jg,jg,-1);cK(a.d,kg,kg,-1);cK(a.d,lg,lg,-1);cK(a.d,mg,mg,-1);cK(a.d,ng,ng,-1);cK(a.d,pg,pg,-1);cK(a.d,ig,ig,-1);cK(a.d,jg,jg,-1);cK(a.d,kg,kg,-1);cK(a.d,qg,qg,-1);cK(a.d,rg,sg,-1);cQ(a.d,tg);cK(a.d,mg,mg,-1);cK(a.d,ng,ng,-1);cK(a.d,pg,pg,-1);aQ(a.d,ef,hp+qF.clientHeight*0.8);a.d.w.size=14;DJ(a.d,e0(new d0(),a));aQ(a.c,af,ug);xN(a,a.b);oN(a);yN(a);return a}
