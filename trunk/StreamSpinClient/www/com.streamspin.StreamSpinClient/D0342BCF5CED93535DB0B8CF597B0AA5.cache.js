...
function kV(){}
_=kV.prototype=new dY();_.gC=pV;_.tI=0;function sV(l){var a,d,e,f,g,h,i,j,k,m,c;wV=mV(new kV(),g3(new f3()),(EV(),g3(new f3()),g3(new f3()),g3(new f3())));try{m=(wQ(),fT(xQ,l));k=bu(bS((eT(),m.a.documentElement)),20);e=fS(new eS(),hS(fS(new eS(),k.a.getElementsByTagNameNS(qf,rf)),0).a.childNodes).a.length;bu(hS(fS(new eS(),k.a.getElementsByTagNameNS(qf,sf)),0),20);bu(hS(fS(new eS(),k.a.getElementsByTagNameNS(qf,tf)),0),20);fS(new eS(),k.a.getElementsByTagNameNS(qf,sf)).a.length;for(h=0;h<~~(e/2)-1;++h){i=bu(hS(fS(new eS(),k.a.getElementsByTagNameNS(qf,uf)),h),20);$wnd.alert(vf+h+mm+i.a.nodeValue+mm+i.a.getAttribute(wf)+mm+(c=i.E(),(new XMLSerializer()).serializeToString(c)));i3(wV.a,sT(new rT(),bY(i.a.getAttribute(wf),10,-2147483648,2147483647),i.a.nodeValue))}$wnd.alert(xf);for(g=u1(new s1(),wV.a);g.a<g.b.wb();){f=bu(x1(g),21).a;j=bu(x1(g),21).b;$wnd.alert(j+zf+f)}$wnd.alert(Af+iS(fS(new eS(),hS(fS(new eS(),k.a.getElementsByTagNameNS(qf,rf)),0).a.childNodes)));$wnd.alert(Bf+fS(new eS(),hS(fS(new eS(),k.a.getElementsByTagNameNS(qf,rf)),0).a.childNodes).a.length)}catch(a){a=dz(a);if(eu(a,19)){d=a;$wnd.alert(Cf+d.ab()+Df+wt(Fy,0,31,0,0))}else throw a}return null}
