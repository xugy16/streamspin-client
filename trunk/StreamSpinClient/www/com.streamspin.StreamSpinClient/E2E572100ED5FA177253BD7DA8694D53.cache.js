(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var C='',A=' ',yc=', Size: ',Cb='-',qb='0',ac='0px',qc='100%',uc='100px',wc=':',xb='DIV',w='DOMMouseScroll',xc='Index: ',lc='Item four',ic='Item one',nc='Item six',mc='Item that has a long title and is number five',kc='Item tree',jc='Item two',bd='Object;',vc='Status: <b>Online<\/b>',sc='This is some contense that should show how the widget handles stuff, wwwwwwwwwww wwwwwwwwww wwwwwwwwww wwwwew rw er',Fc='Widget;',Ec='[Lcom.google.gwt.user.client.ui.',ad='[Ljava.lang.',tb='align',m='blur',lb='bottom',F='button',rb='cellPadding',pb='cellSpacing',jb='center',x='change',z='className',cb='click',Dc='com.streamspin.client.StreamSpinClient',y='contextmenu',nb='dblclick',gb='div',u='error',yb='focus',ab='gwt-Button',ib='gwt-HTML',hb='gwt-Label',vb='gwt-ListBox',Bb='gwt-MenuBar',fc='gwt-TextArea',tc='height',bc='hideFocus',Eb='horizontal',dc='keydown',oc='keypress',zc='keyup',B='left',cd='load',n='losecapture',Ab='menubar',mb='middle',Bc='moduleStartup',o='mousedown',p='mousemove',q='mouseout',r='mouseover',s='mouseup',v='mousewheel',Cc='onModuleLoadStart',wb='option',Fb='outline',E='position',kb='right',zb='role',t='scroll',l='select',gc='someTest',Ac='startup',bb='submit',eb='table',fb='tbody',sb='td',ec='textarea',hc='title of Main Window',D='top',ob='tr',cc='true',db='type',rc='value',Db='vertical',ub='verticalAlign',pc='width';var _;function po(a){return this===(a==null?null:a)}
...
function eh(){var a;if(dh){for(a=br(new Fq(),dh);a.a<a.b.b;){uf(er(a),3);fl()}}}
...
function El(a){var b,c;b=a[z]==null?null:String(a[z]);c=b.indexOf(jp(32));if(c>=0){return b.substr(0,c-0)}return b}
function Fl(c,j,a){var b,d,e,f,g,h,i;if(!c){throw new ro()}j=fp(j);if(j.length==0){throw new co()}i=c[z]==null?null:String(c[z]);e=i.indexOf(j);while(e!=-1){if(e==0||i.charCodeAt(e-1)==32){f=e+j.length;g=i.length;if(f==g||f<g&&i.charCodeAt(f)==32){break}}e=i.indexOf(j,e+1)}if(a){if(e==-1){if(i.length>0){i+=A}c[z]=i+j}}else{if(e!=-1){b=fp(i.substr(0,e-0));d=fp(dp(i,e+j.length));if(b.length==0){h=d}else if(d.length==0){h=b}else{h=b+A+d}c[z]=h}}}
function yl(){}
_=yl.prototype=new no();_.tI=7;_.i=null;function ym(a){if(a.g){throw new go()}a.g=true;a.i.__listener=a;a.l();a.v()}
function zm(a){if(!a.g){throw new go()}try{a.w()}finally{a.m();a.i.__listener=null;a.g=false}}
function Am(a){if(a.h){a.h.x(a)}else if(a.h){throw new go()}}
function Bm(c,b){var a;a=c.h;if(!b){if(!!a&&a.g){c.u()}c.h=null}else{if(a){throw new go()}c.h=b;if(b.g){ym(c)}}}
function Cm(){}
function Dm(){}
function Em(a){}
function Fm(){zm(this)}
...
function yi(b,c){var a;if(c.h!=b){return false}Bm(c,null);a=c.i;Ed((Bd(),a)).removeChild(a);wm(b.f,c);return true}
function zi(){return lm(new jm(),this.f)}
function Ai(a){return yi(this,a)}
function ui(){}
_=ui.prototype=new wk();_.r=zi;_.x=Ai;_.tI=10;function ei(a,b){wi(a,b,a.i)}
function gi(b,c){var a;a=yi(b,c);if(a){hi(c.i)}return a}
function hi(a){a.style[B]=C;a.style[D]=C;a.style[E]=C}
function ii(a){return gi(this,a)}
function di(){}
_=di.prototype=new ui();_.x=ii;_.tI=11;function Ci(b,a){b.i=a;b.i.tabIndex=0;return b}
function Ei(a){Ah(a)}
function Bi(){}
_=Bi.prototype=new hm();_.t=Ei;_.tI=12;function li(b,a){b.i=a;b.i.tabIndex=0;return b}
function ki(){}
_=ki.prototype=new Bi();_.tI=13;function oi(b,a){li(b,$doc.createElement((Bd(),F)));qi(b.i);b.i[z]=ab;b.i.innerHTML=a||C;return b}
function qi(b){if(b.type==bb){try{b.setAttribute(db,F)}catch(a){}}}
function ji(){}
_=ji.prototype=new ki();_.tI=14;function si(a){a.f=qm(new im());a.e=$doc.createElement((Bd(),eb));a.d=$doc.createElement(fb);a.e.appendChild(a.d);a.i=a.e;return a}
function ri(){}
_=ri.prototype=new ui();_.tI=15;_.d=null;_.e=null;function Fj(a){a.i=$doc.createElement((Bd(),gb));a.i[z]=hb;return a}
function ck(a){Ah(a)}
function Ej(){}
_=Ej.prototype=new hm();_.t=ck;_.tI=16;function aj(a){a.i=$doc.createElement((Bd(),gb));a.i[z]=ib;return a}
function Fi(){}
_=Fi.prototype=new Ej();_.tI=17;function jj(){jj=tt;hj(new gj(),jb);lj=hj(new gj(),B);hj(new gj(),kb);kj=lj}
var kj,lj;function hj(b,a){b.a=a;return b}
function gj(){}
_=gj.prototype=new no();_.tI=0;_.a=null;function rj(){rj=tt;pj(new oj(),lb);pj(new oj(),mb);sj=pj(new oj(),D)}
var sj;function pj(a,b){a.a=b;return a}
function oj(){}
_=oj.prototype=new no();_.tI=0;_.a=null;function xj(a){si(a);a.a=(jj(),kj);a.c=(rj(),sj);a.b=$doc.createElement((Bd(),ob));a.d.appendChild(a.b);a.e[pb]=qb;a.e[rb]=qb;return a}
function yj(c,d){var b,a;b=(a=$doc.createElement((Bd(),sb)),(a[tb]=c.a.a,undefined),(a.style[ub]=c.c.a,undefined),a);c.b.appendChild(b);Am(d);rm(c.f,d);b.appendChild(d.i);Bm(d,c)}
function Bj(c){var a,b;b=Ed((Bd(),c.i));a=yi(this,c);if(a){this.b.removeChild(b)}return a}
function vj(){}
_=vj.prototype=new ri();_.x=Bj;_.tI=18;_.b=null;function ek(a){Ci(a,Dd((Bd(),false)));a.i[z]=vb;return a}
function hk(f,c,g,b){var a,d,e;e=f.i;d=$doc.createElement((Bd(),wb));d.text=c;d.value=g;if(b==-1||b==e.options.length){e.add(d,null)}else{a=e.options[b];e.add(d,a)}}
function jk(a){if(Ah(a)==1024){}else{Ah(a)}}
function dk(){}
_=dk.prototype=new Bi();_.t=jk;_.tI=19;function nk(a){js(new is());a.b=js(new is());qk(a,false,(tk(),new rk()));return a}
function pk(d,a){var b,c;for(c=br(new Fq(),d.b);c.a<c.b.b;){b=ag(er(c));if((Bd(),null.B()).contains(a)){return b}}return null}
function qk(d,f){var b,c,e,a;c=$doc.createElement((Bd(),eb));d.a=$doc.createElement(fb);c.appendChild(d.a);if(!f){e=$doc.createElement(ob);d.a.appendChild(e)}b=(a=$doc.createElement(xb),a.tabIndex=0,a);b.appendChild(c);d.i=b;d.i.setAttribute(zb,Ab);Dg(d.i,2225|(d.i.__eventBits||0));d.i[z]=Bb;if(f){zl(d,El(d.i)+Cb+Db)}else{zl(d,El(d.i)+Cb+Eb)}d.i.style[Fb]=ac;d.i.setAttribute(bc,cc)}
function uk(a){var b;pk(this,a.target);switch(Ah(a)){case 1:{this.i.focus();break}{break}case 2048:{ag(ns(this.b,0));break}case 128:{b=a.which||(a.keyCode||0);switch(b){case 37:{ag(ns(this.b,0))}a.cancelBubble=true;a.preventDefault();break;case 39:{ag(ns(this.b,0))}a.cancelBubble=true;a.preventDefault();break;case 38:ag(ns(this.b,0));a.cancelBubble=true;a.preventDefault();break;case 40:ag(ns(this.b,0));a.cancelBubble=true;a.preventDefault();break;case 27:a.cancelBubble=true;a.preventDefault();break;case 13:{ag(ns(this.b,0))}}break}}}
function vk(){zm(this)}
function kk(){}
_=kk.prototype=new hm();_.t=uk;_.u=vk;_.tI=20;_.a=null;function tk(){tk=tt}
function rk(){}
_=rk.prototype=new no();_.tI=0;function el(){el=tt;il=ws(new vs());jl=As(new zs())}
function dl(b,a){el();b.f=qm(new im());b.i=a;ym(b);return b}
function fl(){var b,a;el();var c,d;for(d=(b=yp(new xp(),bs(jl.a).b.a),rr(new qr(),b));dr(d.a.a);){c=uf((a=uf(er(d.a.a),9),a.o()),6);if(c.g){c.u()}}}
function hl(a){el();var b;b=uf(wq(il,a),5);if(b){return b}if(il.d==0){ch(new Ek())}b=bl(new al());Cq(il,a,b);Bs(jl,b);return b}
function Dk(){}
_=Dk.prototype=new di();_.tI=21;var il,jl;function Ek(){}
_=Ek.prototype=new no();_.tI=22;function cl(){cl=tt;el()}
function bl(a){cl();dl(a,$doc.body);return a}
function al(){}
_=al.prototype=new Dk();_.tI=23;function ul(b,a){b.i=a;b.i.tabIndex=0;return b}
function xl(a){var b;b=Ah(a);if((b&896)!=0){Ah(a)}else if(b==1024){}else{Ah(a)}}
function tl(){}
_=tl.prototype=new Bi();_.t=xl;_.tI=24;function rl(a){ul(a,$doc.createElement((Bd(),ec)));a.i[z]=fc;return a}
function ql(){}
_=ql.prototype=new tl();_.tI=25;function cm(a){si(a);a.a=(jj(),kj);a.b=(rj(),sj);a.e[pb]=qb;a.e[rb]=qb;return a}
function dm(c,e){var b,d,a;d=$doc.createElement((Bd(),ob));b=(a=$doc.createElement(sb),(a[tb]=c.a.a,undefined),(a.style[ub]=c.b.a,undefined),a);d.appendChild(b);c.d.appendChild(d);Am(e);rm(c.f,e);b.appendChild(e.i);Bm(e,c)}
function gm(c){var a,b;b=Ed((Bd(),c.i));a=yi(this,c);if(a){this.d.removeChild(Ed(b))}return a}
function am(){}
_=am.prototype=new ri();_.x=gm;_.tI=26;function qm(a){a.a=kf(eg,0,6,4,0);return a}
function rm(a,b){um(a,b,a.b)}
function tm(b,c){var a;for(a=0;a<b.b;++a){if(b.a[a]==c){return a}}return -1}
function um(d,e,a){var b,c;if(a<0||a>d.b){throw new jo()}if(d.b==d.a.length){c=kf(eg,0,6,d.a.length*2,0);for(b=0;b<d.a.length;++b){nf(c,b,d.a[b])}d.a=c}++d.b;for(b=d.b-1;b>a;--b){nf(d.a,b,d.a[b-1])}nf(d.a,a,e)}
function vm(c,b){var a;if(b<0||b>=c.b){throw new jo()}--c.b;for(a=b;a<c.b;++a){nf(c.a,a,c.a[a+1])}nf(c.a,c.b,null)}
function wm(b,c){var a;a=tm(b,c);if(a==-1){throw new mt()}vm(b,a)}
function im(){}
_=im.prototype=new no();_.tI=0;_.a=null;_.b=0;function lm(b,a){b.b=a;return b}
function nm(a){if(a.a>=a.b.b){throw new mt()}return a.b.a[++a.a]}
function om(){return this.a<this.b.b-1}
function pm(){return nm(this)}
function jm(){}
_=jm.prototype=new no();_.q=om;_.s=pm;_.tI=0;_.a=-1;_.b=null;function hn(){}
_=hn.prototype=new bf();_.tI=0;function kn(a){a.d=cm(new am());a.c=xj(new vj());a.h=cm(new am());a.g=ek(new dk());a.a=rl(new ql());a.e=nk(new kk());a.b=oi(new ji(),gc);a.f=Fj(new Ej());a.i=aj(new Fi());ce((Bd(),a.i.i),hc);hk(a.g,ic,ic,-1);hk(a.g,jc,jc,-1);hk(a.g,kc,kc,-1);hk(a.g,lc,lc,-1);hk(a.g,mc,mc,-1);hk(a.g,nc,nc,-1);a.g.i.size=3;a.g.i.style[pc]=qc;a.a.i[rc]=sc!=null?sc:C;a.a.i.style[pc]=qc;dm(a.h,a.g);dm(a.h,a.a);a.h.i.style[tc]=uc;a.h.i.style[pc]=qc;a.f.i.innerHTML=vc;yj(a.c,a.b);yj(a.c,a.e);dm(a.d,a.i);dm(a.d,a.h);dm(a.d,a.b);dm(a.d,a.f);a.d.i.style[tc]=qc;a.d.i.style[pc]=qc;ei((el(),hl(null)),a.d);return a}
function jn(){}
_=jn.prototype=new hn();_.tI=0;function lp(){}
...
function rn(){!!$stats&&$stats({moduleName:$moduleName,subSystem:Ac,evtGroup:Bc,millis:(new Date()).getTime(),type:Cc,className:Dc});kn(new jn())}
