(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var ko='',Cf='\n',ag='\n\n',od='\n ',Bf='\nElements:\n',Af='\nNum of msg: ',pn=' ',Cd=" border='0'><\/gwt:clipper>",Bd=' height=',oe='"',Ad='" width=',wd='"><img src=\'',zd='#',ih='$',me='&',ne='&amp;',te='&apos;',xe='&gt;',ve='&lt;',re='&quot;',le='&semi;',se="'",xd="' onerror='if(window.__gwt_transparentImgHandler)window.__gwt_transparentImgHandler(this);else this.src=\"",sd="',sizingMethod='crop'); margin-left: ",xf="']",bb='(',je='(?=[;&<>\'"])',rn='(null handle)',mb='): ',fo=', ',lo=', Size: ',Fe=', char ',sn='-',Ce='-->',vf=".//*[local-name()='",qe='/',sb='0',dc='0px',Dg='100%',nf='100px',ah='150px',bh='300px',vc='548CDF11D6FE9011F3447CA200D7FB7F.cache.png',zg='65px',af=':',En=': ',ke=';',ue='<',Ae='<!--',ye='<![CDATA[',wb='<SELECT MULTIPLE>',yb='<SELECT>',vd='<gwt:clipper style="',lh='=',we='>',ee='?',F='@',Ci='AbsolutePanel',cj='AbstractCollection',hm='AbstractHashMap',jm='AbstractHashMap$EntrySet',km='AbstractHashMap$EntrySetIterator',mm='AbstractHashMap$MapEntryNull',nm='AbstractHashMap$MapEntryString',ui='AbstractImagePrototype',dj='AbstractList',om='AbstractList$IteratorImpl',gm='AbstractMap',pm='AbstractMap$1',rm='AbstractMap$1$1',lm='AbstractMapEntry',im='AbstractSet',ho='Add not supported on this collection',io='Add not supported on this list',xh='Animation',Ah='Animation$1',sh='Animation;',ej='ArrayList',yl='ArrayStoreException',wk='AttrImpl',gf='BackgroundImageCache',zl='Boolean',sc='Bottom',Fi='Button',Ei='ButtonBase',Ak='CDATASectionImpl',Ec='CENTER',en='CSS1Compat',hn="Can't overwrite cause",xn='Cannot set a new parent without first clearing the old parent',aj='CellPanel',db='Center',xk='CharacterDataImpl',Cl='Class',Dl='ClassCastException',fj='ClickListenerCollection',xi='ClippedImagePrototype',mk='CommandCanceledException',ok='CommandExecutor',qk='CommandExecutor$1',rk='CommandExecutor$2',pk='CommandExecutor$CircularIterator',Bk='CommentImpl',Bi='ComplexPanel',uc='Content',Ef='Content:\n',ii='ContentFetchedHandler$ContentFetchedEvent',il='ContentPopup',jl='ContentPopup$1',kl='ContentPopup$2',ll='ContentPopup$3',Bb='DIV',Dk='DOMException',uk='DOMItem',qm='DOMMouseScroll',Ek='DOMParseException',uf='Damn!!\nAn Exception getting content from streamspin..\n\n',ij='DecoratedPopupPanel',jj='DecoratorPanel',Fk='DocumentFragmentImpl',al='DocumentImpl',si='DocumentRootImpl',mi='DynamicHeightFeature',bl='ElementImpl',rg='Enable debug Mode',qi='Enum',ji='Event$2',gi='EventObject',Ch='Exception',sg='Exit',De='Failed to parse: ',Di='FocusWidget',ni='Gadget',lj='HTML',nj='HasHorizontalAlignment$HorizontalAlignmentConstant',oj='HasVerticalAlignment$VerticalAlignmentConstant',sm='HashMap',tm='HashSet',pj='HorizontalPanel',dg='INPUT',El='IllegalArgumentException',Fl='IllegalStateException',qj='Image',rj='Image$State',sj='Image$UnclippedState',jo='Index: ',xl='IndexOutOfBoundsException',hb='Inner',oi='IntrinsicFeature',pi='IntrinsicFeature$2',bi='JavaScriptException',ci='JavaScriptObject$',kj='Label',cb='Left',tj='ListBox',hf='MSXML.DOMDocument',jf='MSXML3.DOMDocument',um='MapEntryImpl',yg='Menu',uj='MenuBar',vj='MenuBar$1',wj='MenuBar$2',yj='MenuBar_MenuBarImages_generatedBundle',zj='MenuItem',lf='Microsoft.DOMDocument',kf='Microsoft.XmlDom',rc='Middle',ff='Msxml2.DOMDocument',qf='New Item',vm='NoSuchElementException',vk='NodeImpl',cl='NodeListImpl',nn='Null widget handle. If you are creating a composite, ensure that initWidget() has been called.',am='NullPointerException',Fc='ONE_WAY_CORNER',vh='Object',em='Object;',Ai='Panel',Cj='PasswordTextBox',ic='Popup',Dj='PopupListenerCollection',hj='PopupPanel',Ej='PopupPanel$AnimationType',Fj='PopupPanel$ResizeAnimation',ak='PopupPanel$ResizeAnimation$1',el='ProcessingInstructionImpl',pg='Profile 1',qg='Profile 2',eb='Right',bk='RootPanel',ek='RootPanel$1',dk='RootPanel$DefaultRootPanel',Dh='RuntimeException',df='SelectionLanguage',bf='SelectionNamespaces',tn='Self-causation not permitted',Ag='Send Message',xg='Set Profile',vg='SetLocation',un="Should only call onAttach when the widget is detached from the browser's document",vn="Should only call onDetach when the widget is attached to the browser's document",gj='SimplePanel',fk='SimplePanel$1',cm='StackTraceElement;',wg='Start Service',pf='Status: <b>Offline<\/b>',of='Status: <b>Online<\/b>',ml='StreamSpinClient',nl='StreamSpinClient$1',ql='StreamSpinClient$2',rl='StreamSpinClient$3',sl='StreamSpinClient$4',tl='StreamSpinClient$5',ul='StreamSpinClient$6',vl='StreamSpinClient$8',wl='StreamSpinClientGadgetImpl',cc='String',ei='String;',bm='StringBuffer',on='Style names cannot be empty',gk='TextArea',Bj='TextBox',Aj='TextBoxBase',zk='TextImpl',Fg='This is some content that should show how the widget handles stuff,\n <b> wwwwwwwwwww wwwwwwwwww wwwwwwwwww wwwwew rw er<\/b>',wn="This widget's parent does not implement HasWidgets",Bh='Throwable',zh='Timer',sk='Timer$1',qc='Top',yi='UIObject',dm='UnsupportedOperationException',mg='Use GPS',hk='VerticalPanel',zi='Widget',jk='Widget;',kk='WidgetCollection',lk='WidgetCollection$WidgetIterator',ug='Write Message',fl='XMLParserImpl',gl='XMLParserImplIE6',mf='XMLParserImplIE6.createDocumentImpl: Could not find appropriate version of DOMDocument.',ef='XPath',Bg='You can send messages to your friends with this',bg='You selected a menu item!',eo='[',Bl='[C',rh='[Lcom.google.gwt.animation.client.',ik='[Lcom.google.gwt.user.client.ui.',di='[Ljava.lang.',hh='\\',go=']',ze=']]>',ch='__gwt_gadget_content_div',Df='__gwt_initWindowCloseHandler',cd='absolute',co='align',be='alpha(opacity=0)',kc='aria-activedescendant',Ac='aria-haspopup',ng='bar',ig='blur',qb='bottom',Bn='button',to='cellPadding',so='cellSpacing',ob='center',tg='change',fh='class ',ln='className',Dd='clear.cache.gif',yd='clear.cache.gif"\' style="',Eg='click',ad='clip',rf='cmd',sf='cmd cannot be null',mc='colSpan',wh='com.google.gwt.animation.client.',Eh='com.google.gwt.core.client.',ki='com.google.gwt.gadgets.client.',hi='com.google.gwt.gadgets.client.event.',yh='com.google.gwt.user.client.',ri='com.google.gwt.user.client.impl.',ti='com.google.gwt.user.client.ui.',vi='com.google.gwt.user.client.ui.impl.',Ck='com.google.gwt.xml.client.',tk='com.google.gwt.xml.client.impl.',hl='com.streamspin.client.',qh='com.streamspin.client.StreamSpinClient',zf='content',wm='contextmenu',jh='dblclick',mo='div',Al='error',dh='false',rd="filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",uh='focus',lg='foo',fn='function',gn='function ',gh='g',Cn='gwt-Button',tc='gwt-DecoratedPopupPanel',fb='gwt-DecoratorPanel',jb='gwt-HTML',ub='gwt-Image',ib='gwt-Label',zb='gwt-ListBox',Eb='gwt-MenuBar',hc='gwt-MenuBarPopup',wc='gwt-MenuItem',hg='gwt-PasswordTextBox',no='gwt-PopupPanel',jd='gwt-TextArea',fg='gwt-TextBox',Be='gwt-uid-',yf='headline',mn='height',ol='hidden',ec='hideFocus',ac='horizontal',md='http://',tf='http://streamspin-client.googlecode.com/svn/trunk/StreamSpinClient/www/com.streamspin.StreamSpinClient/content.xml',kd='https',ld='https://',lc='id',Ed='iframe',jg='images/daisy.gif',vb='img',eh='interface ',th='java.lang.',fi='java.util.',Fd="javascript:''",ai='keydown',li='keypress',wi='keyup',yn='left',Ee='line ',bj='load',mj='losecapture',og='menu',gc='menuPopup',Db='menubar',xc='menuitem',yc='message',rb='middle',oh='moduleStartup',xj='mousedown',ck='mousemove',nk='mouseout',yk='mouseover',dl='mouseup',fm='mousewheel',wf='msg',Cm='must be positive',nc='name',ae='no',lb='normal',nb='nowrap',xb='null',ab='offsetHeight',pe='offsetWidth',ph='onModuleLoadStart',bn='onblur',xm='onclick',dn='oncontextmenu',cn='ondblclick',an='onfocus',Dm='onkeydown',Em='onkeypress',Fm='onkeyup',ym='onmousedown',Am='onmousemove',zm='onmouseup',Bm='onmousewheel',Ab='option',bc='outline',Fh='overflow',nd='overflow: hidden; width: ',gg='password',oo='popupContent',An='position',po='px',gd='px)',fd='px, ',ud='px; border: none',pd='px; height: ',td='px; margin-top: ',qd='px; padding: 0px; zoom: 1',Bc='readOnly',Cc='readonly',ed='rect(',hd='rect(0px, 0px, 0px, 0px)',bd='rect(auto, auto, auto, auto)',pb='right',Cb='role',jn='script',pl='scroll',zc='selected',cg='someTest',nh='startup',pc='subMenuIcon',jc='subMenuIcon-selected',Dn='submit',ao='table',bo='tbody',gb='td',eg='text',id='textarea',kg='the',Ff='there is an exception:\n',ge='this.__popup.offsetHeight',ce='this.__popup.offsetLeft',de='this.__popup.offsetTop',fe='this.__popup.offsetWidth',ie='this.__popup.style.zIndex',kn='title',Cg='title of Main Window',dd='toString',zn='top',uo='tr',fc='true',Fn='type',oc='vAlign',Dc='value',Fb='vertical',tb='verticalAlign',qo='visibility',ro='visible',kb='whiteSpace',qn='width',cf="xmlns:xsl='http://www.w3.org/1999/XSL/Transform'",he='zIndex',kh='{',mh='}';var _;function jX(a){return this===(a==null?null:a)}
...
function hS(){}
_=hS.prototype=new gS();_.v=nS;_.gC=oS;_.tI=0;function mT(f,d){var a,b,c,e;yK(f);f.e=true;e=f;c=yF(new wF(),d,false);lH(c,ES(new DS(),e));a=kH(new iH(),d);lH(a,dT(new cT(),e));b=vM(new uM());b.r[Dc]=d!=null?d:ko;CM(b,true);b.r.style[qn]=nf;b.r.style[mn]=nf;rF(b,iT(new hT(),e));hM(f,b);DK(f);return f}
...
function hT(){}
_=hT.prototype=new hX();_.gC=kT;_.hb=lT;_.tI=68;_.a=null;function BU(b,a){if(a.a){b.h.r.innerHTML=of}else{b.h.r.innerHTML=pf}}
function FU(a){uH(a.i,qf,rf,-1);BU(a,(mV(),nV))}
function aV(d){var a,c;try{qt(tf,kt(new jt(),oU(new nU(),d)),10)}catch(a){a=qz(a);if(Cu(a,19)){c=a;$wnd.alert(uf+c.E())}else throw a}return d.l}
function bV(l,m){var a,c,d,e,f,g,h,i,j,k,n;try{n=(iQ(),rS(jQ,m));k=zu(tR((qS(),n.a.documentElement)),20);j=xR(new wR(),k.a.selectNodes(vf+wf+xf)).a.length;f=zu(zR(xR(new wR(),k.a.selectNodes(vf+yf+xf)),0),20);c=zu(zR(xR(new wR(),k.a.selectNodes(vf+zf+xf)),0),20);g=zR(xR(new wR(),f.a.childNodes),0).tS();d=zR(xR(new wR(),c.a.childNodes),0).tS();for(h=0;h<j;++h){f=zu(zR(xR(new wR(),k.a.selectNodes(vf+yf+xf)),h),20);c=zu(zR(xR(new wR(),k.a.selectNodes(vf+zf+xf)),h),20);g=zR(xR(new wR(),f.a.childNodes),0).tS();d=zR(xR(new wR(),c.a.childNodes),0).a.nodeValue;sH(l.i,g);i=l.i.r.options.length;n2(l.b,i-1,mT(new CS(),d))}DM(l.c,k.a.nodeName+Af+j+Bf+f+Cf+c+Cf+Ef+g+Cf+d+Cf)}catch(a){a=qz(a);if(Cu(a,19)){e=a;$wnd.alert(Ff+e.E()+ag+ou(mz,0,31,0,0))}else throw a}}
function cV(){return ey}
function eV(a){}
function dV(a){}
function pT(){}
_=pT.prototype=new et();_.gC=cV;_.db=eV;_.cb=dV;_.tI=0;_.l=null;function sT(){$wnd.alert(bg)}
...
function nU(){}
_=nU.prototype=new hX();_.gC=rU;_.tI=0;_.a=null;function tU(m){var a,b,d,f,h,j,l;m.f=yN(new wN());m.e=uG(new sG());m.j=yN(new wN());m.i=rH(new qH(),false);m.c=vM(new uM());m.d=fI(new yH());m.g=hE(new bE(),cg);m.h=jH(new iH());m.n=xF(new wF());yN(new wN());aN(new yM(),(a=$doc.createElement(dg),a.type=eg,a),fg);aN(new xJ(),(b=$doc.createElement(dg),b.type=gg,b),hg);gE(new bE());dH(new AG(),$moduleBase+jg);m.b=m2(new l2());m.a=new qT();vT(new uT(),m);m.m=AT(new zT(),m);m.k=FT(new ET(),m);m.cb(new Fs());m.db(new it());d=gI(new yH(),true);iI(d,jJ(new iJ(),kg,m.a));iI(d,jJ(new iJ(),lg,m.a));h=gI(new yH(),true);iI(h,jJ(new iJ(),mg,m.k));iI(h,jJ(new iJ(),kg,m.a));iI(h,jJ(new iJ(),ng,m.a));iI(h,jJ(new iJ(),og,m.a));l=gI(new yH(),true);iI(l,jJ(new iJ(),kg,m.a));iI(l,jJ(new iJ(),ng,m.a));iI(l,jJ(new iJ(),og,m.a));j=gI(new yH(),true);iI(j,jJ(new iJ(),pg,m.a));iI(j,jJ(new iJ(),qg,m.a));f=gI(new yH(),true);iI(f,kJ(new iJ(),rg,d));iI(f,jJ(new iJ(),sg,m.m));iI(f,jJ(new iJ(),ug,m.k));iI(f,kJ(new iJ(),vg,h));iI(f,kJ(new iJ(),wg,l));iI(f,kJ(new iJ(),xg,j));iI(m.d,kJ(new iJ(),yg,f));m.d.b=false;m.d.r.style[qn]=zg;rF(m.g,eU(new dU(),m));m.g.r.innerText=Ag;mN(m.g,Bg);m.n.r.innerText=Cg;vG(m.e,m.d);vG(m.e,m.n);vG(m.e,m.g);pE(m.e,m.d,(dG(),gG));pE(m.e,m.n,eG);pE(m.e,m.g,hG);m.e.r.style[qn]=Dg;rF(m.i,jU(new iU(),m));m.i.r.size=5;m.i.r.style[qn]=Dg;m.c.r[Dc]=Fg!=null?Fg:ko;CM(m.c,true);m.c.r.style[qn]=Dg;m.c.r.style[mn]=ah;zN(m.j,m.i);zN(m.j,m.c);m.j.r.style[mn]=nf;m.j.r.style[qn]=Dg;BU(m,(mV(),mV(),oV));zN(m.f,m.e);zN(m.f,m.j);zN(m.f,m.h);m.f.r.style[mn]=bh;m.f.r.style[qn]=Dg;yD((wL(),AL(null)),m.f);AL(ch);$wnd._IG_AdjustIFrameHeight();return m}
