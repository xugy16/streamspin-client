...
function mT(h,i){var a,c,d,e,f,g,j;try{j=(iP(),rR(jP,i));g=ht(tQ((qR(),j.a.documentElement)),21);xQ(new wQ(),g.a.getElementsByTagNameNS(Fd,ae)).a.length;f=xQ(new wQ(),g.a.getElementsByTagNameNS(Fd,ae)).a.length;e=ht(zQ(xQ(new wQ(),g.a.getElementsByTagNameNS(Fd,be)),0),21);c=ht(zQ(xQ(new wQ(),g.a.getElementsByTagNameNS(Fd,ce)),0),21);ht(zQ(xQ(new wQ(),e.a.childNodes),0),21);ht(zQ(xQ(new wQ(),c.a.childNodes),0),21);$wnd.alert(g.a.nodeName+de+f);$wnd.alert(fe+e+ge);$wnd.alert(c+ge);$wnd.alert(he);g.a.nodeValue;g.a.nodeName;g.a.getAttribute(sb);AV(g.a.getAttribute(sb),10,-2147483648,2147483647)}catch(a){a=cy(a);if(kt(a,20)){d=a;$wnd.alert(ie+d.D()+je+Cs(Ex,0,31,0,0))}else throw a}$wnd.alert(h.k)}
