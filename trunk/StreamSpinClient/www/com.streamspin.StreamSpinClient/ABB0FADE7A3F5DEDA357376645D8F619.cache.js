...
function wY(e,d){var a,c,f;if(!e.a){$wnd.alert(uf)}f=vf+d+wf;$wnd.alert(f);try{gu(f,au(new Ft(),pY(new oY(),e)),10)}catch(a){a=EA(a);if(sv(a,20)){c=a;$wnd.alert(xf+h4(c))}else throw a}}
