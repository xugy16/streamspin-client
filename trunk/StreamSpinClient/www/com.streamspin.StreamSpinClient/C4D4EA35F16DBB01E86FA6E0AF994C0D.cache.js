...
function C2(e,d){var a,c,f;if(!e.a){$wnd.alert(yh)}f=zh+d+Bh+j2+Ch+h2+Dh+i2;try{ww(f,qw(new pw(),v2(new u2(),e)),1)}catch(a){a=sD(a);if(cy(a,20)){c=a;$wnd.alert(Eh+s8(c))}else throw a}}
