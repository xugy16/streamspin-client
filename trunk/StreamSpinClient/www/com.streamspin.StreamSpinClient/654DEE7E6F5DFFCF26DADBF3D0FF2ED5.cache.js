...
function s1(e,d){var a,c,f;if(!e.a){$wnd.alert(cg)}f=eg+d+fg+F0+gg+D0+hg+E0;try{ev(f,Eu(new Du(),l1(new k1(),e)),1)}catch(a){a=gC(a);if(qw(a,20)){c=a;$wnd.alert(ig+g7(c))}else throw a}}
