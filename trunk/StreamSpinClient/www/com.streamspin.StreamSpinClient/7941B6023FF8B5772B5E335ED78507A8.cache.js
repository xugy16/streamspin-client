...
function sX(){}
_=sX.prototype=new n1();_.gC=DX;_.tS=EX;_.tI=0;_.a=null;_.b=0;_.g=0;function lY(a){kM(a);a.j=false;a.e=dI(new bI());a.f=mP(new kP());a.b=dI(new bI());a.c=iO(new hO());a.h=qF(new kF(),ne);a.a=qF(new kF(),Cf);a.d=FI(new EI(),true);a.g=a;eI(a.e,a.a);eI(a.e,a.h);nP(a.f,a.c);nP(a.f,a.e);eI(a.b,a.d);eI(a.b,a.f);EO(a.b,uo+BE().clientWidth*0.9,uo+BE().clientHeight*0.85);aH(a.h,bY(new aY(),a));fJ(a.d,Df,Df,-1);fJ(a.d,Ef,Ef,-1);fJ(a.d,Ff,Ff,-1);fJ(a.d,ag,ag,-1);fJ(a.d,bg,bg,-1);fJ(a.d,cg,cg,-1);fJ(a.d,eg,eg,-1);fJ(a.d,Df,Df,-1);fJ(a.d,Ef,Ef,-1);fJ(a.d,Ff,Ff,-1);fJ(a.d,ag,ag,-1);fJ(a.d,bg,bg,-1);fJ(a.d,cg,cg,-1);fJ(a.d,eg,eg,-1);EO(a.d,te,uo+BE().clientHeight*0.8);a.d.w.size=10;aJ(a.d,gY(new fY(),a));wM(a,a.b);nM(a);xM(a);return a}
