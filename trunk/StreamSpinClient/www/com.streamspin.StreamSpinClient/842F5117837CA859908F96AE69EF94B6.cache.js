...
function y2(f){var a,c,d,e;sK(f.g,f.a);sK(f.g,f.j);yR(f.h,f.e);yR(f.h,f.g);sK(f.d,f.f);sK(f.d,f.h);kR(f.d,ng,pg);nJ(f.j,g2(new f2(),f));nJ(f.a,l2(new k2(),f));if(f.c.length){try{f.b=E2((e3(),f.c))}catch(a){a=AB(a);if(fw(a,19)){c=a;$wnd.alert(qg+C7(c))}else throw a}}if(f.b.b==0)rL(f.f,rg,sg,-1);else{for(e=D9(new B9(),f.b);e.a<e.b.Ab();){d=cw(a$(e),25);rL(f.f,d.b,wp+d.a,-1)}}kR(f.f,ze,wp+oH().clientHeight*0.8);kR(f.e,ye,wp+(oH().clientHeight*0.8-30));kR(f.g,ye,ue);kR(f.d,ye,ye)}
