(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var cq='',ee='\tContent : ',ce='\tHeadline : ',le='\tId : ',ie='\tLatitude: ',he='\tLongtitude: ',ge='\tName : ',ne='\tName: ',qe='\tScript Url: ',oe='\tService id: ',te='\tStartURL: ',pe='\tXml Script: ',se='\tid: ',de='\n',lh='\n\n',ud='\n ',be='\nContent\n',xf='\nLatitude: ',fe='\nLocation\n',je='\nProfile\n',me='\nServiceProfile\n',re='\nStartService\n',Af='\nstart url: ',xo=' ',Eh=' out of range',pd='"',nd='&',od='&amp;',sd='&apos;',xd='&gt;',vd='&lt;',gg='&pw=',qd='&quot;',md='&semi;',hg='&uid=',fg='&un=',rd="'",id="' border='0'>",hb='(',kd='(?=[;&<>\'"])',zo='(null handle)',ed=') no-repeat ',sb='): ',gh='*',lp=', ',rp=', Size: ',Ao='-',kg='------------------------------\n--- User Information ---\n------------------------------\n',Bd='-->',mq='0',vb='0px',ze='100%',Ae='100px',dh='210px',Be='300px',qg='310px',hc='548CDF11D6FE9011F3447CA200D7FB7F.cache.png',of='65px',ai=':',xp=': ',ld=';',td='<',Ad='<!--',yd='<![CDATA[',Bf='<\/br><center><font size="6" face="Times" color="Green">Loading...<\/font><\/br><\/br><\/br><img border="0" src="',Df='<\/center>',bg='<b>Login<\/b>',gd="<img src='",ci='=',wd='>',fb='@',Bj='AbsolutePanel',bk='AbstractCollection',go='AbstractHashMap',io='AbstractHashMap$EntrySet',jo='AbstractHashMap$EntrySetIterator',lo='AbstractHashMap$MapEntryNull',mo='AbstractHashMap$MapEntryString',uj='AbstractImagePrototype',ck='AbstractList',no='AbstractList$IteratorImpl',fo='AbstractMap',oo='AbstractMap$1',qo='AbstractMap$1$1',ko='AbstractMapEntry',ho='AbstractSet',op='Add not supported on this collection',pp='Add not supported on this list',pi='Animation',ti='Animation$1',li='Animation;',km='AnswerWrapper',De='Application encountered a problem contacting StreamSpin\nPlease reload the application\n\nIf the problem persist StreamSpin may be down for maintenance\n\n',dk='ArrayList',tn='ArrayStoreException',yl='AttrImpl',un='Boolean',uf='Both username and password has to be filled out',ec='Bottom',Fj='Button',Ej='ButtonBase',Bl='CDATASectionImpl',vc='CENTER',bn='CSS1Compat',bp="Can't overwrite cause",pg='Cancel',Eo='Cannot set a new parent without first clearing the old parent',ak='CellPanel',Dp='Center',ek='ChangeListenerCollection',zl='CharacterDataImpl',vf='Check',xn='Class',zn='ClassCastException',fk='ClickListenerCollection',wj='ClippedImagePrototype',nl='CommandCanceledException',ol='CommandExecutor',ql='CommandExecutor$1',rl='CommandExecutor$2',pl='CommandExecutor$CircularIterator',Cl='CommentImpl',Aj='ComplexPanel',gc='Content',ij='ContentFetchedHandler$ContentFetchedEvent',mm='ContentPopup',nm='ContentPopup$1',om='ContentPopup$2',pm='ContentPopup$3',nb='DIV',El='DOMException',Fi='DOMImpl',bj='DOMImplOpera',aj='DOMImplStandard',wl='DOMItem',lm='DOMMouseScroll',Fl='DOMParseException',ig='Damn!!\nAn Exception getting content from streamspin..\n\n',jk='DecoratedPopupPanel',kk='DecoratorPanel',Dg='Dell1',Eg='Dell2',bm='DocumentFragmentImpl',cm='DocumentImpl',rj='DocumentRootImpl',An='Double',lj='DynamicHeightFeature',dm='ElementImpl',ff='Enable debug Mode',pj='Enum',jj='Event$2',fj='EventObject',yi='Exception',kh='Exception!\nCould not parse content update: \n\n',gf='Exit',Cd='Failed to parse: ',Cj='FocusWidget',Ch='For input string: "',rg='Friend1',Bg='Friend10',Cg='Friend11',sg='Friend2',tg='Friend3',ug='Friend4',vg='Friend5',wg='Friend6',xg='Friend7',yg='Friend8',Ag='Friend9',mg='GPS Default: ',ng='GPS Threshhold: ',mj='Gadget',mk='HTML',nk='HasHorizontalAlignment$HorizontalAlignmentConstant',ok='HasVerticalAlignment$VerticalAlignmentConstant',ro='HashMap',so='HashSet',pk='HorizontalPanel',Fd='INPUT',zf='Id: ',Bn='IllegalArgumentException',Cn='IllegalStateException',qk='Image',rk='Image$State',sk='Image$UnclippedState',qp='Index: ',sn='IndexOutOfBoundsException',bq='Inner',nj='IntrinsicFeature',oj='IntrinsicFeature$2',Bi='JavaScriptException',Di='JavaScriptObject$',lk='Label',Cp='Left',uk='ListBox',qm='Location',ag='Login Screen',wf='Longtitude: ',to='MapEntryImpl',mf='Menu',vk='MenuBar',wk='MenuBar$1',xk='MenuBar$2',yk='MenuBar_MenuBarImages_generatedBundle',zk='MenuItem',dc='Middle',ef='No Interests Profiles found',cf='No Predefined Locations',df='No Service Subscriptions found',uo='NoSuchElementException',xl='NodeImpl',em='NodeListImpl',po='Null widget handle. If you are creating a composite, ensure that initWidget() has been called.',Dn='NullPointerException',vn='Number',En='NumberFormatException',wc='ONE_WAY_CORNER',ni='Object',co='Object;',Fe='Off',Ee='On',zj='Panel',Ck='PasswordTextBox',Ab='Popup',Dk='PopupListenerCollection',hk='PopupPanel',Fk='PopupPanel$AnimationType',al='PopupPanel$ResizeAnimation',bl='PopupPanel$ResizeAnimation$1',fm='ProcessingInstructionImpl',rm='Profile',Ep='Right',cl='RootPanel',el='RootPanel$1',dl='RootPanel$DefaultRootPanel',zi='RuntimeException',fh='Selected items: ',mp='Self-causation not permitted',ue='Send Message',sm='ServiceProfile',jf='Set Location',lf='Set Profile',Bo="Should only call onAttach when the widget is detached from the browser's document",Co="Should only call onDetach when the widget is attached to the browser's document",gk='SimplePanel',fl='SimplePanel$1',ao='StackTraceElement;',kf='Start Service',tm='StartService',qf='Status: <b>Offline<\/b>',pf='Status: <b>Online<\/b>',um='StreamSpinClient',Dm='StreamSpinClient$1',Em='StreamSpinClient$2',Fm='StreamSpinClient$3',an='StreamSpinClient$4',cn='StreamSpinClient$5',dn='StreamSpinClient$6',en='StreamSpinClient$6$1',fn='StreamSpinClient$7',gn='StreamSpinClient$8',zm='StreamSpinClient$mainTopWindowListBoxContentupdate',Am='StreamSpinClient$mainTopWindowListBoxContentupdate$1',vm='StreamSpinClient$setLocation',ym='StreamSpinClient$setProfile',xm='StreamSpinClient$startService',Bm='StreamSpinClient$startUpLoadingScreen',Cm='StreamSpinClient$startUpLoadingScreen$1',hn='StreamSpinClientGadgetImpl',jn='StreamSpinContact',kn='StreamSpinContact$1',ln='StreamSpinContact$2',ic='String',dj='String;',Fn='StringBuffer',vi='StringBufferImpl',wi='StringBufferImplAppend',vo='Style names cannot be empty',bf='TBODY',we='TR',gl='TextArea',Bk='TextBox',Ak='TextBoxBase',Al='TextImpl',Do="This widget's parent does not implement HasWidgets",xi='Throwable',si='Timer',sl='Timer$1',cc='Top',xj='UIObject',bo='UnsupportedOperationException',af='Use GPS',lg='User id: ',mn='UserInfo',on='UserMessage',pn='UserMessage$1',qn='UserMessage$2',hl='VerticalPanel',yj='Widget',kl='Widget;',ll='WidgetCollection',ml='WidgetCollection$WidgetIterator',hf='Write Message',gm='XMLParserImpl',im='XMLParserImplOpera',hm='XMLParserImplStandard',rn='XmlParser',xe='You can send messages to your friends with this',tf='You selected a menu item which has not yet been implemented!',kp='[',wn='[C',ki='[Lcom.google.gwt.animation.client.',il='[Lcom.google.gwt.user.client.ui.',cj='[Ljava.lang.',np=']',zd=']]>',Ce='__gwt_gadget_content_div',cg='a problem.. the google url-translation feature has failed..',zc='absolute',jp='align',Cb='aria-activedescendant',mc='aria-haspopup',dg='blur',kq='bottom',dp='button',Ap='cellPadding',zp='cellSpacing',iq='center',og='change',Bh='class ',yn='className',hd="clear.cache.gif' style='",zg='click',xc='clip',yf='cmd cannot be null',Fb='colSpan',oi='com.google.gwt.animation.client.',Ai='com.google.gwt.core.client.',ui='com.google.gwt.core.client.impl.',Ei='com.google.gwt.dom.client.',kj='com.google.gwt.gadgets.client.',gj='com.google.gwt.gadgets.client.event.',qi='com.google.gwt.user.client.',qj='com.google.gwt.user.client.impl.',tj='com.google.gwt.user.client.ui.',vj='com.google.gwt.user.client.ui.impl.',Dl='com.google.gwt.xml.client.',tl='com.google.gwt.xml.client.impl.',jm='com.streamspin.client.',ji='com.streamspin.client.StreamSpinClient',jg='contactStreamSpinAsync\n',jh='content',wm='contextmenu',eh='dblclick',qh='defaulton',sp='div',vl='error',yh='false',ph='focus',Fg='foo',bh='funny',Fh='g',ep='gwt-Button',fc='gwt-DecoratedPopupPanel',Fp='gwt-DecoratorPanel',eq='gwt-HTML',jb='gwt-Image',dq='gwt-Label',lb='gwt-ListBox',qb='gwt-MenuBar',zb='gwt-MenuBarPopup',jc='gwt-MenuItem',uc='gwt-PasswordTextBox',tp='gwt-PopupPanel',ad='gwt-TextArea',rc='gwt-TextBox',nf='gwt-uid-',ih='headline',eo='height',ul='hidden',wb='hideFocus',tb='horizontal',eg='http://webclient.streamspin.com/Default.aspx?type=',ae='http://www.mozilla.org/newlayout/xml/parsererror.xml',Eb='id',Cf='images/ajax-loader.gif" /> ',Ff='images/daisy.gif',kb='img',zh='interface ',mi='java.lang.',ej='java.util.',sf='jeppe',rf='jeppejeppe',Ah='keydown',gi='keypress',ri='keyup',Fo='left',Ci='load',oh='location',nh='locations',hj='losecapture',yb='menuPopup',pb='menubar',kc='menuitem',Ec='message',lq='middle',hi='moduleStartup',sj='mousedown',Dj='mousemove',ik='mouseout',tk='mouseover',Ek='mouseup',am='mousewheel',hh='msg',wo='must be positive',tc='name',gq='normal',hq='nowrap',Db='null',gb='offsetHeight',ve='offsetWidth',ii='onModuleLoadStart',mb='option',ub='outline',fi='overflow',Ed='parsererror',sc='password',up='popupContent',cp='position',vh='profile',uh='profiles',yp='px',fd='px ',Cc='px)',Bc='px, ',dd='px; background: url(',cd='px; height: ',Dh='radix ',nc='readOnly',oc='readonly',Ac='rect(',Dc='rect(0px, 0px, 0px, 0px)',yc='rect(auto, auto, auto, auto)',jq='right',ob='role',jl='scroll',ke='select',lc='selected',xh='serviceprofile',wh='serviceprofiles',Ef='someTest',th='startservice',sh='startservices',ei='startup',ch='stuff',bc='subMenuIcon',Bb='subMenuIcon-selected',fp='submit',hp='table',ip='tbody',aq='td',qc='text',Dd='text/xml',Fc='textarea',nn='title',ye='title of Main Window',jd='toString',ap='top',ah='tqg',Bp='tr',rh='treshhold',xb='true',gp='type',mh='uid',ac='vAlign',pc='value',rb='vertical',ib='verticalAlign',vp='visibility',wp='visible',fq='whiteSpace',yo='width',bd='width: ',bi='{',di='}';var _;function v5(a){return this===(a==null?null:a)}
...
function Fu(c,a){var b;b=kv(new jv(),a);n1(c.a,b)}
...
function BX(){}
_=BX.prototype=new t5();_.gC=FX;_.tS=aY;_.tI=74;_.a=null;_.b=0;_.c=null;function B0(b){var a;w0(b);CI(b.j,uY(new tY(),b));ct((ws(),b.j.x),ue);bR(b.j,xe);ct(b.q.x,ye);bK(b.h,b.g);bK(b.h,b.q);bK(b.h,b.j);uH(b.h,b.g,(pJ(),sJ));uH(b.h,b.q,qJ);uH(b.h,b.j,tJ);b.h.x.style[yo]=ze;a=dZ(new cZ(),b);zE(a,10000);CI(b.l,EY(new yY(),b));b.l.x.size=35;b.l.x.style[yo]=ze;oR(b.m,b.l);b.m.x.style[eo]=Ae;b.m.x.style[yo]=ze;y0(b,(d3(),f3));oR(b.i,b.h);oR(b.i,b.m);oR(b.i,b.k);b.i.x.style[eo]=Be;b.i.x.style[yo]=ze;DG((jP(),nP(null)),b.i);nP(Ce);$wnd._IG_AdjustIFrameHeight()}
function w0(p){var a,c,d,e,f,g,h,i,j,k,l,m,n,o;g=null;try{g=v2((A2(),p.o.a))}catch(a){a=gC(a);if(qw(a,20)){d=a;$wnd.alert(De+g7(d))}else throw a}c=xL(new jL(),true);zL(c,AM(new zM(),Ee,p.n));zL(c,AM(new zM(),Fe,p.n));m=xL(new jL(),true);zL(m,AM(new zM(),af,p.a));if(g.c.b==0){zL(m,AM(new zM(),cf,p.a))}for(f=h9(new f9(),g.c);f.a<f.b.zb();){e=nw(k9(f),21);zL(m,AM(new zM(),e.c,xZ(new wZ(),e.b,e.a)))}o=xL(new jL(),true);if(g.f.b==0){zL(o,AM(new zM(),df,p.a))}for(l=h9(new f9(),g.f);l.a<l.b.zb();){k=nw(k9(l),22);zL(o,AM(new zM(),k.a,b0(new a0(),k.b,k.c)))}n=xL(new jL(),true);if(g.d.b==0){zL(n,AM(new zM(),ef,p.a))}for(j=h9(new f9(),g.d);j.a<j.b.zb();){i=nw(k9(j),23);zL(n,AM(new zM(),i.b,CZ(new BZ(),i.a)))}h=xL(new jL(),true);zL(h,BM(new zM(),ff,c));zL(h,AM(new zM(),gf,p.n));zL(h,AM(new zM(),hf,p.r));zL(h,BM(new zM(),jf,m));zL(h,BM(new zM(),kf,o));zL(h,BM(new zM(),lf,n));zL(p.g,BM(new zM(),mf,h));p.g.b=false;p.g.x.style[yo]=of}
function y0(b,a){if(a.a){b.k.x.innerHTML=pf}else{b.k.x.innerHTML=qf}}
function a1(){return pA}
function b1(a){}
function c1(a){d1=a}
function bY(){}
_=bY.prototype=new yu();_.gC=a1;_.hb=b1;_.ib=c1;_.tI=0;_.p=0;var D0=rf,E0=-1,F0=sf,d1=null;function eY(){}
function fY(){return Ez}
function cY(){}
_=cY.prototype=new t5();_.E=eY;_.gC=fY;_.tI=75;function iY(){$wnd.alert(tf)}
...
function gZ(){var a;++this.a.p;a=new lW();a.a=null;t1(q1(new e1()),2,a);zE(tZ(new mZ(),a,this.a).c,500)}
function cZ(){}
_=cZ.prototype=new qE();_.gC=fZ;_.ub=gZ;_.tI=81;_.a=null;function iZ(b,a){b.a=a;return b}
function kZ(){return gA}
function lZ(a){if(pt(this.a.e.x,pc).length>0&&pt(this.a.d.x,pc).length>0){F0=pt(this.a.e.x,pc);D0=pt(this.a.d.x,pc);FG((jP(),nP(null)),this.a.c);t1(q1(new e1()),8,this.a.o);l0(new f0(),this.a)}else{$wnd.alert(uf)}}
function hZ(){}
...
function rZ(){var a,b,c;if(this.a.a.a!=null){wE(this);eL(this.a.b.l,vf+this.a.b.p,this.a.a.a,-1);if(this.a.a.a.length){c=u2((A2(),this.a.a.a));for(b=h9(new f9(),c);b.a<b.b.zb();){a=nw(k9(b),24);eL(this.a.b.l,a.b,a.a,-1)}}}}
function nZ(){}
_=nZ.prototype=new qE();_.gC=qZ;_.ub=rZ;_.tI=83;_.a=null;function xZ(c,b,a){c.b=b;c.a=a;return c}
function zZ(){$wnd.alert(wf+this.b+xf+this.a)}
function AZ(){return jA}
function wZ(){}
_=wZ.prototype=new t5();_.E=zZ;_.gC=AZ;_.tI=84;_.a=null;_.b=null;function CZ(b,a){b.a=a;return b}
function EZ(){$wnd.alert(zf+this.a)}
function FZ(){return kA}
function BZ(){}
_=BZ.prototype=new t5();_.E=EZ;_.gC=FZ;_.tI=85;_.a=0;function b0(c,b,a){c.a=b;c.b=a;return c}
function d0(){$wnd.alert(zf+this.a+Af+this.b)}
function e0(){return lA}
function a0(){}
_=a0.prototype=new t5();_.E=d0;_.gC=e0;_.tI=86;_.a=0;_.b=null;function l0(d,c){var a,b,e;d.a=c;kO(d);d.k=false;xO(d);b=d;a=cJ(new bJ());a.x.innerHTML=Bf+$moduleBase+Cf+Df||cq;FQ(a,cq+xG().clientWidth*0.95,cq+xG().clientHeight*0.9);AP(d,a);qO(d);e=h0(new g0(),d,b);zE(e,1000);return d}
...
function g0(){}
_=g0.prototype=new qE();_.gC=j0;_.ub=k0;_.tI=88;_.a=null;_.b=null;function p0(a){a.i=nR(new lR());a.h=aK(new EJ());a.m=nR(new lR());a.l=DK(new CK(),false);a.f=iQ(new hQ());a.g=wL(new jL());a.j=mH(new gH(),Ef);a.k=vK(new uK());a.q=cJ(new bJ());a.c=nR(new lR());a.e=tQ(new lQ());a.d=jN(new iN());a.b=lH(new gH());pK(new gK(),$moduleBase+Ff);a.o=new lW();a.a=new cY();a.n=new gY();lY(new kY(),a);a.r=new pY();a.hb(new tu());a.ib(new Cu());ct((ws(),a.q.x),ag);a.b.x.innerHTML=bg;CI(a.b,iZ(new hZ(),a));oR(a.c,a.q);oR(a.c,a.e);oR(a.c,a.d);oR(a.c,a.b);DG((jP(),nP(null)),a.c);return a}
function s0(){return oA}
function o0(){}
_=o0.prototype=new bY();_.gC=s0;_.tI=0;function q1(a){a.a=d1;return a}
function t1(d,c,b){var a,e;s1(d,c);a=b;e=g1(new f1(),d,a);zE(e,1000)}
function s1(e,d){var a,c,f;if(!e.a){$wnd.alert(cg)}f=eg+d+fg+F0+gg+D0+hg+E0;try{ev(f,Eu(new Du(),l1(new k1(),e)),10)}catch(a){a=gC(a);if(qw(a,20)){c=a;$wnd.alert(ig+g7(c))}else throw a}}
...
function j1(){if(this.a.b!=null){this.b.a=this.a.b;this.a.b=null;wE(this)}}
function f1(){}
_=f1.prototype=new qE();_.gC=i1;_.ub=j1;_.tI=89;_.a=null;_.b=null;function l1(b,a){b.a=a;return b}
function n1(b,a){b.a.b=a.a;$wnd.alert(jg+b.a.b)}
