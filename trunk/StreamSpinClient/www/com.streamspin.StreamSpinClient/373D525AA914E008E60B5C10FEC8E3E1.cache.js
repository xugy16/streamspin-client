...
function xY(a){yY();oM(a,false);a.e=gI(new eI());a.f=rP(new pP());a.b=gI(new eI());a.c=nO(new mO());a.h=tF(new nF(),se);a.a=tF(new nF(),bg);a.d=cJ(new bJ(),true);a.g=a;hI(a.e,a.a);hI(a.e,a.h);sP(a.f,a.c);sP(a.f,a.e);hI(a.b,a.d);hI(a.b,a.f);dP(a.b,zo+(yE(),AE).clientWidth*0.8,zo+AE.clientHeight*0.8);dH(a.h,nY(new mY(),a));iJ(a.d,cg,cg,-1);iJ(a.d,eg,eg,-1);iJ(a.d,fg,fg,-1);iJ(a.d,gg,gg,-1);iJ(a.d,hg,hg,-1);iJ(a.d,ig,ig,-1);iJ(a.d,jg,jg,-1);iJ(a.d,cg,cg,-1);iJ(a.d,eg,eg,-1);iJ(a.d,fg,fg,-1);iJ(a.d,gg,gg,-1);iJ(a.d,hg,hg,-1);iJ(a.d,ig,ig,-1);iJ(a.d,jg,jg,-1);dP(a.d,Ae,zo+(parseInt(a.b.w[ve])||0)*0.95);$wnd.alert((parseInt(a.b.w[gb])||0)+nn+(parseInt(a.b.w[ve])||0));a.d.w.size=10;dJ(a.d,sY(new rY(),a));BM(a,a.b);sM(a);CM(a);return a}
