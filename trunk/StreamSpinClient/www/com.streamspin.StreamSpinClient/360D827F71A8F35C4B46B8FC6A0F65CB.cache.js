...
_=eo.prototype=new jf();_.tI=0;function go(a){a.c=rm(new pm());a.b=dk(new bk());a.g=rm(new pm());a.f=qk(new pk());a.a=am(new Fl());a.d=Ak(new xk());wi(new si());a.e=lk(new kk());a.h=mj(new lj());je((ce(),a.h.i),kc);uk(a.f,lc,lc,-1);uk(a.f,mc,mc,-1);uk(a.f,nc,nc,-1);uk(a.f,pc,pc,-1);uk(a.f,qc,qc,-1);uk(a.f,rc,rc,-1);a.f.i.size=4;a.f.i.style[sc]=tc;a.a.i[uc]=vc!=null?vc:E;a.a.i.style[sc]=tc;sm(a.g,a.f);sm(a.g,a.a);a.g.i.style[wc]=xc;a.g.i.style[sc]=tc;je(a.e.i,yc);a.e.i.innerHTML=Ac;ek(a.b,a.d);a.b.i.style[wc]=tc;a.b.i.style[sc]=tc;sm(a.c,a.h);sm(a.c,a.g);sm(a.c,a.e);sm(a.c,a.b);a.c.i.style[wc]=tc;a.c.i.style[sc]=tc;ni((rl(),ul(null)),a.c);return a}
function fo(){}
