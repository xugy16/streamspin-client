(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var fq='',ee='\tContent : ',ce='\tHeadline : ',le='\tId : ',ie='\tLatitude: ',he='\tLongtitude: ',ge='\tName : ',ne='\tName: ',qe='\tScript Url: ',oe='\tService id: ',te='\tStartURL: ',pe='\tXml Script: ',se='\tid: ',de='\n',oh='\n\n',ud='\n ',be='\nContent\n',xf='\nLatitude: ',fe='\nLocation\n',je='\nProfile\n',me='\nServiceProfile\n',re='\nStartService\n',Af='\nstart url: ',Ao=' ',bi=' out of range',pd='"',nd='&',od='&amp;',sd='&apos;',xd='&gt;',vd='&lt;',ig='&pw=',qd='&quot;',md='&semi;',jg='&uid=',hg='&un=',rd="'",id="' border='0'>",hb='(',kd='(?=[;&<>\'"])',Co='(null handle)',ed=') no-repeat ',sb='): ',jh='*',op=', ',up=', Size: ',Do='-',ng='------------------------------\n--- User Information ---\n------------------------------\n',Bd='-->',pq='0',vb='0px',ze='100%',Ae='100px',hh='210px',Be='300px',tg='310px',hc='548CDF11D6FE9011F3447CA200D7FB7F.cache.png',of='65px',di=':',Ap=': ',ld=';',td='<',Ad='<!--',yd='<![CDATA[',Bf='<\/br><center><font size="6" face="Times" color="Green">Loading...<\/font><\/br><\/br><\/br><img border="0" src="',Df='<\/center>',bg='<b>Login<\/b>',gd="<img src='",hi='=',wd='>',fb='@',Fj='AbsolutePanel',ek='AbstractCollection',jo='AbstractHashMap',lo='AbstractHashMap$EntrySet',mo='AbstractHashMap$EntrySetIterator',oo='AbstractHashMap$MapEntryNull',qo='AbstractHashMap$MapEntryString',xj='AbstractImagePrototype',fk='AbstractList',ro='AbstractList$IteratorImpl',io='AbstractMap',so='AbstractMap$1',to='AbstractMap$1$1',no='AbstractMapEntry',ko='AbstractSet',rp='Add not supported on this collection',sp='Add not supported on this list',ti='Animation',wi='Animation$1',oi='Animation;',om='AnswerWrapper',De='Application encountered a problem contacting StreamSpin\nPlease reload the application\n\nIf the problem persist StreamSpin may be down for maintenance\n\n',gk='ArrayList',wn='ArrayStoreException',Bl='AttrImpl',xn='Boolean',uf='Both username and password has to be filled out',ec='Bottom',ck='Button',bk='ButtonBase',El='CDATASectionImpl',vc='CENTER',bn='CSS1Compat',ep="Can't overwrite cause",sg='Cancel',bp='Cannot set a new parent without first clearing the old parent',dk='CellPanel',aq='Center',hk='ChangeListenerCollection',Cl='CharacterDataImpl',vf='Check',Bn='Class',Cn='ClassCastException',jk='ClickListenerCollection',zj='ClippedImagePrototype',ql='CommandCanceledException',rl='CommandExecutor',tl='CommandExecutor$1',wl='CommandExecutor$2',sl='CommandExecutor$CircularIterator',Fl='CommentImpl',Ej='ComplexPanel',gc='Content',lj='ContentFetchedHandler$ContentFetchedEvent',pm='ContentPopup',qm='ContentPopup$1',rm='ContentPopup$2',sm='ContentPopup$3',nb='DIV',cm='DOMException',cj='DOMImpl',ej='DOMImplOpera',dj='DOMImplStandard',zl='DOMItem',lm='DOMMouseScroll',dm='DOMParseException',kg='Damn!!\nAn Exception getting content from streamspin..\n\n',mk='DecoratedPopupPanel',nk='DecoratorPanel',ah='Dell1',bh='Dell2',em='DocumentFragmentImpl',fm='DocumentImpl',vj='DocumentRootImpl',Dn='Double',oj='DynamicHeightFeature',gm='ElementImpl',ff='Enable debug Mode',tj='Enum',mj='Event$2',jj='EventObject',Bi='Exception',nh='Exception!\nCould not parse content update: \n\n',gf='Exit',Cd='Failed to parse: ',ak='FocusWidget',Fh='For input string: "',ug='Friend1',Eg='Friend10',Fg='Friend11',vg='Friend2',wg='Friend3',xg='Friend4',yg='Friend5',Ag='Friend6',Bg='Friend7',Cg='Friend8',Dg='Friend9',qg='GPS Default: ',rg='GPS Threshhold: ',pj='Gadget',pk='HTML',qk='HasHorizontalAlignment$HorizontalAlignmentConstant',rk='HasVerticalAlignment$VerticalAlignmentConstant',uo='HashMap',vo='HashSet',sk='HorizontalPanel',Fd='INPUT',zf='Id: ',En='IllegalArgumentException',Fn='IllegalStateException',uk='Image',vk='Image$State',wk='Image$UnclippedState',tp='Index: ',vn='IndexOutOfBoundsException',eq='Inner',qj='IntrinsicFeature',rj='IntrinsicFeature$2',Fi='JavaScriptException',aj='JavaScriptObject$',ok='Label',Fp='Left',xk='ListBox',tm='Location',ag='Login Screen',wf='Longtitude: ',wo='MapEntryImpl',mf='Menu',yk='MenuBar',zk='MenuBar$1',Ak='MenuBar$2',Bk='MenuBar_MenuBarImages_generatedBundle',Ck='MenuItem',dc='Middle',ef='No Interests Profiles found',cf='No Predefined Locations',df='No Service Subscriptions found',xo='NoSuchElementException',Al='NodeImpl',hm='NodeListImpl',po='Null widget handle. If you are creating a composite, ensure that initWidget() has been called.',ao='NullPointerException',zn='Number',bo='NumberFormatException',wc='ONE_WAY_CORNER',qi='Object',ho='Object;',Fe='Off',Ee='On',Cj='Panel',al='PasswordTextBox',Ab='Popup',bl='PopupListenerCollection',lk='PopupPanel',cl='PopupPanel$AnimationType',dl='PopupPanel$ResizeAnimation',el='PopupPanel$ResizeAnimation$1',im='ProcessingInstructionImpl',um='Profile',bq='Right',fl='RootPanel',hl='RootPanel$1',gl='RootPanel$DefaultRootPanel',Di='RuntimeException',ih='Selected items: ',pp='Self-causation not permitted',ue='Send Message',vm='ServiceProfile',jf='Set Location',lf='Set Profile',Eo="Should only call onAttach when the widget is detached from the browser's document",Fo="Should only call onDetach when the widget is attached to the browser's document",kk='SimplePanel',il='SimplePanel$1',fo='StackTraceElement;',kf='Start Service',xm='StartService',qf='Status: <b>Offline<\/b>',pf='Status: <b>Online<\/b>',ym='StreamSpinClient',an='StreamSpinClient$1',cn='StreamSpinClient$2',dn='StreamSpinClient$3',en='StreamSpinClient$4',fn='StreamSpinClient$5',gn='StreamSpinClient$6',hn='StreamSpinClient$6$1',jn='StreamSpinClient$7',kn='StreamSpinClient$8',Cm='StreamSpinClient$mainTopWindowListBoxContentupdate',Dm='StreamSpinClient$mainTopWindowListBoxContentupdate$1',zm='StreamSpinClient$setLocation',Bm='StreamSpinClient$setProfile',Am='StreamSpinClient$startService',Em='StreamSpinClient$startUpLoadingScreen',Fm='StreamSpinClient$startUpLoadingScreen$1',ln='StreamSpinClientGadgetImpl',mn='StreamSpinContact',on='StreamSpinContact$1',pn='StreamSpinContact$2',ic='String',gj='String;',co='StringBuffer',yi='StringBufferImpl',zi='StringBufferImplAppend',yo='Style names cannot be empty',bf='TBODY',we='TR',kl='TextArea',Fk='TextBox',Dk='TextBoxBase',Dl='TextImpl',ap="This widget's parent does not implement HasWidgets",Ai='Throwable',vi='Timer',xl='Timer$1',cc='Top',Aj='UIObject',go='UnsupportedOperationException',af='Use GPS',pg='User id: ',qn='UserInfo',rn='UserMessage',sn='UserMessage$1',tn='UserMessage$2',ll='VerticalPanel',Bj='Widget',nl='Widget;',ol='WidgetCollection',pl='WidgetCollection$WidgetIterator',hf='Write Message',jm='XMLParserImpl',mm='XMLParserImplOpera',km='XMLParserImplStandard',un='XmlParser',xe='You can send messages to your friends with this',tf='You selected a menu item which has not yet been implemented!',np='[',An='[C',ni='[Lcom.google.gwt.animation.client.',ml='[Lcom.google.gwt.user.client.ui.',fj='[Ljava.lang.',qp=']',zd=']]>',Ce='__gwt_gadget_content_div',eg='a problem.. the google url-translation feature has failed..',zc='absolute',mp='align',Cb='aria-activedescendant',mc='aria-haspopup',dg='blur',nq='bottom',gp='button',Dp='cellPadding',Cp='cellSpacing',lq='center',og='change',Eh='class ',yn='className',hd="clear.cache.gif' style='",zg='click',xc='clip',yf='cmd cannot be null',Fb='colSpan',si='com.google.gwt.animation.client.',Ei='com.google.gwt.core.client.',xi='com.google.gwt.core.client.impl.',bj='com.google.gwt.dom.client.',nj='com.google.gwt.gadgets.client.',kj='com.google.gwt.gadgets.client.event.',ui='com.google.gwt.user.client.',uj='com.google.gwt.user.client.impl.',wj='com.google.gwt.user.client.ui.',yj='com.google.gwt.user.client.ui.impl.',bm='com.google.gwt.xml.client.',yl='com.google.gwt.xml.client.impl.',nm='com.streamspin.client.',mi='com.streamspin.client.StreamSpinClient',mg='contactStreamSpin AS timer\n',cg='contactStreamSpin BF timer\n',lg='contactStreamSpin IN timer\n',fg='contactStreamSpinAsync ',mh='content',wm='contextmenu',eh='dblclick',th='defaulton',vp='div',vl='error',Ch='false',ph='focus',ch='foo',fh='funny',ci='g',hp='gwt-Button',fc='gwt-DecoratedPopupPanel',cq='gwt-DecoratorPanel',hq='gwt-HTML',jb='gwt-Image',gq='gwt-Label',lb='gwt-ListBox',qb='gwt-MenuBar',zb='gwt-MenuBarPopup',jc='gwt-MenuItem',uc='gwt-PasswordTextBox',wp='gwt-PopupPanel',ad='gwt-TextArea',rc='gwt-TextBox',nf='gwt-uid-',lh='headline',eo='height',ul='hidden',wb='hideFocus',tb='horizontal',gg='http://webclient.streamspin.com/Default.aspx?type=',ae='http://www.mozilla.org/newlayout/xml/parsererror.xml',Eb='id',Cf='images/ajax-loader.gif" /> ',Ff='images/daisy.gif',kb='img',Dh='interface ',pi='java.lang.',ij='java.util.',sf='jeppe',rf='jeppejeppe',Ah='keydown',gi='keypress',ri='keyup',cp='left',Ci='load',sh='location',rh='locations',hj='losecapture',yb='menuPopup',pb='menubar',kc='menuitem',Ec='message',oq='middle',ki='moduleStartup',sj='mousedown',Dj='mousemove',ik='mouseout',tk='mouseover',Ek='mouseup',am='mousewheel',kh='msg',zo='must be positive',tc='name',jq='normal',kq='nowrap',Db='null',gb='offsetHeight',ve='offsetWidth',li='onModuleLoadStart',mb='option',ub='outline',fi='overflow',Ed='parsererror',sc='password',xp='popupContent',fp='position',yh='profile',xh='profiles',Bp='px',fd='px ',Cc='px)',Bc='px, ',dd='px; background: url(',cd='px; height: ',ai='radix ',nc='readOnly',oc='readonly',Ac='rect(',Dc='rect(0px, 0px, 0px, 0px)',yc='rect(auto, auto, auto, auto)',mq='right',ob='role',jl='scroll',ke='select',lc='selected',Bh='serviceprofile',zh='serviceprofiles',Ef='someTest',wh='startservice',vh='startservices',ji='startup',gh='stuff',bc='subMenuIcon',Bb='subMenuIcon-selected',ip='submit',kp='table',lp='tbody',dq='td',qc='text',Dd='text/xml',Fc='textarea',nn='title',ye='title of Main Window',jd='toString',dp='top',dh='tqg',Ep='tr',uh='treshhold',xb='true',jp='type',qh='uid',ac='vAlign',pc='value',rb='vertical',ib='verticalAlign',yp='visibility',zp='visible',iq='whiteSpace',Bo='width',bd='width: ',ei='{',ii='}';var _;function y5(a){return this===(a==null?null:a)}
...
function EX(){}
_=EX.prototype=new w5();_.gC=cY;_.tS=dY;_.tI=74;_.a=null;_.b=0;_.c=null;function E0(b){var a;z0(b);FI(b.j,xY(new wY(),b));ft((zs(),b.j.x),ue);eR(b.j,xe);ft(b.q.x,ye);eK(b.h,b.g);eK(b.h,b.q);eK(b.h,b.j);xH(b.h,b.g,(sJ(),vJ));xH(b.h,b.q,tJ);xH(b.h,b.j,wJ);b.h.x.style[Bo]=ze;a=gZ(new fZ(),b);CE(a,15000);FI(b.l,bZ(new BY(),b));b.l.x.size=35;b.l.x.style[Bo]=ze;rR(b.m,b.l);b.m.x.style[eo]=Ae;b.m.x.style[Bo]=ze;B0(b,(g3(),i3));rR(b.i,b.h);rR(b.i,b.m);rR(b.i,b.k);b.i.x.style[eo]=Be;b.i.x.style[Bo]=ze;aH((mP(),qP(null)),b.i);qP(Ce);$wnd._IG_AdjustIFrameHeight()}
function z0(p){var a,c,d,e,f,g,h,i,j,k,l,m,n,o;g=null;try{g=y2((D2(),p.o.a))}catch(a){a=jC(a);if(tw(a,20)){d=a;$wnd.alert(De+j7(d))}else throw a}c=AL(new mL(),true);CL(c,DM(new CM(),Ee,p.n));CL(c,DM(new CM(),Fe,p.n));m=AL(new mL(),true);CL(m,DM(new CM(),af,p.a));if(g.c.b==0){CL(m,DM(new CM(),cf,p.a))}for(f=k9(new i9(),g.c);f.a<f.b.zb();){e=qw(n9(f),21);CL(m,DM(new CM(),e.c,AZ(new zZ(),e.b,e.a)))}o=AL(new mL(),true);if(g.f.b==0){CL(o,DM(new CM(),df,p.a))}for(l=k9(new i9(),g.f);l.a<l.b.zb();){k=qw(n9(l),22);CL(o,DM(new CM(),k.a,e0(new d0(),k.b,k.c)))}n=AL(new mL(),true);if(g.d.b==0){CL(n,DM(new CM(),ef,p.a))}for(j=k9(new i9(),g.d);j.a<j.b.zb();){i=qw(n9(j),23);CL(n,DM(new CM(),i.b,FZ(new EZ(),i.a)))}h=AL(new mL(),true);CL(h,EM(new CM(),ff,c));CL(h,DM(new CM(),gf,p.n));CL(h,DM(new CM(),hf,p.r));CL(h,EM(new CM(),jf,m));CL(h,EM(new CM(),kf,o));CL(h,EM(new CM(),lf,n));CL(p.g,EM(new CM(),mf,h));p.g.b=false;p.g.x.style[Bo]=of}
function B0(b,a){if(a.a){b.k.x.innerHTML=pf}else{b.k.x.innerHTML=qf}}
function d1(){return sA}
function e1(a){}
function f1(a){g1=a}
function eY(){}
_=eY.prototype=new Bu();_.gC=d1;_.hb=e1;_.ib=f1;_.tI=0;_.p=0;var a1=rf,b1=-1,c1=sf,g1=null;function hY(){}
function iY(){return bA}
function fY(){}
_=fY.prototype=new w5();_.E=hY;_.gC=iY;_.tI=75;function lY(){$wnd.alert(tf)}
...
function jZ(){var a;++this.a.p;a=new oW();a.a=null;w1(t1(new h1()),2,a);CE(wZ(new pZ(),a,this.a).c,20)}
function fZ(){}
_=fZ.prototype=new tE();_.gC=iZ;_.ub=jZ;_.tI=81;_.a=null;function lZ(b,a){b.a=a;return b}
function nZ(){return jA}
function oZ(a){if(st(this.a.e.x,pc).length>0&&st(this.a.d.x,pc).length>0){c1=st(this.a.e.x,pc);a1=st(this.a.d.x,pc);cH((mP(),qP(null)),this.a.c);w1(t1(new h1()),8,this.a.o);o0(new i0(),this.a)}else{$wnd.alert(uf)}}
function kZ(){}
...
function uZ(){var a,b,c;if(this.a.a.a!=null){zE(this);$wnd.alert(vf+this.a.b.p+de+this.a.a.a);hL(this.a.b.l,vf+this.a.b.p,this.a.a.a,-1);if(this.a.a.a.length){c=x2((D2(),this.a.a.a));for(b=k9(new i9(),c);b.a<b.b.zb();){a=qw(n9(b),24);hL(this.a.b.l,a.b,a.a,-1)}this.a.a.a=fq}}}
function qZ(){}
_=qZ.prototype=new tE();_.gC=tZ;_.ub=uZ;_.tI=83;_.a=null;function AZ(c,b,a){c.b=b;c.a=a;return c}
function CZ(){$wnd.alert(wf+this.b+xf+this.a)}
function DZ(){return mA}
function zZ(){}
_=zZ.prototype=new w5();_.E=CZ;_.gC=DZ;_.tI=84;_.a=null;_.b=null;function FZ(b,a){b.a=a;return b}
function b0(){$wnd.alert(zf+this.a)}
function c0(){return nA}
function EZ(){}
_=EZ.prototype=new w5();_.E=b0;_.gC=c0;_.tI=85;_.a=0;function e0(c,b,a){c.a=b;c.b=a;return c}
function g0(){$wnd.alert(zf+this.a+Af+this.b)}
function h0(){return oA}
function d0(){}
_=d0.prototype=new w5();_.E=g0;_.gC=h0;_.tI=86;_.a=0;_.b=null;function o0(d,c){var a,b,e;d.a=c;nO(d);d.k=false;AO(d);b=d;a=fJ(new eJ());a.x.innerHTML=Bf+$moduleBase+Cf+Df||fq;cR(a,fq+AG().clientWidth*0.95,fq+AG().clientHeight*0.9);DP(d,a);tO(d);e=k0(new j0(),d,b);CE(e,1000);return d}
...
function j0(){}
_=j0.prototype=new tE();_.gC=m0;_.ub=n0;_.tI=88;_.a=null;_.b=null;function s0(a){a.i=qR(new oR());a.h=dK(new bK());a.m=qR(new oR());a.l=aL(new FK(),false);a.f=lQ(new kQ());a.g=zL(new mL());a.j=pH(new jH(),Ef);a.k=yK(new xK());a.q=fJ(new eJ());a.c=qR(new oR());a.e=wQ(new oQ());a.d=mN(new lN());a.b=oH(new jH());sK(new jK(),$moduleBase+Ff);a.o=new oW();a.a=new fY();a.n=new jY();oY(new nY(),a);a.r=new sY();a.hb(new wu());a.ib(new Fu());ft((zs(),a.q.x),ag);a.b.x.innerHTML=bg;FI(a.b,lZ(new kZ(),a));rR(a.c,a.q);rR(a.c,a.e);rR(a.c,a.d);rR(a.c,a.b);aH((mP(),qP(null)),a.c);return a}
function v0(){return rA}
function r0(){}
_=r0.prototype=new eY();_.gC=v0;_.tI=0;function t1(a){a.a=g1;return a}
function w1(d,c,b){var a,e;v1(d,c);a=b;$wnd.alert(cg+a.a+de+b.a);e=j1(new i1(),d,a);CE(e,200)}
function v1(e,d){var a,c,f;if(!e.a){$wnd.alert(eg)}$wnd.alert(fg+e.b);f=gg+d+hg+c1+ig+a1+jg+b1;try{hv(f,bv(new av(),o1(new n1(),e)),10)}catch(a){a=jC(a);if(tw(a,20)){c=a;$wnd.alert(kg+j7(c))}else throw a}}
...
function m1(){if(this.a.b!=null){$wnd.alert(lg+this.b.a+de);this.b.a=this.a.b;$wnd.alert(mg+this.b.a+de);this.a.b=null;zE(this)}}
function i1(){}
