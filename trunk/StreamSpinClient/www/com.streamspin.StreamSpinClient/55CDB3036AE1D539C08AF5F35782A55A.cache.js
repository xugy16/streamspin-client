(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var cn='',je='\n',me='\n\n',od='\n ',ie='\nElements:\n',he='\nNum of msg: ',xl=' ',kd='"',id='&',jd='&amp;',nd='&apos;',sd='&gt;',qd='&lt;',ld='&quot;',hd='&semi;',md="'",Dc="' border='0'>",bb='(',fd='(?=[;&<>\'"])',zl='(null handle)',zc=') no-repeat ',mb='): ',ce='*',nm=', ',sm=', Size: ',Bl='-',wd='-->',cb='0',pb='0px',lf='100%',of='100px',nf='150px',pf='300px',bc='548CDF11D6FE9011F3447CA200D7FB7F.cache.png',ff='65px',wf=':',xm=': ',gd=';',pd='<',vd='<!--',td='<![CDATA[',Ec='<div><\/div>',Bc="<img src='",yf='=',rd='>',F='@',rh='AbsolutePanel',xh='AbstractCollection',Ck='AbstractHashMap',Ek='AbstractHashMap$EntrySet',Fk='AbstractHashMap$EntrySetIterator',bl='AbstractHashMap$MapEntryNull',cl='AbstractHashMap$MapEntryString',ih='AbstractImagePrototype',yh='AbstractList',el='AbstractList$IteratorImpl',Bk='AbstractMap',fl='AbstractMap$1',gl='AbstractMap$1$1',al='AbstractMapEntry',Dk='AbstractSet',pm='Add not supported on this collection',qm='Add not supported on this list',eg='Animation',hg='Animation$1',ag='Animation;',zh='ArrayList',ok='ArrayStoreException',nj='AttrImpl',pk='Boolean',Eb='Bottom',vh='Button',th='ButtonBase',qj='CDATASectionImpl',kc='CENTER',ql='CSS1Compat',bm="Can't overwrite cause",Fl='Cannot set a new parent without first clearing the old parent',wh='CellPanel',Em='Center',oj='CharacterDataImpl',rk='Class',sk='ClassCastException',Ah='ClickListenerCollection',lh='ClippedImagePrototype',dj='CommandCanceledException',ej='CommandExecutor',gj='CommandExecutor$1',hj='CommandExecutor$2',fj='CommandExecutor$CircularIterator',rj='CommentImpl',qh='ComplexPanel',ac='Content',ke='Content:\n',Cg='ContentFetchedHandler$ContentFetchedEvent',Ej='ContentPopup',Fj='ContentPopup$1',ak='ContentPopup$2',bk='ContentPopup$3',Al='DIV',tj='DOMException',ug='DOMImpl',wg='DOMImplMozilla',vg='DOMImplStandard',kj='DOMItem',ml='DOMMouseScroll',uj='DOMParseException',be='Damn!!\nAn Exception getting content from streamspin..\n\n',Dh='DecoratedPopupPanel',Eh='DecoratorPanel',vj='DocumentFragmentImpl',wj='DocumentImpl',gh='DocumentRootImpl',ah='DynamicHeightFeature',yj='ElementImpl',Ee='Enable debug Mode',eh='Enum',Dg='Event$2',Ag='EventObject',ng='Exception',Fe='Exit',xd='Failed to parse: ',sh='FocusWidget',bh='Gadget',ci='HTML',di='HasHorizontalAlignment$HorizontalAlignmentConstant',ei='HasVerticalAlignment$VerticalAlignmentConstant',hl='HashMap',il='HashSet',fi='HorizontalPanel',zd='INPUT',tk='IllegalArgumentException',uk='IllegalStateException',gi='Image',hi='Image$State',ii='Image$UnclippedState',rm='Index: ',mk='IndexOutOfBoundsException',dn='Inner',ch='IntrinsicFeature',dh='IntrinsicFeature$2',qg='JavaScriptException',rg='JavaScriptObject$',bi='Label',Dm='Left',ji='ListBox',cd='Macintosh',jl='MapEntryImpl',ef='Menu',ki='MenuBar',mi='MenuBar$1',ni='MenuBar$2',oi='MenuBar_MenuBarImages_generatedBundle',pi='MenuItem',Db='Middle',pl='MouseEvents',Ed='New Item',kl='NoSuchElementException',lj='NodeImpl',zj='NodeListImpl',ul='Null widget handle. If you are creating a composite, ensure that initWidget() has been called.',vk='NullPointerException',lc='ONE_WAY_CORNER',cg='Object',Ak='Object;',ph='Panel',si='PasswordTextBox',ub='Popup',mh='PopupImplMozilla$1',ti='PopupListenerCollection',Ch='PopupPanel',ui='PopupPanel$AnimationType',vi='PopupPanel$ResizeAnimation',xi='PopupPanel$ResizeAnimation$1',Aj='ProcessingInstructionImpl',Ce='Profile 1',De='Profile 2',Fm='Right',yi='RootPanel',Ai='RootPanel$1',zi='RootPanel$DefaultRootPanel',og='RuntimeException',mm='Self-causation not permitted',hf='Send Message',df='Set Profile',bf='SetLocation',Cl="Should only call onAttach when the widget is detached from the browser's document",Dl="Should only call onDetach when the widget is attached to the browser's document",Bh='SimplePanel',Bi='SimplePanel$1',xk='StackTraceElement;',cf='Start Service',Dd='Status: <b>Offline<\/b>',Cd='Status: <b>Online<\/b>',dk='StreamSpinClient',ek='StreamSpinClient$1',fk='StreamSpinClient$2',gk='StreamSpinClient$3',hk='StreamSpinClient$4',ik='StreamSpinClient$5',jk='StreamSpinClient$6',kk='StreamSpinClient$8',lk='StreamSpinClientGadgetImpl',cc='String',yg='String;',wk='StringBuffer',kg='StringBufferImpl',lg='StringBufferImplAppend',vl='Style names cannot be empty',Ci='TextArea',ri='TextBox',qi='TextBoxBase',pj='TextImpl',mf='This is some content that should show how the widget handles stuff,\n <b> wwwwwwwwwww wwwwwwwwww wwwwwwwwww wwwwew rw er<\/b>',El="This widget's parent does not implement HasWidgets",mg='Throwable',gg='Timer',ij='Timer$1',Cb='Top',nh='UIObject',zk='UnsupportedOperationException',ye='Use GPS',Di='VerticalPanel',oh='Widget',Fi='Widget;',aj='WidgetCollection',cj='WidgetCollection$WidgetIterator',af='Write Message',Bj='XMLParserImpl',Cj='XMLParserImplStandard',jf='You can send messages to your friends with this',ne='You selected a menu item!',lm='[',qk='[C',Ff='[Lcom.google.gwt.animation.client.',Ei='[Lcom.google.gwt.user.client.ui.',xg='[Ljava.lang.',om=']',ud=']]>',qf='__gwt_gadget_content_div',oc='absolute',km='align',wb='aria-activedescendant',gc='aria-haspopup',ed='auto',ze='bar',gf='blur',mn='bottom',em='button',Bm='cellPadding',Am='cellSpacing',kn='center',sf='change',uf='class ',sl='className',Cc="clear.cache.gif' style='",Df='click',Fc='clip',Fd='cmd',Be='cmd cannot be null',zb='colSpan',dg='com.google.gwt.animation.client.',pg='com.google.gwt.core.client.',jg='com.google.gwt.core.client.impl.',sg='com.google.gwt.dom.client.',Fg='com.google.gwt.gadgets.client.',Bg='com.google.gwt.gadgets.client.event.',fg='com.google.gwt.user.client.',fh='com.google.gwt.user.client.impl.',hh='com.google.gwt.user.client.ui.',kh='com.google.gwt.user.client.ui.impl.',sj='com.google.gwt.xml.client.',jj='com.google.gwt.xml.client.impl.',Dj='com.streamspin.client.',Ef='com.streamspin.client.StreamSpinClient',ge='content',nl='contextmenu',ig='dblclick',ad='display',tm='div',yk='error',rf='false',tg='focus',xe='foo',vf='g',fm='gwt-Button',Fb='gwt-DecoratedPopupPanel',an='gwt-DecoratorPanel',fn='gwt-HTML',eb='gwt-Image',en='gwt-Label',gb='gwt-ListBox',kb='gwt-MenuBar',tb='gwt-MenuBarPopup',dc='gwt-MenuItem',ue='gwt-PasswordTextBox',um='gwt-PopupPanel',uc='gwt-TextArea',se='gwt-TextBox',qe='gwt-uid-',fe='headline',tl='height',ll='hidden',qb='hideFocus',nb='horizontal',ol='html',ae='http://streamspin-client.googlecode.com/svn/trunk/StreamSpinClient/www/com.streamspin.StreamSpinClient/content.xml',Bd='http://www.mozilla.org/newlayout/xml/parsererror.xml',yb='id',ve='images/daisy.gif',fb='img',tf='interface ',bg='java.lang.',zg='java.util.',Eg='keydown',jh='keypress',uh='keyup',am='left',ai='load',li='losecapture',Ae='menu',sb='menuPopup',jb='menubar',ec='menuitem',yc='message',nn='middle',Bf='moduleStartup',wi='mousedown',bj='mousemove',mj='mouseout',xj='mouseover',ck='mouseup',dl='mousewheel',de='msg',wl='must be positive',nc='name',bd='none',hn='normal',jn='nowrap',xb='null',ab='offsetHeight',pe='offsetWidth',Cf='onModuleLoadStart',hb='option',ob='outline',Fh='overflow',Ad='parsererror',te='password',vm='popupContent',dm='position',wm='px',Ac='px ',rc='px)',qc='px, ',xc='px; background: url(',wc='px; height: ',hc='readOnly',ic='readonly',pc='rect(',sc='rect(0px, 0px, 0px, 0px)',mc='rect(auto, auto, auto, auto)',ln='right',ib='role',nk='scroll',ee='select',fc='selected',oe='someTest',Af='startup',Bb='subMenuIcon',vb='subMenuIcon-selected',gm='submit',im='table',jm='tbody',bn='td',re='text',yd='text/xml',tc='textarea',we='the',le='there is an exception:\n',rl='title',kf='title of Main Window',dd='toString',cm='top',Cm='tr',rb='true',hm='type',Ab='vAlign',jc='value',lb='vertical',db='verticalAlign',ym='visibility',zm='visible',gn='whiteSpace',yl='width',vc='width: ',xf='{',zf='}';var _;function lW(a){return this===(a==null?null:a)}
...
function oS(f,d){var a,b,c,e;pS();zJ(f,true);e=f;c=yE(new wE(),d,false);lG(c,aS(new FR(),e));a=kG(new iG(),d);lG(a,fS(new eS(),e));b=xL(new wL());b.r[jc]=d!=null?d:cn;EL(b,true);rE(b,kS(new jS(),e));jL(f,b);FJ(f);return f}
...
function jS(){}
_=jS.prototype=new jW();_.gC=mS;_.gb=nS;_.tI=69;_.a=null;function DT(b,a){if(a.a){b.h.r.innerHTML=Cd}else{b.h.r.innerHTML=Dd}}
function bU(a){uG(a.i,Ed,Fd,-1);DT(a,(oU(),pU))}
function cU(d){var a,c;try{ds(ae,Dr(new Cr(),qT(new pT(),d)),10)}catch(a){a=jy(a);if(pt(a,19)){c=a;$wnd.alert(be+c.D())}else throw a}return d.l}
function dU(l,m){var a,c,d,e,f,g,h,i,j,k,n;try{n=(kP(),tR(lP,m));k=mt(vQ((sR(),n.a.documentElement)),20);j=zQ(new yQ(),k.a.getElementsByTagNameNS(ce,de)).a.length;f=mt(BQ(zQ(new yQ(),k.a.getElementsByTagNameNS(ce,fe)),0),20);c=mt(BQ(zQ(new yQ(),k.a.getElementsByTagNameNS(ce,ge)),0),20);g=BQ(zQ(new yQ(),f.a.childNodes),0).tS();d=BQ(zQ(new yQ(),c.a.childNodes),0).tS();for(h=0;h<j;++h){f=mt(BQ(zQ(new yQ(),k.a.getElementsByTagNameNS(ce,fe)),h),20);c=mt(BQ(zQ(new yQ(),k.a.getElementsByTagNameNS(ce,ge)),h),20);g=BQ(zQ(new yQ(),f.a.childNodes),0).tS();d=BQ(zQ(new yQ(),c.a.childNodes),0).a.nodeValue;sG(l.i,g);i=(Bp(),l.i.r).options.length;n1(l.b,i-1,oS(new ER(),d))}FL(l.c,k.a.nodeName+he+j+ie+f+je+c+je+ke+g+je+d+je)}catch(a){a=jy(a);if(pt(a,19)){e=a;$wnd.alert(le+e.D()+me+bt(fy,0,31,0,0))}else throw a}}
function eU(){return Dw}
function gU(a){}
function fU(a){}
function rS(){}
_=rS.prototype=new xr();_.gC=eU;_.cb=gU;_.bb=fU;_.tI=0;_.l=null;function uS(){$wnd.alert(ne)}
...
function pT(){}
_=pT.prototype=new jW();_.gC=tT;_.tI=0;_.a=null;function vT(l){var a,c,e,g,i,k;l.f=AM(new yM());l.e=uF(new sF());l.j=AM(new yM());l.i=rG(new qG(),false);l.c=xL(new wL());l.d=fH(new yG());l.g=hD(new bD(),oe);l.h=jG(new iG());l.n=xE(new wE());AM(new yM());cM(new AL(),Dp((Bp(),re)),se);cM(new xI(),(a=$doc.createElement(zd),a.type=te,a),ue);gD(new bD());dG(new AF(),$moduleBase+ve);l.b=m1(new l1());l.a=new sS();xS(new wS(),l);l.m=CS(new BS(),l);l.k=bT(new aT(),l);l.bb(new sr());l.cb(new Br());c=gH(new yG(),true);iH(c,jI(new iI(),we,l.a));iH(c,jI(new iI(),xe,l.a));g=gH(new yG(),true);iH(g,jI(new iI(),ye,l.k));iH(g,jI(new iI(),we,l.a));iH(g,jI(new iI(),ze,l.a));iH(g,jI(new iI(),Ae,l.a));k=gH(new yG(),true);iH(k,jI(new iI(),we,l.a));iH(k,jI(new iI(),ze,l.a));iH(k,jI(new iI(),Ae,l.a));i=gH(new yG(),true);iH(i,jI(new iI(),Ce,l.a));iH(i,jI(new iI(),De,l.a));e=gH(new yG(),true);iH(e,kI(new iI(),Ee,c));iH(e,jI(new iI(),Fe,l.m));iH(e,jI(new iI(),af,l.k));iH(e,kI(new iI(),bf,g));iH(e,kI(new iI(),cf,k));iH(e,kI(new iI(),df,i));iH(l.d,kI(new iI(),ef,e));l.d.b=false;l.d.r.style[yl]=ff;rE(l.g,gT(new fT(),l));fq(l.g.r,hf);oM(l.g,jf);fq(l.n.r,kf);vF(l.e,l.d);vF(l.e,l.n);vF(l.e,l.g);pD(l.e,l.d,(dF(),gF));pD(l.e,l.n,eF);pD(l.e,l.g,hF);l.e.r.style[yl]=lf;rE(l.i,lT(new kT(),l));l.i.r.size=5;l.i.r.style[yl]=lf;l.c.r[jc]=mf!=null?mf:cn;EL(l.c,true);l.c.r.style[yl]=lf;l.c.r.style[tl]=nf;BM(l.j,l.i);BM(l.j,l.c);l.j.r.style[tl]=of;l.j.r.style[yl]=lf;DT(l,(oU(),oU(),qU));BM(l.f,l.e);BM(l.f,l.j);BM(l.f,l.h);l.f.r.style[tl]=pf;l.f.r.style[yl]=lf;yC((yK(),CK(null)),l.f);CK(qf);$wnd._IG_AdjustIFrameHeight();return l}
