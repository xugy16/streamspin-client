...
function dS(){}
_=dS.prototype=new kS();_.gC=iS;_.tI=0;function nT(f,d){var a,b,c,e;jK(f);f.e=true;e=f;c=hF(new fF(),d,false);AG(c,FS(new ES(),e));a=zG(new xG(),d);AG(a,eT(new dT(),e));b=gM(new fM());b.r[kc]=d!=null?d:fn;nM(b,true);DM(b,fn+(yC(),zC).clientWidth*0.8,fn+($wnd.devicePixelRatio?zC.clientHeight:$wnd.innerHeight)*0.85);FE(b,jT(new iT(),e));yL(f,b);oK(f);return f}
...
function iT(){}
_=iT.prototype=new nX();_.gC=lT;_.hb=mT;_.tI=68;_.a=null;function FU(l,m){var a,c,d,e,f,g,h,i,j,k,n;try{n=(eQ(),sS(fQ,m));k=pt(pR((rS(),n.a.documentElement)),20);j=tR(new sR(),k.a.getElementsByTagName(Ed)).a.length;f=pt(vR(tR(new sR(),k.a.getElementsByTagName(Fd)),0),20);c=pt(vR(tR(new sR(),k.a.getElementsByTagName(ae)),0),20);g=vR(tR(new sR(),f.a.childNodes),0).tS();d=vR(tR(new sR(),c.a.childNodes),0).tS();for(h=0;h<j;++h){f=pt(vR(tR(new sR(),k.a.getElementsByTagName(Fd)),h),20);c=pt(vR(tR(new sR(),k.a.getElementsByTagName(ae)),h),20);g=vR(tR(new sR(),f.a.childNodes),0).tS();d=vR(tR(new sR(),c.a.childNodes),0).a.nodeValue;bH(l.i,g);i=(Dp(),l.i.r).children.length;r2(l.b,i-1,nT(new DS(),d))}oM(l.c,k.a.nodeName+be+j+ce+f+de+c+de+fe+g+de+d+de)}catch(a){a=ry(a);if(st(a,19)){e=a;$wnd.alert(ge+e.E()+he+et(ny,0,31,0,0))}else throw a}}
function cV(b,a){if(a.a){b.h.r.innerHTML=ie}else{b.h.r.innerHTML=je}}
function gV(a){dH(a.i,ke,le,-1);cV(a,(sV(),tV))}
function hV(d){var a,c;try{gs(me,as(new Fr(),uU(new tU(),d)),10)}catch(a){a=ry(a);if(st(a,19)){c=a;$wnd.alert(ne+c.E())}else throw a}return d.l}
function iV(){return fx}
function kV(a){}
function jV(a){}
function qT(){}
_=qT.prototype=new Ar();_.gC=iV;_.db=kV;_.cb=jV;_.tI=0;_.l=null;function tT(){$wnd.alert(oe)}
function uT(){return Cw}
function rT(){}
_=rT.prototype=new nX();_.z=tT;_.gC=uT;_.tI=69;function wT(b,a){b.a=a;return b}
function yT(){gV(this.a)}
function zT(){return Dw}
function vT(){}
_=vT.prototype=new nX();_.z=yT;_.gC=zT;_.tI=70;_.a=null;function BT(b,a){b.a=a;return b}
function DT(){hV(this.a)}
function ET(){return Ew}
function AT(){}
_=AT.prototype=new nX();_.z=DT;_.gC=ET;_.tI=71;_.a=null;function aU(b,a){b.a=a;return b}
function cU(){FU(this.a,this.a.l)}
...
function tU(){}
_=tU.prototype=new nX();_.gC=xU;_.tI=0;_.a=null;function zU(k){var b,d,f,h,j;k.f=lN(new jN());k.e=dG(new bG());k.j=lN(new jN());k.i=aH(new FG(),false);k.c=gM(new fM());k.d=uH(new hH());k.g=sD(new mD(),re);k.h=yG(new xG());k.n=gF(new fF());lN(new jN());rM(new jM());iJ(new hJ());rD(new mD());sG(new jG(),$moduleBase+se);k.b=q2(new p2());k.a=new rT();wT(new vT(),k);k.m=BT(new AT(),k);k.k=aU(new FT(),k);k.cb(new vr());k.db(new Er());b=vH(new hH(),true);xH(b,zI(new yI(),te,k.a));xH(b,zI(new yI(),ue,k.a));f=vH(new hH(),true);xH(f,zI(new yI(),ve,k.k));xH(f,zI(new yI(),we,k.a));xH(f,zI(new yI(),xe,k.a));xH(f,zI(new yI(),ye,k.a));j=vH(new hH(),true);xH(j,zI(new yI(),we,k.a));xH(j,zI(new yI(),xe,k.a));xH(j,zI(new yI(),ye,k.a));h=vH(new hH(),true);xH(h,zI(new yI(),ze,k.a));xH(h,zI(new yI(),Ae,k.a));d=vH(new hH(),true);xH(d,AI(new yI(),Ce,b));xH(d,zI(new yI(),De,k.m));xH(d,zI(new yI(),Ee,k.k));xH(d,AI(new yI(),Fe,f));xH(d,AI(new yI(),af,j));xH(d,AI(new yI(),bf,h));xH(k.d,AI(new yI(),cf,d));k.d.b=false;k.d.r.style[xl]=df;FE(k.g,fU(new eU(),k));hq((Dp(),k.g.r),ef);FM(k.g,ff);hq(k.n.r,hf);eG(k.e,k.d);eG(k.e,k.n);eG(k.e,k.g);AD(k.e,k.d,(sF(),vF));AD(k.e,k.n,tF);AD(k.e,k.g,wF);k.e.r.style[xl]=jf;FE(k.i,pU(new jU(),k));k.i.r.size=5;k.i.r.style[xl]=jf;k.c.r[kc]=kf!=null?kf:fn;nM(k.c,true);k.c.r.style[xl]=jf;k.c.r.style[yl]=lf;mN(k.j,k.i);mN(k.j,k.c);k.j.r.style[yl]=mf;k.j.r.style[xl]=jf;cV(k,(sV(),sV(),uV));mN(k.f,k.e);mN(k.f,k.j);mN(k.f,k.h);k.f.r.style[yl]=nf;k.f.r.style[xl]=jf;dD((hL(),lL(null)),k.f);lL(of);$wnd._IG_AdjustIFrameHeight();return k}
