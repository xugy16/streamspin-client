(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var E='',C=' ',Fc=', Size: ',ac='-',sb='0',fc='0px',vc='100%',Ac='100px',Cc='10px',Dc=':',Cb='DIV',w='DOMMouseScroll',Ec='Index: ',rc='Item four',nc='Item one',tc='Item six',sc='Item that has a long title and is number five',qc='Item tree',pc='Item two',A='MouseEvents',id='Object;',Bc='Status: <b>Online<\/b>',xc='This is some contense that should show how the widget handles stuff, wwwwwwwwwww wwwwwwwwww wwwwwwwwww wwwwew rw er',gd='Widget;',fd='[Lcom.google.gwt.user.client.ui.',hd='[Ljava.lang.',vb='align',m='blur',ob='bottom',bb='button',tb='cellPadding',rb='cellSpacing',lb='center',x='change',B='className',cb='click',dd='com.streamspin.client.StreamSpinClient',y='contextmenu',nb='dblclick',ib='div',u='error',yb='focus',db='gwt-Button',kb='gwt-HTML',xb='gwt-Image',jb='gwt-Label',Ab='gwt-ListBox',Fb='gwt-MenuBar',jc='gwt-TextArea',yc='height',gc='hideFocus',cc='horizontal',z='html',lc='images/daisy.tif',zb='img',dc='keydown',oc='keypress',zc='keyup',D='left',ed='load',n='losecapture',Eb='menubar',pb='middle',bd='moduleStartup',o='mousedown',p='mousemove',q='mouseout',r='mouseover',s='mouseup',v='mousewheel',cd='onModuleLoadStart',Bb='option',ec='outline',ab='position',mb='right',Db='role',t='scroll',l='select',kc='someTest',ad='startup',eb='submit',gb='table',hb='tbody',ub='td',ic='textarea',mc='title of Main Window',F='top',qb='tr',hc='true',fb='type',wc='value',bc='vertical',wb='verticalAlign',uc='width';var _;function ip(a){return this===(a==null?null:a)}
