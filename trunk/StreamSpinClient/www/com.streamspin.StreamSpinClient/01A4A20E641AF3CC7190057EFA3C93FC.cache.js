...
function e0(a){f0();fN(a,false);a.e=BI(new zI());a.f=jQ(new hQ());a.b=BI(new zI());a.c=eP(new dP());a.h=eG(new EF(),De);a.a=eG(new EF(),hg);a.d=xJ(new wJ(),true);a.g=a;CI(a.e,a.a);CI(a.e,a.h);kQ(a.f,a.c);kQ(a.f,a.e);CI(a.b,a.d);CI(a.b,a.f);BP(a.b,cp+(jF(),lF).clientWidth*0.8,cp+lF.clientHeight*0.8);xH(a.h,AZ(new zZ(),a));DJ(a.d,ig,ig,-1);DJ(a.d,jg,jg,-1);DJ(a.d,kg,kg,-1);DJ(a.d,lg,lg,-1);DJ(a.d,mg,mg,-1);DJ(a.d,ng,ng,-1);DJ(a.d,pg,pg,-1);DJ(a.d,ig,ig,-1);DJ(a.d,jg,jg,-1);DJ(a.d,kg,kg,-1);DJ(a.d,lg,lg,-1);DJ(a.d,mg,mg,-1);DJ(a.d,ng,ng,-1);DJ(a.d,pg,pg,-1);BP(a.d,ef,cp+(parseInt(a.b.w[ve])||0)*0.95);$wnd.alert((parseInt(a.b.w[gb])||0)+yn+(parseInt(a.b.w[ve])||0));a.d.w.size=10;yJ(a.d,FZ(new EZ(),a));sN(a,a.b);jN(a);tN(a);return a}
