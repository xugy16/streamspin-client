...
function aS(j){var a,c,d,e,f,g,h,i;i=De;c=$moduleBase+Ee;h=us(new os(),(ws(),zs),c);try{ys(h,null,oR(new nR(),j));i=Fe+null.Ab()+tg+null.Ab()}catch(a){a=dz(a);if(yu(a,16)){e=a;bN(j.b,af+e.db()+bf+e.e+tg+i+tg+hp()+cf+$moduleBase)}else throw a}d=wQ(df);f=vu(iZ(d.a,0),17);vu(gX(f.a,ef),1);g=vu(iZ(f.b,0),17);f.c+f.e+vu(gX(f.a,ef),1)+f.d+g.c+g.e+g.d}
