...
_=fo.prototype=new kf();_.tI=0;function ho(a){a.c=sm(new qm());a.b=ek(new ck());a.g=sm(new qm());a.f=rk(new qk());a.a=bm(new am());a.d=Bk(new yk());xi(new ti());a.e=mk(new lk());a.h=nj(new mj());ke((de(),a.h.i),kc);vk(a.f,lc,lc,-1);vk(a.f,mc,mc,-1);vk(a.f,nc,nc,-1);vk(a.f,pc,pc,-1);vk(a.f,qc,qc,-1);vk(a.f,rc,rc,-1);a.f.i.size=4;a.f.i.style[sc]=tc;a.a.i[uc]=vc!=null?vc:E;a.a.i.style[sc]=tc;tm(a.g,a.f);tm(a.g,a.a);a.g.i.style[wc]=xc;a.g.i.style[sc]=tc;ke(a.e.i,yc);a.e.i.innerHTML=Ac;fk(a.b,a.d);a.b.i.style[wc]=Bc;a.b.i.style[sc]=tc;tm(a.c,a.h);tm(a.c,a.g);tm(a.c,a.e);tm(a.c,a.d);tm(a.c,a.b);a.c.i.style[wc]=tc;a.c.i.style[sc]=tc;oi((sl(),vl(null)),a.c);return a}
function go(){}
