...
function BZ(e,d){var a,c,f;if(!e.a){$wnd.alert(xf)}f=zf+d+Af;$wnd.alert(f);try{mu(f,gu(new fu(),uZ(new tZ(),e)),10)}catch(a){a=iB(a);if(yv(a,20)){c=a;$wnd.alert(Bf+m5(c))}else throw a}}
