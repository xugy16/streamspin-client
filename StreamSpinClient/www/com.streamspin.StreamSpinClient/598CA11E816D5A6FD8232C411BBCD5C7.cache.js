...
function oT(h){var a,c,d,e,f,g,i;try{i=(jP(),tR(kP,h.k));g=it(vQ((sR(),i.a.documentElement)),21);d=zQ(new yQ(),g.a.getElementsByTagNameNS(Fd,ae)).a.length;f=it(BQ(zQ(new yQ(),g.a.getElementsByTagNameNS(Fd,ae)),0),21);e=zQ(new yQ(),g.a.getElementsByTagNameNS(Fd,be)).a.length;EL(h.b,g.a.nodeValue);$wnd.alert(g.a.nodeValue+ce+g.a.getAttribute(de)+fe+g.a.nodeName+fe+BQ(zQ(new yQ(),f.a.childNodes),0)+fe+f.a.nodeName+fe+f.a.getAttribute(ge)+he+d+wl+e);g.a.nodeValue;g.a.nodeName;g.a.getAttribute(de);f.a.nodeName;BQ(zQ(new yQ(),f.a.childNodes),0);f.a.getAttribute(ge);zQ(new yQ(),g.a.getElementsByTagNameNS(Fd,ae)).a.length}catch(a){a=cy(a);if(lt(a,20)){c=a;$wnd.alert(ie+c.D()+fe+Ds(Ex,0,31,0,0))}else throw a}$wnd.alert(h.k)}
