(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var E='',C=' ',Dc=', Size: ',Db='-',sb='0',bc='0px',uc='100%',yc='100px',Bc=':',w='DOMMouseScroll',Cc='Index: ',qc='Item four',mc='Item one',sc='Item six',rc='Item that has a long title and is number five',pc='Item tree',nc='Item two',A='MouseEvents',gd='Object;',Ac='Status: <b>Online<\/b>',wc='This is some contense that should show how the widget handles stuff, wwwwwwwwwww wwwwwwwwww wwwwwwwwww wwwwew rw er',dd='Widget;',cd='[Lcom.google.gwt.user.client.ui.',fd='[Ljava.lang.',jc='absolute',vb='align',m='blur',ob='bottom',bb='button',tb='cellPadding',rb='cellSpacing',lb='center',x='change',B='className',cb='click',bd='com.streamspin.client.StreamSpinClient',y='contextmenu',nb='dblclick',ib='div',u='error',yb='focus',db='gwt-Button',kb='gwt-HTML',jb='gwt-Label',xb='gwt-ListBox',Cb='gwt-MenuBar',gc='gwt-TextArea',xc='height',cc='hideFocus',Fb='horizontal',z='html',hc='input',dc='keydown',oc='keypress',zc='keyup',D='left',ed='load',n='losecapture',Bb='menubar',pb='middle',Fc='moduleStartup',o='mousedown',p='mousemove',q='mouseout',r='mouseover',s='mouseup',v='mousewheel',ad='onModuleLoadStart',zb='option',ac='outline',ab='position',mb='right',Ab='role',t='scroll',l='select',kc='someTest',Ec='startup',eb='submit',gb='table',hb='tbody',ub='td',ic='text',fc='textarea',lc='title of Main Window',F='top',qb='tr',ec='true',fb='type',vc='value',Eb='vertical',wb='verticalAlign',tc='width';var _;function lp(a){return this===(a==null?null:a)}
...
function kh(){var a;if(jh){for(a=Dr(new Br(),jh);a.a<a.b.b;){Bf(as(a),3);tl()}}}
...
function om(a){var b,c;b=a[B]==null?null:String(a[B]);c=b.indexOf(fq(32));if(c>=0){return b.substr(0,c-0)}return b}
function pm(c,j,a){var b,d,e,f,g,h,i;if(!c){throw new np()}j=bq(j);if(j.length==0){throw new Fo()}i=c[B]==null?null:String(c[B]);e=i.indexOf(j);while(e!=-1){if(e==0||i.charCodeAt(e-1)==32){f=e+j.length;g=i.length;if(f==g||f<g&&i.charCodeAt(f)==32){break}}e=i.indexOf(j,e+1)}if(a){if(e==-1){if(i.length>0){i+=C}c[B]=i+j}}else{if(e!=-1){b=bq(i.substr(0,e-0));d=bq(Fp(i,e+j.length));if(b.length==0){h=d}else if(d.length==0){h=b}else{h=b+C+d}c[B]=h}}}
function im(){}
_=im.prototype=new jp();_.tI=7;_.i=null;function jn(a){if(a.g){throw new cp()}a.g=true;a.i.__listener=a;a.m();a.w()}
function kn(a){if(!a.g){throw new cp()}try{a.x()}finally{a.n();a.i.__listener=null;a.g=false}}
function ln(a){if(a.h){a.h.y(a)}else if(a.h){throw new cp()}}
function mn(c,b){var a;a=c.h;if(!b){if(!!a&&a.g){c.v()}c.h=null}else{if(a){throw new cp()}c.h=b;if(b.g){jn(c)}}}
function nn(){}
function on(){}
function pn(a){}
function qn(){kn(this)}
...
function bj(b,c){var a;if(c.h!=b){return false}mn(c,null);a=c.i;fe((ce(),a)).removeChild(a);gn(b.f,c);return true}
function cj(){return Bm(new zm(),this.f)}
function dj(a){return bj(this,a)}
function Di(){}
_=Di.prototype=new el();_.s=cj;_.y=dj;_.tI=10;function ni(a,b){Fi(a,b,a.i)}
...
function mi(){}
_=mi.prototype=new Di();_.y=ri;_.tI=11;function jj(){jj=pu;kj=(ao(),co)}
function ij(b,a){jj();b.i=a;kj.z(b.i,0);return b}
function lj(a){di(a)}
function hj(){}
_=hj.prototype=new xm();_.u=lj;_.tI=12;var kj;function vi(){vi=pu;jj()}
function ui(b,a){vi();b.i=a;kj.z(b.i,0);return b}
function ti(){}
_=ti.prototype=new hj();_.tI=13;function yi(){yi=pu;vi()}
function xi(b,a){yi();ui(b,$doc.createElement((ce(),bb)));zi(b.i);b.i[B]=db;b.i.innerHTML=a||E;return b}
function zi(b){if(b.type==eb){try{b.setAttribute(fb,bb)}catch(a){}}}
function si(){}
_=si.prototype=new ti();_.tI=14;function Bi(a){a.f=an(new ym());a.e=$doc.createElement((ce(),gb));a.d=$doc.createElement(hb);a.e.appendChild(a.d);a.i=a.e;return a}
function Ai(){}
_=Ai.prototype=new Di();_.tI=15;_.d=null;_.e=null;function fj(){fj=pu;gj=(ao(),bo)}
var gj;function mk(a){a.i=$doc.createElement((ce(),ib));a.i[B]=jb;return a}
function pk(a){di(a)}
function lk(){}
_=lk.prototype=new xm();_.u=pk;_.tI=16;function nj(a){a.i=$doc.createElement((ce(),ib));a.i[B]=kb;return a}
function mj(){}
_=mj.prototype=new lk();_.tI=17;function wj(){wj=pu;uj(new tj(),lb);yj=uj(new tj(),D);uj(new tj(),mb);xj=yj}
var xj,yj;function uj(b,a){b.a=a;return b}
function tj(){}
_=tj.prototype=new jp();_.tI=0;_.a=null;function Ej(){Ej=pu;Cj(new Bj(),ob);Cj(new Bj(),pb);Fj=Cj(new Bj(),F)}
var Fj;function Cj(a,b){a.a=b;return a}
function Bj(){}
_=Bj.prototype=new jp();_.tI=0;_.a=null;function ek(a){Bi(a);a.a=(wj(),xj);a.c=(Ej(),Fj);a.b=$doc.createElement((ce(),qb));a.d.appendChild(a.b);a.e[rb]=sb;a.e[tb]=sb;return a}
function fk(c,d){var b,a;b=(a=$doc.createElement((ce(),ub)),(a[vb]=c.a.a,undefined),(a.style[wb]=c.c.a,undefined),a);c.b.appendChild(b);ln(d);bn(c.f,d);b.appendChild(d.i);mn(d,c)}
function ik(c){var a,b;b=fe((ce(),c.i));a=bj(this,c);if(a){this.b.removeChild(b)}return a}
function ck(){}
_=ck.prototype=new Ai();_.y=ik;_.tI=18;_.b=null;function uk(){uk=pu;jj()}
function rk(a){uk();ij(a,ee((ce(),false)));a.i[B]=xb;return a}
function vk(f,c,g,b){var a,d,e;e=f.i;d=$doc.createElement((ce(),zb));d.text=c;d.value=g;if(b==-1||b==e.options.length){e.add(d,null)}else{a=e.options[b];e.add(d,a)}}
function xk(a){if(di(a)==1024){}else{di(a)}}
function qk(){}
_=qk.prototype=new hj();_.u=xk;_.tI=19;function Bk(a){ft(new et());a.b=ft(new et());Ek(a,false,(bl(),new Fk()));return a}
function Dk(d,a){var b,c;for(c=Dr(new Br(),d.b);c.a<c.b.b;){b=hg(as(c));if(Fd((ce(),null.D()),a)){return b}}return null}
function Ek(c,e){var a,b,d;b=$doc.createElement((ce(),gb));c.a=$doc.createElement(hb);b.appendChild(c.a);if(!e){d=$doc.createElement(qb);c.a.appendChild(d)}a=An((fj(),gj));a.appendChild(b);c.i=a;c.i.setAttribute(Ab,Bb);vh(c.i,2225|(c.i.__eventBits||0));c.i[B]=Cb;if(e){jm(c,om(c.i)+Db+Eb)}else{jm(c,om(c.i)+Db+Fb)}c.i.style[ac]=bc;c.i.setAttribute(cc,ec)}
function cl(a){var b;Dk(this,a.target);switch(di(a)){case 1:{(fj(),this.i).firstChild.focus();break}{break}case 2048:{hg(jt(this.b,0));break}case 128:{b=a.which||(a.keyCode||0);switch(b){case 37:{hg(jt(this.b,0))}a.cancelBubble=true;a.preventDefault();break;case 39:{hg(jt(this.b,0))}a.cancelBubble=true;a.preventDefault();break;case 38:hg(jt(this.b,0));a.cancelBubble=true;a.preventDefault();break;case 40:hg(jt(this.b,0));a.cancelBubble=true;a.preventDefault();break;case 27:a.cancelBubble=true;a.preventDefault();break;case 13:{hg(jt(this.b,0))}}break}}}
function dl(){kn(this)}
function yk(){}
_=yk.prototype=new xm();_.u=cl;_.v=dl;_.tI=20;_.a=null;function bl(){bl=pu}
function Fk(){}
_=Fk.prototype=new jp();_.tI=0;function sl(){sl=pu;wl=st(new rt());xl=wt(new vt())}
function rl(b,a){sl();b.f=an(new ym());b.i=a;jn(b);return b}
function tl(){var b,a;sl();var c,d;for(d=(b=uq(new tq(),Ds(xl.a).b.a),ns(new ms(),b));Fr(d.a.a);){c=Bf((a=Bf(as(d.a.a),9),a.p()),6);if(c.g){c.v()}}}
function vl(a){sl();var b;b=Bf(sr(wl,a),5);if(b){return b}if(wl.d==0){ih(new ml())}b=pl(new ol());yr(wl,a,b);xt(xl,b);return b}
function ll(){}
_=ll.prototype=new mi();_.tI=21;var wl,xl;function ml(){}
_=ml.prototype=new jp();_.tI=22;function ql(){ql=pu;sl()}
function pl(a){ql();rl(a,$doc.body);return a}
function ol(){}
_=ol.prototype=new ll();_.tI=23;function fm(){fm=pu;jj()}
function em(b,a){fm();b.i=a;kj.z(b.i,0);return b}
function hm(a){var b;b=di(a);if((b&896)!=0){di(a)}else if(b==1024){}else{di(a)}}
function dm(){}
_=dm.prototype=new hj();_.u=hm;_.tI=24;function cm(){cm=pu;fm()}
function bm(a){cm();em(a,$doc.createElement((ce(),fc)));a.i[B]=gc;return a}
function am(){}
_=am.prototype=new dm();_.tI=25;function sm(a){Bi(a);a.a=(wj(),xj);a.b=(Ej(),Fj);a.e[rb]=sb;a.e[tb]=sb;return a}
function tm(c,e){var b,d,a;d=$doc.createElement((ce(),qb));b=(a=$doc.createElement(ub),(a[vb]=c.a.a,undefined),(a.style[wb]=c.b.a,undefined),a);d.appendChild(b);c.d.appendChild(d);ln(e);bn(c.f,e);b.appendChild(e.i);mn(e,c)}
function wm(c){var a,b;b=fe((ce(),c.i));a=bj(this,c);if(a){this.d.removeChild(fe(b))}return a}
function qm(){}
_=qm.prototype=new Ai();_.y=wm;_.tI=26;function an(a){a.a=rf(lg,0,6,4,0);return a}
function bn(a,b){en(a,b,a.b)}
function dn(b,c){var a;for(a=0;a<b.b;++a){if(b.a[a]==c){return a}}return -1}
function en(d,e,a){var b,c;if(a<0||a>d.b){throw new fp()}if(d.b==d.a.length){c=rf(lg,0,6,d.a.length*2,0);for(b=0;b<d.a.length;++b){uf(c,b,d.a[b])}d.a=c}++d.b;for(b=d.b-1;b>a;--b){uf(d.a,b,d.a[b-1])}uf(d.a,a,e)}
function fn(c,b){var a;if(b<0||b>=c.b){throw new fp()}--c.b;for(a=b;a<c.b;++a){uf(c.a,a,c.a[a+1])}uf(c.a,c.b,null)}
function gn(b,c){var a;a=dn(b,c);if(a==-1){throw new iu()}fn(b,a)}
function ym(){}
_=ym.prototype=new jp();_.tI=0;_.a=null;_.b=0;function Bm(b,a){b.b=a;return b}
function Dm(a){if(a.a>=a.b.b){throw new iu()}return a.b.a[++a.a]}
function Em(){return this.a<this.b.b-1}
function Fm(){return Dm(this)}
function zm(){}
_=zm.prototype=new jp();_.r=Em;_.t=Fm;_.tI=0;_.a=-1;_.b=null;function ao(){ao=pu;bo=wn(new un());co=bo?(ao(),new tn()):bo}
function eo(a,b){a.tabIndex=b}
function tn(){}
_=tn.prototype=new jp();_.z=eo;_.tI=0;var bo,co;function xn(){xn=pu;ao()}
...
_=fo.prototype=new jf();_.tI=0;function ho(a){a.d=sm(new qm());a.c=ek(new ck());a.h=sm(new qm());a.g=rk(new qk());a.a=bm(new am());a.e=Bk(new yk());a.b=xi(new si(),kc);a.f=mk(new lk());a.i=nj(new mj());je((ce(),a.i.i),lc);vk(a.g,mc,mc,-1);vk(a.g,nc,nc,-1);vk(a.g,pc,pc,-1);vk(a.g,qc,qc,-1);vk(a.g,rc,rc,-1);vk(a.g,sc,sc,-1);a.g.i.size=3;a.g.i.style[tc]=uc;a.a.i[vc]=wc!=null?wc:E;a.a.i.style[tc]=uc;tm(a.h,a.g);tm(a.h,a.a);a.h.i.style[xc]=yc;a.h.i.style[tc]=uc;a.f.i.innerHTML=Ac;fk(a.c,a.b);fk(a.c,a.e);tm(a.d,a.i);tm(a.d,a.h);tm(a.d,a.b);tm(a.d,a.f);a.d.i.style[xc]=uc;a.d.i.style[tc]=uc;ni((sl(),vl(null)),a.d);return a}
function go(){}
_=go.prototype=new fo();_.tI=0;function hq(){}
...
function oo(){!!$stats&&$stats({moduleName:$moduleName,subSystem:Ec,evtGroup:Fc,millis:(new Date()).getTime(),type:ad,className:bd});ho(new go())}
