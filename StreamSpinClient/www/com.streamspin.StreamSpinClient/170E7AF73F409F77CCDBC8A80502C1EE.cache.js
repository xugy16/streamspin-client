...
_=ao.prototype=new ff();_.tI=0;function co(a){a.c=km(new im());a.b=Cj(new Aj());a.g=km(new im());a.f=jk(new ik());a.a=zl(new yl());a.d=tk(new qk());pi(new li());a.e=ek(new dk());a.h=fj(new ej());ge((be(),a.h.i),kc);nk(a.f,lc,lc,-1);nk(a.f,mc,mc,-1);nk(a.f,nc,nc,-1);nk(a.f,pc,pc,-1);nk(a.f,qc,qc,-1);nk(a.f,rc,rc,-1);a.f.i.size=4;a.f.i.style[sc]=tc;a.a.i[uc]=vc!=null?vc:C;a.a.i.style[sc]=tc;lm(a.g,a.f);lm(a.g,a.a);a.g.i.style[wc]=xc;a.g.i.style[sc]=tc;ge(a.e.i,yc);a.e.i.innerHTML=Ac;Dj(a.b,a.d);a.b.i.style[wc]=tc;a.b.i.style[sc]=tc;lm(a.c,a.h);lm(a.c,a.g);lm(a.c,a.e);lm(a.c,a.b);a.c.i.style[wc]=tc;a.c.i.style[sc]=tc;gi((kl(),nl(null)),a.c);return a}
function bo(){}
