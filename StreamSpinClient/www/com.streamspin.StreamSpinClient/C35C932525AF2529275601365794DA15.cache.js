...
function hT(e){var a,c,d,f;try{f=(gP(),pR(hP,e.k));d=et(sQ((oR(),f.a.documentElement)),21);rt(wQ(new vQ(),d.a.getElementsByTagNameNS(Fd,ae)));BL(e.b,d.a.nodeValue+be+null.tb()+be+null.tb().tb());$wnd.alert(d.a.nodeValue+ce+null.tb()+de+null.tb().tb())}catch(a){a=Fx(a);if(ht(a,20)){c=a;$wnd.alert(fe+c.D()+be+zs(Bx,0,31,0,0))}else throw a}$wnd.alert(e.k)}
