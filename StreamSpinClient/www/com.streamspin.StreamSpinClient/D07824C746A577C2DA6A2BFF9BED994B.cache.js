(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var hp='',tf='\tId : ',rf='\tName : ',wf='\tName: ',Af='\tScript Url: ',xf='\tService id: ',Df='\tStartURL: ',zf='\tXml Script: ',Cf='\tid: ',sf='\n',Bh='\n\n',ud='\n ',qf='\nLocation\n',uf='\nProfile\n',vf='\nServiceProfile\n',Bf='\nStartService\n',no=' ',Ed=" border='0'><\/gwt:clipper>",Dd=' height=',ai=' out of range',re='"',Cd='" width=',zd='"><img src=\'',Fd='#',ei='$',pe='&',qe='&amp;',ue='&apos;',Ae='&gt;',ye='&lt;',se='&quot;',oe='&semi;',Ff='&un=f&pw=1',te="'",Ad="' onerror='if(window.__gwt_transparentImgHandler)window.__gwt_transparentImgHandler(this);else this.src=\"",vd="',sizingMethod='crop'); margin-left: ",nh="']",hb='(',me='(?=[;&<>\'"])',po='(null handle)',sb='): ',cp=', ',ip=', Size: ',cf=', char ',qo='-',gh='------------------------------\n--- User Information ---\n------------------------------\n',Ee='-->',lh=".//*[local-name()='",we='/',tb='0',dc='0px',sg='100%',vg='100px',ug='150px',wg='300px',yc='548CDF11D6FE9011F3447CA200D7FB7F.cache.png',ng='65px',df=':',Co=': ',ne=';',xe='<',De='<!--',Be='<![CDATA[',xb='<SELECT MULTIPLE>',yb='<SELECT>',yd='<gwt:clipper style="',ii='=',ze='>',ke='?',fb='@',yj='AbsolutePanel',Ej='AbstractCollection',gn='AbstractHashMap',jn='AbstractHashMap$EntrySet',kn='AbstractHashMap$EntrySetIterator',mn='AbstractHashMap$MapEntryNull',on='AbstractHashMap$MapEntryString',qj='AbstractImagePrototype',Fj='AbstractList',pn='AbstractList$IteratorImpl',fn='AbstractMap',qn='AbstractMap$1',rn='AbstractMap$1$1',ln='AbstractMapEntry',hn='AbstractSet',ep='Add not supported on this collection',fp='Add not supported on this list',ui='Animation',xi='Animation$1',pi='Animation;',ak='ArrayList',xm='ArrayStoreException',sl='AttrImpl',nf='BackgroundImageCache',ym='Boolean',vc='Bottom',Bj='Button',Aj='ButtonBase',xl='CDATASectionImpl',bd='CENTER',co='CSS1Compat',go="Can't overwrite cause",vo='Cannot set a new parent without first clearing the old parent',Cj='CellPanel',qp='Center',tl='CharacterDataImpl',Am='Class',Bm='ClassCastException',bk='ClickListenerCollection',tj='ClippedImagePrototype',il='CommandCanceledException',kl='CommandExecutor',ml='CommandExecutor$1',nl='CommandExecutor$2',ll='CommandExecutor$CircularIterator',yl='CommentImpl',xj='ComplexPanel',xc='Content',ej='ContentFetchedHandler$ContentFetchedEvent',Bb='DIV',Al='DOMException',ql='DOMItem',wm='DOMMouseScroll',Bl='DOMParseException',ag='Damn!!\nAn Exception getting content from streamspin..\n\n',ek='DecoratedPopupPanel',fk='DecoratorPanel',Cl='DocumentFragmentImpl',Dl='DocumentImpl',oj='DocumentRootImpl',ij='DynamicHeightFeature',El='ElementImpl',gg='Enable debug Mode',mj='Enum',fj='Event$2',cj='EventObject',zi='Exception',hg='Exit',Fe='Failed to parse: ',zj='FocusWidget',bi='For input string: "',ih='GPS Default: ',jh='GPS Threshhold: ',jj='Gadget',hk='HTML',jk='HasHorizontalAlignment$HorizontalAlignmentConstant',kk='HasVerticalAlignment$VerticalAlignmentConstant',sn='HashMap',tn='HashSet',lk='HorizontalPanel',Fg='INPUT',Cm='IllegalArgumentException',Dm='IllegalStateException',mk='Image',nk='Image$State',ok='Image$UnclippedState',gp='Index: ',vm='IndexOutOfBoundsException',lb='Inner',kj='IntrinsicFeature',lj='IntrinsicFeature$2',Di='JavaScriptException',Ei='JavaScriptObject$',gk='Label',pp='Left',pk='ListBox',fm='Location',kf='MSXML.DOMDocument',lf='MSXML3.DOMDocument',un='MapEntryImpl',mg='Menu',qk='MenuBar',rk='MenuBar$1',sk='MenuBar$2',uk='MenuBar_MenuBarImages_generatedBundle',vk='MenuItem',of='Microsoft.DOMDocument',mf='Microsoft.XmlDom',uc='Middle',jf='Msxml2.DOMDocument',Bg='New Item',vn='NoSuchElementException',rl='NodeImpl',Fl='NodeListImpl',lo='Null widget handle. If you are creating a composite, ensure that initWidget() has been called.',Em='NullPointerException',Fm='NumberFormatException',cd='ONE_WAY_CORNER',si='Object',en='Object;',eg='Off',cg='On',wj='Panel',yk='PasswordTextBox',jc='Popup',zk='PopupListenerCollection',dk='PopupPanel',Ak='PopupPanel$AnimationType',Bk='PopupPanel$ResizeAnimation',Ck='PopupPanel$ResizeAnimation$1',bm='ProcessingInstructionImpl',gm='Profile',rp='Right',Dk='RootPanel',al='RootPanel$1',Fk='RootPanel$DefaultRootPanel',Ai='RuntimeException',gf='SelectionLanguage',ef='SelectionNamespaces',ro='Self-causation not permitted',pg='Send Message',hm='ServiceProfile',lg='Set Profile',jg='SetLocation',so="Should only call onAttach when the widget is detached from the browser's document",to="Should only call onDetach when the widget is attached to the browser's document",ck='SimplePanel',bl='SimplePanel$1',cn='StackTraceElement;',kg='Start Service',im='StartService',Ag='Status: <b>Offline<\/b>',yg='Status: <b>Online<\/b>',jm='StreamSpinClient',km='StreamSpinClient$1',mm='StreamSpinClient$2',nm='StreamSpinClient$3',om='StreamSpinClient$4',pm='StreamSpinClient$5',qm='StreamSpinClient$6',rm='StreamSpinClient$8',sm='StreamSpinClientGadgetImpl',ic='String',aj='String;',an='StringBuffer',mo='Style names cannot be empty',cl='TextArea',xk='TextBox',wk='TextBoxBase',wl='TextImpl',tg='This is some content that should show how the widget handles stuff,\n <b> wwwwwwwwwww wwwwwwwwww wwwwwwwwww wwwwew rw er<\/b>',uo="This widget's parent does not implement HasWidgets",yi='Throwable',wi='Timer',ol='Timer$1',sc='Top',uj='UIObject',dn='UnsupportedOperationException',fg='Use GPS',hh='User id: ',tm='UserInfo',dl='VerticalPanel',vj='Widget',fl='Widget;',gl='WidgetCollection',hl='WidgetCollection$WidgetIterator',ig='Write Message',cm='XMLParserImpl',dm='XMLParserImplIE6',pf='XMLParserImplIE6.createDocumentImpl: Could not find appropriate version of DOMDocument.',hf='XPath',um='XmlParser',qg='You can send messages to your friends with this',Dg='You selected a menu item which has not yet been implemented!',bp='[',zm='[C',oi='[Lcom.google.gwt.animation.client.',el='[Lcom.google.gwt.user.client.ui.',Fi='[Ljava.lang.',di='\\',dp=']',Ce=']]>',xg='__gwt_gadget_content_div',dg='__gwt_initWindowCloseHandler',fd='absolute',ap='align',ee='alpha(opacity=0)',lc='aria-activedescendant',Cc='aria-haspopup',og='blur',qb='bottom',zo='button',np='cellPadding',mp='cellSpacing',ob='center',zg='change',Eh='class ',jo='className',ae='clear.cache.gif',Bd='clear.cache.gif"\' style="',eh='click',dd='clip',Cg='cmd',yf='cmd cannot be null',nc='colSpan',ti='com.google.gwt.animation.client.',Bi='com.google.gwt.core.client.',gj='com.google.gwt.gadgets.client.',dj='com.google.gwt.gadgets.client.event.',vi='com.google.gwt.user.client.',nj='com.google.gwt.user.client.impl.',pj='com.google.gwt.user.client.ui.',rj='com.google.gwt.user.client.ui.impl.',zl='com.google.gwt.xml.client.',pl='com.google.gwt.xml.client.impl.',em='com.streamspin.client.',ni='com.streamspin.client.StreamSpinClient',bn='contextmenu',ph='dblclick',rh='defaulton',kb='div',am='error',Ch='false',td="filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",Ah='focus',bg='foo 2',eo='function',fo='function ',ci='g',Ao='gwt-Button',wc='gwt-DecoratedPopupPanel',ib='gwt-DecoratorPanel',nb='gwt-HTML',vb='gwt-Image',mb='gwt-Label',zb='gwt-ListBox',Fb='gwt-MenuBar',hc='gwt-MenuBarPopup',zc='gwt-MenuItem',dh='gwt-PasswordTextBox',qc='gwt-PopupPanel',md='gwt-TextArea',bh='gwt-TextBox',bf='gwt-uid-',ko='height',ul='hidden',ec='hideFocus',bc='horizontal',pd='http://',Ef='http://webclient.streamspin.com/Default.aspx?type=',nd='https',od='https://',mc='id',be='iframe',fh='images/daisy.gif',wb='img',Dh='interface ',qi='java.lang.',bj='java.util.',ce="javascript:''",gi='keydown',ri='keypress',Ci='keyup',wo='left',af='line ',hj='load',oh='location',mh='locations',qh='locid',sj='losecapture',gc='menuPopup',Eb='menubar',Ac='menuitem',Ec='message',rb='middle',li='moduleStartup',Dj='mousedown',ik='mousemove',tk='mouseout',Ek='mouseover',jl='mouseup',lm='mousewheel',An='must be positive',tc='name',de='no',Db='null',gb='offsetHeight',ve='offsetWidth',mi='onModuleLoadStart',Fn='onblur',nn='onclick',bo='oncontextmenu',ao='ondblclick',En='onfocus',Bn='onkeydown',Cn='onkeypress',Dn='onkeyup',wn='onmousedown',yn='onmousemove',xn='onmouseup',zn='onmousewheel',Ab='option',cc='outline',fi='overflow',qd='overflow: hidden; width: ',ch='password',rc='popupContent',yo='position',wh='profile',vh='profiles',jp='px',id='px)',hd='px, ',xd='px; border: none',rd='px; height: ',wd='px; margin-top: ',sd='px; padding: 0px; zoom: 1',Fh='radix ',Dc='readOnly',Fc='readonly',gd='rect(',kd='rect(0px, 0px, 0px, 0px)',ed='rect(auto, auto, auto, auto)',pb='right',Cb='role',ho='script',vl='scroll',Bc='selected',yh='serviceprofile',xh='serviceprofiles',Eg='someTest',uh='startservice',th='startservices',ki='startup',pc='subMenuIcon',kc='subMenuIcon-selected',Bo='submit',Eo='table',Fo='tbody',jb='td',ah='text',ld='textarea',zh='there is an exception:\n',ie='this.__popup.offsetHeight',fe='this.__popup.offsetLeft',ge='this.__popup.offsetTop',he='this.__popup.offsetWidth',le='this.__popup.style.zIndex',io='title',rg='title of Main Window',jd='toString',xo='top',op='tr',sh='treshhold',fc='true',Do='type',kh='uid',oc='vAlign',ad='value',ac='vertical',ub='verticalAlign',kp='visibility',lp='visible',oo='width',ff="xmlns:xsl='http://www.w3.org/1999/XSL/Transform'",je='zIndex',hi='{',ji='}';var _;function iZ(a){return this===(a==null?null:a)}
...
function hu(c,a){var b;b=su(new ru(),a);sV(c.a,b)}
...
function lU(){}
_=lU.prototype=new gZ();_.gC=pU;_.tS=qU;_.tI=68;_.a=null;_.b=0;_.c=null;function BV(e,d){var a,c,f,g;f=d;g=Ef+d+Ff;try{mu(g,gu(new fu(),qV(new pV(),e,f)),10)}catch(a){a=qA(a);if(yv(a,19)){c=a;$wnd.alert(ag+c.E())}else throw a}if(e.l==null)return BV(e,d);else return e.l}
function bW(m){var b,d,f,h,j,l;l=BV(m,8);vW((yW(),l));$wnd.alert(bg);b=cJ(new uI(),true);eJ(b,fK(new eK(),cg,m.a));eJ(b,fK(new eK(),eg,m.a));f=cJ(new uI(),true);eJ(f,fK(new eK(),fg,m.a));j=cJ(new uI(),true);h=cJ(new uI(),true);d=cJ(new uI(),true);eJ(d,gK(new eK(),gg,b));eJ(d,fK(new eK(),hg,m.m));eJ(d,fK(new eK(),ig,m.k));eJ(d,gK(new eK(),jg,f));eJ(d,gK(new eK(),kg,j));eJ(d,gK(new eK(),lg,h));eJ(m.d,gK(new eK(),mg,d));m.d.b=false;m.d.r.style[oo]=ng;rG(m.g,gV(new fV(),m));m.g.r.innerText=pg;iO(m.g,qg);m.n.r.innerText=rg;uH(m.e,m.d);uH(m.e,m.n);uH(m.e,m.g);pF(m.e,m.d,(cH(),fH));pF(m.e,m.n,dH);pF(m.e,m.g,gH);m.e.r.style[oo]=sg;rG(m.i,lV(new kV(),m));m.i.r.size=5;m.i.r.style[oo]=sg;m.c.r[ad]=tg!=null?tg:hp;yN(m.c,true);m.c.r.style[oo]=sg;m.c.r.style[ko]=ug;vO(m.j,m.i);vO(m.j,m.c);m.j.r.style[ko]=vg;m.j.r.style[oo]=sg;EV(m,(bX(),dX));vO(m.f,m.e);vO(m.f,m.j);vO(m.f,m.h);m.f.r.style[ko]=wg;m.f.r.style[oo]=sg;yE((sM(),wM(null)),m.f);wM(xg);$wnd._IG_AdjustIFrameHeight()}
function EV(b,a){if(a.a){b.h.r.innerHTML=yg}else{b.h.r.innerHTML=Ag}}
function cW(a){qI(a.i,Bg,Cg,-1);EV(a,(bX(),cX))}
function dW(){return bz}
function fW(a){}
function eW(a){}
function rU(){}
_=rU.prototype=new au();_.gC=dW;_.db=fW;_.cb=eW;_.tI=0;_.l=null;function uU(){$wnd.alert(Dg)}
...
function kV(){}
_=kV.prototype=new gZ();_.gC=nV;_.hb=oV;_.tI=74;_.a=null;function qV(b,a,c){b.a=a;b.b=c;return b}
function sV(b,a){b.a.l=a.a;if(b.b==8)bW(b.a)}
function tV(){return Fy}
function pV(){}
_=pV.prototype=new gZ();_.gC=tV;_.tI=0;_.a=null;_.b=0;function vV(c){var a,b;c.f=uO(new sO());c.e=tH(new rH());c.j=uO(new sO());c.i=oI(new nI(),false);c.c=rN(new qN());c.d=bJ(new uI());c.g=hF(new bF(),Eg);c.h=iI(new hI());c.n=xG(new wG());uO(new sO());CN(new uN(),(a=$doc.createElement(Fg),a.type=ah,a),bh);CN(new tK(),(b=$doc.createElement(Fg),b.type=ch,b),dh);gF(new bF());cI(new zH(),$moduleBase+fh);c.b=m4(new l4());c.a=new sU();xU(new wU(),c);c.m=CU(new BU(),c);c.k=bV(new aV(),c);c.cb(new Bt());c.db(new eu());BV(c,8);return c}
