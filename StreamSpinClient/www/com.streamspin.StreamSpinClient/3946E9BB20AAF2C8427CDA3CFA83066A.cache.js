...
function p0(e,d){var a,c,f;if(!e.a){$wnd.alert(Ff)}f=ag+d+bg;$wnd.alert(f);try{yu(f,su(new ru(),i0(new h0(),e)),10)}catch(a){a=uB(a);if(ew(a,20)){c=a;$wnd.alert(cg+a6(c))}else throw a}}
