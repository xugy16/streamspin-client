...
function zY(){}
_=zY.prototype=new u2();_.gC=eZ;_.tS=fZ;_.tI=0;_.a=null;_.b=0;_.g=0;function sZ(a){BM(a);a.j=false;a.e=sI(new qI());a.f=EP(new CP());a.b=sI(new qI());a.c=zO(new yO());a.h=BF(new vF(),ue);a.a=BF(new vF(),Ff);a.d=oJ(new nJ(),true);a.g=a;tI(a.e,a.a);tI(a.e,a.h);FP(a.f,a.c);FP(a.f,a.e);tI(a.b,a.d);tI(a.b,a.f);qP(a.b,Co+(FE(),aF).clientWidth*0.9,Co+($wnd.devicePixelRatio?aF.clientHeight:$wnd.innerHeight)*0.85);oH(a.h,iZ(new hZ(),a));uJ(a.d,ag,ag,-1);uJ(a.d,bg,bg,-1);uJ(a.d,cg,cg,-1);uJ(a.d,eg,eg,-1);uJ(a.d,fg,fg,-1);uJ(a.d,gg,gg,-1);uJ(a.d,hg,hg,-1);uJ(a.d,ag,ag,-1);uJ(a.d,bg,bg,-1);uJ(a.d,cg,cg,-1);uJ(a.d,ig,ig,-1);uJ(a.d,fg,fg,-1);uJ(a.d,gg,gg,-1);uJ(a.d,hg,hg,-1);a.d.w.size=14;pJ(a.d,nZ(new mZ(),a));qP(a.c,ze,jg);$wnd.alert(Co+jr((sr(),a.w))+tn+kr(a.w)+tn+jr(a.w)+tn+kr(a.w));hN(a,a.b);EM(a);iN(a);return a}
