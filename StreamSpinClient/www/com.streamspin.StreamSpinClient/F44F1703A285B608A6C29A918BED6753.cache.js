...
function xV(d,c){var a,b,e;yV();d.a=c;aL(d,false);nL(d);b=d;a=bG(new aG());a.r.innerHTML=sf+$moduleBase+tf+uf||mo;uN(a,mo+(yD(),AD).clientWidth,mo+AD.clientHeight);uH(a,jV(new iV(),b));qM(d,a);gL(d);e=oV(new nV(),d,b);d.a.l=tV(new sV(),d,e);bC(d.a.l,2500);return d}
