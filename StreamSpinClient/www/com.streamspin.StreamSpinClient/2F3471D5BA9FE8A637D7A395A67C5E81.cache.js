...
function BU(h){var a,c,d,e,f,g,i;try{i=(rQ(),aT(sQ,h.k));g=vt(DR((FS(),i.a.documentElement)),21);d=bS(new aS(),g.a.getElementsByTagNameNS(je,ke)).a.length;f=vt(dS(bS(new aS(),g.a.getElementsByTagNameNS(je,ke)),0),21);e=bS(new aS(),g.a.getElementsByTagNameNS(je,le)).a.length;wM(h.b,g.a.nodeValue);$wnd.alert(g.a.nodeValue+me+g.a.getAttribute(ne)+oe+g.a.nodeName+oe+dS(bS(new aS(),f.a.childNodes),0)+oe+f.a.nodeName+oe+f.a.getAttribute(re)+se+d+bm+e);g.a.nodeValue;g.a.nodeName;g.a.getAttribute(ne);f.a.nodeName;dS(bS(new aS(),f.a.childNodes),0);f.a.getAttribute(re);bS(new aS(),g.a.getElementsByTagNameNS(je,ke)).a.length}catch(a){a=ty(a);if(yt(a,20)){c=a;$wnd.alert(te+c.ab()+oe+kt(py,0,31,0,0))}else throw a}$wnd.alert(h.k)}
