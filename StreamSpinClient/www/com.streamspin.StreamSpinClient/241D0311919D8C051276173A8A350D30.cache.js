...
function rw(c,a){var b;b=Cw(new Bw(),a);x2(c.a,b)}
...
function fZ(){}
_=fZ.prototype=new D6();_.gC=jZ;_.tS=kZ;_.tI=74;_.a=null;_.b=0;_.c=null;function f2(b){var a;a2(b);FJ(b.j,EZ(new DZ(),b));b.j.x.innerText=mg;eS(b.j,ng);b.q.x.innerText=pg;eL(b.h,b.g);eL(b.h,b.q);eL(b.h,b.j);xI(b.h,b.g,(sK(),vK));xI(b.h,b.q,tK);xI(b.h,b.j,wK);b.h.x.style[uq]=qg;a=n0(new m0(),b);FF(a,10000);FJ(b.l,i0(new c0(),b));b.l.x.size=35;b.l.x.style[uq]=qg;rS(b.m,b.l);b.m.x.style[qq]=rg;b.m.x.style[uq]=qg;c2(b,(n4(),p4));rS(b.i,b.h);rS(b.i,b.m);rS(b.i,b.k);b.i.x.style[qq]=sg;b.i.x.style[uq]=qg;aI((mQ(),qQ(null)),b.i);qQ(tg);$wnd._IG_AdjustIFrameHeight()}
function a2(p){var a,c,d,e,f,g,h,i,j,k,l,m,n,o;g=null;try{g=F3((e4(),p.o.a))}catch(a){a=sD(a);if(cy(a,20)){d=a;$wnd.alert(ug+s8(d))}else throw a}c=AM(new mM(),true);CM(c,DN(new CN(),vg,p.n));CM(c,DN(new CN(),wg,p.n));m=AM(new mM(),true);CM(m,DN(new CN(),xg,p.a));if(g.c.b==0){CM(m,DN(new CN(),yg,p.a))}for(f=t$(new r$(),g.c);f.a<f.b.Ab();){e=Fx(w$(f),21);CM(m,DN(new CN(),e.c,b1(new a1(),e.b,e.a)))}o=AM(new mM(),true);if(g.f.b==0){CM(o,DN(new CN(),Ag,p.a))}for(l=t$(new r$(),g.f);l.a<l.b.Ab();){k=Fx(w$(l),22);CM(o,DN(new CN(),k.a,l1(new k1(),k.b,k.c)))}n=AM(new mM(),true);if(g.d.b==0){CM(n,DN(new CN(),Bg,p.a))}for(j=t$(new r$(),g.d);j.a<j.b.Ab();){i=Fx(w$(j),23);CM(n,DN(new CN(),i.b,g1(new f1(),i.a)))}h=AM(new mM(),true);CM(h,EN(new CN(),Cg,c));CM(h,DN(new CN(),Dg,p.n));CM(h,DN(new CN(),Eg,p.r));CM(h,EN(new CN(),Fg,m));CM(h,EN(new CN(),ah,o));CM(h,EN(new CN(),bh,n));CM(p.g,EN(new CN(),ch,h));p.g.b=false;p.g.x.style[uq]=dh}
function c2(b,a){if(a.a){b.k.x.innerHTML=fh}else{b.k.x.innerHTML=gh}}
function k2(){return BB}
function l2(a){}
function m2(a){n2=a}
function lZ(){}
_=lZ.prototype=new kw();_.gC=k2;_.ib=l2;_.jb=m2;_.tI=0;_.p=0;var h2=hh,i2=-1,j2=ih,n2=null;function oZ(){}
function pZ(){return kB}
function mZ(){}
_=mZ.prototype=new D6();_.F=oZ;_.gC=pZ;_.tI=75;function sZ(){$wnd.alert(jh)}
...
function q0(){var a;++this.a.p;a=new vX();a.a=null;D2(A2(new o2()),2,a);FF(D0(new w0(),a,this.a).c,500)}
function m0(){}
_=m0.prototype=new wF();_.gC=p0;_.vb=q0;_.tI=81;_.a=null;function s0(b,a){b.a=a;return b}
function u0(){return sB}
function v0(a){if(yu(this.a.e.x,dd).length>0&&yu(this.a.d.x,dd).length>0){j2=yu(this.a.e.x,dd);h2=yu(this.a.d.x,dd);cI((mQ(),qQ(null)),this.a.c);D2(A2(new o2()),8,this.a.o);v1(new p1(),this.a)}else{$wnd.alert(kh)}}
function r0(){}
...
function B0(){var a,b,c;if(this.a.a.a!=null){CF(this);hM(this.a.b.l,lh+this.a.b.p,this.a.a.a,-1);if(this.a.a.a.length){c=E3((e4(),this.a.a.a));for(b=t$(new r$(),c);b.a<b.b.Ab();){a=Fx(w$(b),24);hM(this.a.b.l,a.b,a.a,-1)}}}}
function x0(){}
_=x0.prototype=new wF();_.gC=A0;_.vb=B0;_.tI=83;_.a=null;function b1(c,b,a){c.b=b;c.a=a;return c}
function d1(){$wnd.alert(mh+this.b+nh+this.a)}
function e1(){return vB}
function a1(){}
_=a1.prototype=new D6();_.F=d1;_.gC=e1;_.tI=84;_.a=null;_.b=null;function g1(b,a){b.a=a;return b}
function i1(){$wnd.alert(oh+this.a)}
function j1(){return wB}
function f1(){}
_=f1.prototype=new D6();_.F=i1;_.gC=j1;_.tI=85;_.a=0;function l1(c,b,a){c.a=b;c.b=a;return c}
function n1(){$wnd.alert(oh+this.a+qh+this.b)}
function o1(){return xB}
function k1(){}
_=k1.prototype=new D6();_.F=n1;_.gC=o1;_.tI=86;_.a=0;_.b=null;function v1(d,c){var a,b,e;d.a=c;nP(d);d.k=false;AP(d);b=d;a=fK(new eK());a.x.innerHTML=rh+$moduleBase+sh+th||nr;cS(a,nr+(qH(),sH).clientWidth*0.95,nr+sH.clientHeight*0.9);DQ(d,a);tP(d);e=r1(new q1(),d,b);FF(e,1000);return d}
...
function q1(){}
_=q1.prototype=new wF();_.gC=t1;_.vb=u1;_.tI=88;_.a=null;_.b=null;function z1(a){a.i=qS(new oS());a.h=dL(new bL());a.m=qS(new oS());a.l=aM(new FL(),false);a.f=lR(new kR());a.g=zM(new mM());a.j=pI(new jI(),uh);a.k=yL(new xL());a.q=fK(new eK());a.c=qS(new oS());a.e=wR(new oR());a.d=mO(new lO());a.b=oI(new jI());sL(new jL(),$moduleBase+vh);a.o=new vX();a.a=new mZ();a.n=new qZ();vZ(new uZ(),a);a.r=new zZ();a.ib(new fw());a.jb(new ow());a.q.x.innerText=wh;a.b.x.innerHTML=xh;FJ(a.b,s0(new r0(),a));rS(a.c,a.q);rS(a.c,a.e);rS(a.c,a.d);rS(a.c,a.b);aI((mQ(),qQ(null)),a.c);return a}
function C1(){return AB}
function y1(){}
_=y1.prototype=new lZ();_.gC=C1;_.tI=0;function A2(a){a.a=n2;return a}
function D2(d,c,b){var a,e;C2(d,c);a=b;e=q2(new p2(),d,a);FF(e,1000)}
function C2(e,d){var a,c,f;if(!e.a){$wnd.alert(yh)}f=zh+d+Bh+j2+Ch+h2+Dh+i2;try{ww(f,qw(new pw(),v2(new u2(),e)),10)}catch(a){a=sD(a);if(cy(a,20)){c=a;$wnd.alert(Eh+s8(c))}else throw a}}
...
function t2(){if(this.a.b!=null){this.b.a=this.a.b;this.a.b=null;CF(this)}}
function p2(){}
_=p2.prototype=new wF();_.gC=s2;_.vb=t2;_.tI=89;_.a=null;_.b=null;function v2(b,a){b.a=a;return b}
function x2(b,a){b.a.b=a.a;$wnd.alert(Fh+b.a.b)}
...
function A3(b){var a;eL(b.f,b.a);eL(b.f,b.i);rS(b.g,b.d);rS(b.g,b.f);eL(b.c,b.e);eL(b.c,b.g);cS(b.c,hi,nr+(qH(),sH).clientHeight*0.85);FJ(b.i,o3(new n3(),b));hM(b.e,ii,ii,-1);hM(b.e,ji,ji,-1);hM(b.e,ki,ki,-1);hM(b.e,li,li,-1);hM(b.e,mi,mi,-1);hM(b.e,ni,ni,-1);hM(b.e,oi,oi,-1);hM(b.e,pi,pi,-1);hM(b.e,qi,qi,-1);hM(b.e,si,si,-1);hM(b.e,ti,ti,-1);hM(b.e,ui,vi,-1);eS(b.e,wi);hM(b.e,xi,xi,-1);hM(b.e,yi,yi,-1);hM(b.e,zi,zi,-1);b.b=(e4(),(c4=fab(new eab()),c4));for(a=t$(new r$(),b.b);a.a<a.b.Ab();){my(w$(a));hM(b.e,null.Cb(),nr+null.Cb(),-1)}cS(b.e,rg,nr+sH.clientHeight*0.8);b.e.x.size=14;bM(b.e,t3(new s3(),b));cS(b.d,qg,Ai);cS(b.f,qg,qg);cS(b.c,qg,qg)}
