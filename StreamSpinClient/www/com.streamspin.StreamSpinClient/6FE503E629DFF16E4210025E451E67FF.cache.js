...
function FV(d,c){var a,b,e;aW();d.a=c;nL(d,true);AL(d);b=d;a=nG(new mG());a.r.innerHTML=pf+$moduleBase+qf+rf||no;bO(a,no+(eE(),gE).clientWidth*1.1,no+gE.clientHeight*1.1);aI(a,rV(new qV(),b));DM(d,a);tL(d);e=wV(new vV(),d,b);d.a.m=BV(new AV(),d,e);nC(d.a.m,2500);return d}
...
function EV(){if(this.a.a.l!=null){oC(this.b,100)}}
function AV(){}
