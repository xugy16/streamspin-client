...
function sZ(){var a,b,c;if(this.a.a.a!=null&&!!this.a.a.a.length){$wnd.alert(xf+this.a.a.a);c=v2((B2(),this.a.a.a));for(b=i9(new g9(),c);b.a<b.b.zb();){a=ow(l9(b),24);fL(this.a.b.l,a.b,a.a,-1)}}xE(this)}
function oZ(){}
...
function t1(e,d){var a,c,f;if(!e.a){$wnd.alert(fg)}f=gg+d+hg+a1+ig+E0+jg+F0;try{fv(f,Fu(new Eu(),m1(new l1(),e)),10)}catch(a){a=hC(a);if(rw(a,20)){c=a;$wnd.alert(kg+h7(c))}else throw a}}
