...
function iP(){var a,c,d,e;e=wd;try{e=$wnd._IG_GetCachedUrl(e);d=qr(new kr(),(sr(),vr),e);$wnd.alert(e);ur(d,null,new xO())}catch(a){a=Ax(a);if(ut(a,16)){c=a;$wnd.alert(c.D())}else throw a}}
