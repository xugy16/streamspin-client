...
function iV(){}
_=iV.prototype=new bY();_.gC=nV;_.tI=0;function qV(j){var a,c,d,e,f,g,h,i,k;uV=kV(new iV(),e3(new d3()),(CV(),e3(new d3()),e3(new d3()),e3(new d3())));try{k=(vQ(),dT(wQ,j));i=au(aS((cT(),k.a.documentElement)),20);d=eS(new dS(),gS(eS(new dS(),i.a.getElementsByTagNameNS(qf,rf)),0).a.childNodes).a.length;au(gS(eS(new dS(),i.a.getElementsByTagNameNS(qf,sf)),0),20);au(gS(eS(new dS(),i.a.getElementsByTagNameNS(qf,tf)),0),20);eS(new dS(),i.a.getElementsByTagNameNS(qf,sf)).a.length;for(f=0;f<~~(d/2)-1;++f){h=au(gS(eS(new dS(),i.a.getElementsByTagNameNS(qf,uf)),f),20);$wnd.alert(vf+f+wf+gS(eS(new dS(),h.a.childNodes),0).a.nodeValue+wf+h.a.getAttribute(xf));g3(uV.a,qT(new pT(),FX(h.a.getAttribute(xf),10,-2147483648,2147483647),gS(eS(new dS(),h.a.childNodes),0).a.nodeValue))}$wnd.alert(zf);for(e=s1(new q1(),uV.a);e.a<e.b.wb();){g=au(v1(e),21);$wnd.alert(g.b+Af+g.a)}}catch(a){a=cz(a);if(du(a,19)){c=a;$wnd.alert(Bf+c.ab()+Cf+vt(Ey,0,31,0,0))}else throw a}return null}
