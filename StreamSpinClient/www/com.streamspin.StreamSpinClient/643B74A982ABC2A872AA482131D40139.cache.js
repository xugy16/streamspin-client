...
function CY(){}
_=CY.prototype=new x2();_.gC=hZ;_.tS=iZ;_.tI=0;_.a=null;_.b=0;_.g=0;function vZ(a){nN(a);a.j=false;a.e=gJ(new eJ());a.f=pQ(new nQ());a.b=gJ(new eJ());a.c=lP(new kP());a.h=tG(new nG(),eg);a.a=tG(new nG(),sh);a.d=cK(new bK(),true);a.g=a;hJ(a.e,a.a);hJ(a.e,a.h);qQ(a.f,a.c);qQ(a.f,a.e);hJ(a.b,a.d);hJ(a.b,a.f);bQ(a.b,Fp+(uF(),wF).clientWidth*0.8,Fp+wF.clientHeight*0.8);dI(a.h,lZ(new kZ(),a));iK(a.d,th,th,-1);iK(a.d,uh,uh,-1);iK(a.d,vh,vh,-1);iK(a.d,wh,wh,-1);iK(a.d,xh,xh,-1);iK(a.d,yh,yh,-1);iK(a.d,zh,zh,-1);iK(a.d,th,th,-1);iK(a.d,uh,uh,-1);iK(a.d,vh,vh,-1);iK(a.d,wh,wh,-1);iK(a.d,xh,xh,-1);iK(a.d,yh,yh,-1);iK(a.d,zh,zh,-1);bQ(a.d,kg,Fp+(parseInt(a.b.w[ve])||0)*0.95);$wnd.alert((parseInt(a.b.w[gb])||0)+fp+(parseInt(a.b.w[ve])||0));a.d.w.size=10;dK(a.d,qZ(new pZ(),a));zN(a,a.b);qN(a);AN(a);return a}
