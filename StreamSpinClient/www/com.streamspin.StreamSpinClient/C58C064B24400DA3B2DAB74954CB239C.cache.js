(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var ao='',ce='\tId : ',ae='\tName : ',fe='\tName: ',ie='\tScript Url: ',ge='\tService id: ',me='\tStartURL: ',he='\tXml Script: ',le='\tid: ',be='\n',jg='\n\n',ud='\n ',Ed='\nLocation\n',de='\nProfile\n',ee='\nServiceProfile\n',je='\nStartService\n',um=' ',pg=' out of range',nd='"',ld='&',md='&amp;',qd='&apos;',vd='&gt;',sd='&lt;',od='&quot;',kd='&semi;',oe='&un=f&pw=1',pd="'",ad="' border='0'>",hb='(',hd='(?=[;&<>\'"])',wm='(null handle)',Bc=') no-repeat ',sb='): ',Bf='*',ln=', ',qn=', Size: ',ym='-',vf='------------------------------\n--- User Information ---\n------------------------------\n',zd='-->',ho='0',pb='0px',cf='100%',ff='100px',ef='150px',gf='300px',ec='548CDF11D6FE9011F3447CA200D7FB7F.cache.png',De='65px',sg=':',vn=': ',id=';',rd='<',yd='<!--',wd='<![CDATA[',bd='<div><\/div>',Dc="<img src='",ug='=',td='>',fb='@',oi='AbsolutePanel',ui='AbstractCollection',Cl='AbstractHashMap',El='AbstractHashMap$EntrySet',Fl='AbstractHashMap$EntrySetIterator',cm='AbstractHashMap$MapEntryNull',dm='AbstractHashMap$MapEntryString',ei='AbstractImagePrototype',vi='AbstractList',em='AbstractList$IteratorImpl',Bl='AbstractMap',fm='AbstractMap$1',gm='AbstractMap$1$1',bm='AbstractMapEntry',Dl='AbstractSet',nn='Add not supported on this collection',on='Add not supported on this list',ah='Animation',dh='Animation$1',Cg='Animation;',wi='ArrayList',ml='ArrayStoreException',jk='AttrImpl',nl='Boolean',bc='Bottom',si='Button',qi='ButtonBase',mk='CDATASectionImpl',nc='CENTER',nm='CSS1Compat',Em="Can't overwrite cause",Cm='Cannot set a new parent without first clearing the old parent',ti='CellPanel',zn='Center',kk='CharacterDataImpl',pl='Class',ql='ClassCastException',xi='ClickListenerCollection',ii='ClippedImagePrototype',Fj='CommandCanceledException',ak='CommandExecutor',ck='CommandExecutor$1',dk='CommandExecutor$2',bk='CommandExecutor$CircularIterator',nk='CommentImpl',ni='ComplexPanel',dc='Content',yh='ContentFetchedHandler$ContentFetchedEvent',xm='DIV',pk='DOMException',qh='DOMImpl',sh='DOMImplMozilla',rh='DOMImplStandard',gk='DOMItem',vl='DOMMouseScroll',qk='DOMParseException',pe='Damn!!\nAn Exception getting content from streamspin..\n\n',Ai='DecoratedPopupPanel',Bi='DecoratorPanel',rk='DocumentFragmentImpl',sk='DocumentImpl',ci='DocumentRootImpl',Ch='DynamicHeightFeature',uk='ElementImpl',ue='Enable debug Mode',ai='Enum',zh='Event$2',wh='EventObject',jh='Exception',xe='Exit',Ad='Failed to parse: ',pi='FocusWidget',qg='For input string: "',xf='GPS Default: ',zf='GPS Threshhold: ',Dh='Gadget',Ei='HTML',Fi='HasHorizontalAlignment$HorizontalAlignmentConstant',aj='HasVerticalAlignment$VerticalAlignmentConstant',hm='HashMap',im='HashSet',bj='HorizontalPanel',Fd='INPUT',rl='IllegalArgumentException',sl='IllegalStateException',cj='Image',dj='Image$State',ej='Image$UnclippedState',pn='Index: ',ll='IndexOutOfBoundsException',En='Inner',Eh='IntrinsicFeature',Fh='IntrinsicFeature$2',mh='JavaScriptException',nh='JavaScriptObject$',Di='Label',yn='Left',fj='ListBox',Ak='Location',fd='Macintosh',jm='MapEntryImpl',Ce='Menu',gj='MenuBar',ij='MenuBar$1',jj='MenuBar$2',kj='MenuBar_MenuBarImages_generatedBundle',lj='MenuItem',ac='Middle',mm='MouseEvents',lf='New Item',km='NoSuchElementException',hk='NodeImpl',vk='NodeListImpl',rm='Null widget handle. If you are creating a composite, ensure that initWidget() has been called.',tl='NullPointerException',wl='NumberFormatException',oc='ONE_WAY_CORNER',Eg='Object',Al='Object;',se='Off',re='On',mi='Panel',oj='PasswordTextBox',vb='Popup',ji='PopupImplMozilla$1',pj='PopupListenerCollection',zi='PopupPanel',qj='PopupPanel$AnimationType',rj='PopupPanel$ResizeAnimation',tj='PopupPanel$ResizeAnimation$1',wk='ProcessingInstructionImpl',Bk='Profile',An='Right',uj='RootPanel',wj='RootPanel$1',vj='RootPanel$DefaultRootPanel',kh='RuntimeException',kn='Self-causation not permitted',Ee='Send Message',Ck='ServiceProfile',Be='Set Profile',ze='SetLocation',zm="Should only call onAttach when the widget is detached from the browser's document",Am="Should only call onDetach when the widget is attached to the browser's document",yi='SimplePanel',xj='SimplePanel$1',yl='StackTraceElement;',Ae='Start Service',Dk='StartService',kf='Status: <b>Offline<\/b>',jf='Status: <b>Online<\/b>',Fk='StreamSpinClient',al='StreamSpinClient$1',bl='StreamSpinClient$2',cl='StreamSpinClient$3',dl='StreamSpinClient$4',el='StreamSpinClient$5',fl='StreamSpinClient$6',gl='StreamSpinClient$8',hl='StreamSpinClientGadgetImpl',ic='String',uh='String;',xl='StringBuffer',gh='StringBufferImpl',hh='StringBufferImplAppend',sm='Style names cannot be empty',yj='TextArea',nj='TextBox',mj='TextBoxBase',lk='TextImpl',df='This is some content that should show how the widget handles stuff,\n <b> wwwwwwwwwww wwwwwwwwww wwwwwwwwww wwwwew rw er<\/b>',Bm="This widget's parent does not implement HasWidgets",ih='Throwable',ch='Timer',ek='Timer$1',Fb='Top',ki='UIObject',zl='UnsupportedOperationException',te='Use GPS',wf='User id: ',il='UserInfo',zj='VerticalPanel',li='Widget',Bj='Widget;',Cj='WidgetCollection',Ej='WidgetCollection$WidgetIterator',ye='Write Message',xk='XMLParserImpl',yk='XMLParserImplStandard',kl='XmlParser',Fe='You can send messages to your friends with this',of='You selected a menu item which has not yet been implemented!',jn='[',ol='[C',Bg='[Lcom.google.gwt.animation.client.',Aj='[Lcom.google.gwt.user.client.ui.',th='[Ljava.lang.',mn=']',xd=']]>',hf='__gwt_gadget_content_div',qc='absolute',hn='align',xb='aria-activedescendant',jc='aria-haspopup',gd='auto',nf='blur',fo='bottom',bn='button',wn='cellPadding',un='cellSpacing',co='center',yf='change',mg='class ',pm='className',Fc="clear.cache.gif' style='",dg='click',cd='clip',mf='cmd',bf='cmd cannot be null',zb='colSpan',Fg='com.google.gwt.animation.client.',lh='com.google.gwt.core.client.',fh='com.google.gwt.core.client.impl.',oh='com.google.gwt.dom.client.',Bh='com.google.gwt.gadgets.client.',xh='com.google.gwt.gadgets.client.event.',bh='com.google.gwt.user.client.',bi='com.google.gwt.user.client.impl.',di='com.google.gwt.user.client.ui.',hi='com.google.gwt.user.client.ui.impl.',ok='com.google.gwt.xml.client.',fk='com.google.gwt.xml.client.impl.',zk='com.streamspin.client.',Ag='com.streamspin.client.StreamSpinClient',am='contextmenu',og='dblclick',Ff='defaulton',dd='display',Dn='div',Ek='error',kg='false',zg='focus',qe='foo 2',rg='g',cn='gwt-Button',cc='gwt-DecoratedPopupPanel',Bn='gwt-DecoratorPanel',bo='gwt-HTML',jo='gwt-Image',Fn='gwt-Label',lo='gwt-ListBox',lb='gwt-MenuBar',ub='gwt-MenuBarPopup',fc='gwt-MenuItem',tf='gwt-PasswordTextBox',Cb='gwt-PopupPanel',xc='gwt-TextArea',rf='gwt-TextBox',we='gwt-uid-',qm='height',ul='hidden',qb='hideFocus',nb='horizontal',lm='html',ne='http://webclient.streamspin.com/Default.aspx?type=',Dd='http://www.mozilla.org/newlayout/xml/parsererror.xml',yb='id',uf='images/daisy.gif',ko='img',lg='interface ',Dg='java.lang.',vh='java.util.',eh='keydown',ph='keypress',Ah='keyup',Dm='left',gi='load',Df='location',Cf='locations',Ef='locid',ri='losecapture',tb='menuPopup',kb='menubar',gc='menuitem',Ec='message',go='middle',xg='moduleStartup',Ci='mousedown',hj='mousemove',sj='mouseout',Dj='mouseover',ik='mouseup',jl='mousewheel',tm='must be positive',tc='name',ed='none',Db='null',gb='offsetHeight',ve='offsetWidth',yg='onModuleLoadStart',ib='option',ob='outline',fi='overflow',Cd='parsererror',sf='password',Eb='popupContent',an='position',fg='profile',eg='profiles',rn='px',Cc='px ',uc='px)',sc='px, ',Ac='px; background: url(',zc='px; height: ',ng='radix ',kc='readOnly',lc='readonly',rc='rect(',vc='rect(0px, 0px, 0px, 0px)',pc='rect(auto, auto, auto, auto)',eo='right',jb='role',tk='scroll',ke='select',hc='selected',hg='serviceprofile',gg='serviceprofiles',pf='someTest',cg='startservice',bg='startservices',wg='startup',Bb='subMenuIcon',wb='subMenuIcon-selected',dn='submit',fn='table',gn='tbody',Cn='td',qf='text',Bd='text/xml',wc='textarea',ig='there is an exception:\n',om='title',af='title of Main Window',jd='toString',Fm='top',xn='tr',ag='treshhold',rb='true',en='type',Af='uid',Ab='vAlign',mc='value',mb='vertical',io='verticalAlign',sn='visibility',tn='visible',vm='width',yc='width: ',tg='{',vg='}';var _;function jY(a){return this===(a==null?null:a)}
...
function zs(c,a){var b;b=et(new dt(),a);tU(c.a,b)}
...
function mT(){}
_=mT.prototype=new hY();_.gC=qT;_.tS=rT;_.tI=69;_.a=null;_.b=0;_.c=null;function CU(e,d){var a,c,f,g;f=d;g=ne+d+oe;try{Es(g,ys(new xs(),rU(new qU(),e,f)),10)}catch(a){a=iz(a);if(ku(a,19)){c=a;$wnd.alert(pe+c.D())}else throw a}if(e.l==null)return CU(e,d);else return e.l}
function cV(m){var b,d,f,h,j,l;l=CU(m,8);wV((zV(),l));$wnd.alert(qe);b=bI(new tH(),true);dI(b,eJ(new dJ(),re,m.a));dI(b,eJ(new dJ(),se,m.a));f=bI(new tH(),true);dI(f,eJ(new dJ(),te,m.a));j=bI(new tH(),true);h=bI(new tH(),true);d=bI(new tH(),true);dI(d,fJ(new dJ(),ue,b));dI(d,eJ(new dJ(),xe,m.m));dI(d,eJ(new dJ(),ye,m.k));dI(d,fJ(new dJ(),ze,f));dI(d,fJ(new dJ(),Ae,j));dI(d,fJ(new dJ(),Be,h));dI(m.d,fJ(new dJ(),Ce,d));m.d.b=false;m.d.r.style[vm]=De;qF(m.g,hU(new gU(),m));cr((yq(),m.g.r),Ee);jN(m.g,Fe);cr(m.n.r,af);tG(m.e,m.d);tG(m.e,m.n);tG(m.e,m.g);oE(m.e,m.d,(bG(),eG));oE(m.e,m.n,cG);oE(m.e,m.g,fG);m.e.r.style[vm]=cf;qF(m.i,mU(new lU(),m));m.i.r.size=5;m.i.r.style[vm]=cf;m.c.r[mc]=df!=null?df:ao;zM(m.c,true);m.c.r.style[vm]=cf;m.c.r.style[qm]=ef;wN(m.j,m.i);wN(m.j,m.c);m.j.r.style[qm]=ff;m.j.r.style[vm]=cf;FU(m,(cW(),eW));wN(m.f,m.e);wN(m.f,m.j);wN(m.f,m.h);m.f.r.style[qm]=gf;m.f.r.style[vm]=cf;xD((tL(),xL(null)),m.f);xL(hf);$wnd._IG_AdjustIFrameHeight()}
function FU(b,a){if(a.a){b.h.r.innerHTML=jf}else{b.h.r.innerHTML=kf}}
function dV(a){pH(a.i,lf,mf,-1);FU(a,(cW(),dW))}
function eV(){return zx}
function gV(a){}
function fV(a){}
function sT(){}
_=sT.prototype=new ss();_.gC=eV;_.cb=gV;_.bb=fV;_.tI=0;_.l=null;function vT(){$wnd.alert(of)}
...
function lU(){}
_=lU.prototype=new hY();_.gC=oU;_.gb=pU;_.tI=75;_.a=null;function rU(b,a,c){b.a=a;b.b=c;return b}
function tU(b,a){b.a.l=a.a;if(b.b==8)cV(b.a)}
function uU(){return xx}
function qU(){}
_=qU.prototype=new hY();_.gC=uU;_.tI=0;_.a=null;_.b=0;function wU(b){var a;b.f=vN(new tN());b.e=sG(new qG());b.j=vN(new tN());b.i=nH(new mH(),false);b.c=sM(new rM());b.d=aI(new tH());b.g=gE(new aE(),pf);b.h=hH(new gH());b.n=wF(new vF());vN(new tN());DM(new vM(),Aq((yq(),qf)),rf);DM(new sJ(),(a=$doc.createElement(Fd),a.type=sf,a),tf);fE(new aE());bH(new yG(),$moduleBase+uf);b.b=l3(new k3());b.a=new tT();yT(new xT(),b);b.m=DT(new CT(),b);b.k=cU(new bU(),b);b.bb(new ns());b.cb(new ws());CU(b,8);return b}
