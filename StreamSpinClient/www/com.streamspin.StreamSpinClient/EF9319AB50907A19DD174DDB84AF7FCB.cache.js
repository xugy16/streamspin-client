(function(){var $gwt_version = "null";var $wnd = window;var $doc = $wnd.document;var $moduleName, $moduleBase;var $stats = $wnd.__gwtStatsEvent ? function(a) {return $wnd.__gwtStatsEvent(a);} : null;$stats && $stats({moduleName:'com.streamspin.StreamSpinClient',subSystem:'startup',evtGroup:'moduleStartup',millis:(new Date()).getTime(),type:'moduleEvalStart'});var Cp='',fe='\tContent : ',de='\tHeadline : ',oe='\tId : ',me='\tLatitude: ',le='\tLongtitude: ',je='\tName : ',qe='\tName: ',te='\tScript Url: ',re='\tService id: ',ye='\tStartURL: ',se='\tXml Script: ',xe='\tid: ',ee='\n',ah='\n\n',ud='\n ',ce='\nContent\n',ie='\nLocation\n',ne='\nProfile\n',pe='\nServiceProfile\n',ue='\nStartService\n',xo=' ',th=' out of range',pd='"',nd='&',od='&amp;',sd='&apos;',xd='&gt;',vd='&lt;',hg='&pw=',qd='&quot;',md='&semi;',Bf='&serviceid=',gg='&un=',Cf='&unique=',rd="'",gd="' border='0'>",hb='(',kd='(?=[;&<>\'"])',zo='(null handle)',cd=') no-repeat ',sb='): ',lp=', ',qp=', Size: ',ph='-',jg='------------------------------\n--- User Information ---\n------------------------------\n',Bd='-->',eh='-9223372036854775808',og='/ by zero',zg='0',xb='0px',Ae='100%',Be='100px',id='1px',Ce='300px',vg='30px',qg='310px',rg='320px',kc='548CDF11D6FE9011F3447CA200D7FB7F.cache.png',pf='65px',vh=':',rp=': ',ld=';',td='<',Ad='<!--',yd='<![CDATA[',Df='<\/br><center><font size="6" face="Times" color="Green">Loading...<\/font><\/br><\/br><\/br><img border="0" src="',Ff='<\/center>',cg='<b>Login<\/b>',ed="<img src='",xh='=',wd='>',Af='?userid=',fb='@',ze='@StreamSpin',wj='AbsolutePanel',Bj='AbstractCollection',En='AbstractHashMap',ao='AbstractHashMap$EntrySet',bo='AbstractHashMap$EntrySetIterator',fo='AbstractHashMap$MapEntryNull',go='AbstractHashMap$MapEntryString',lj='AbstractImagePrototype',Cj='AbstractList',ho='AbstractList$IteratorImpl',Dn='AbstractMap',io='AbstractMap$1',jo='AbstractMap$1$1',co='AbstractMapEntry',Fn='AbstractSet',np='Add not supported on this collection',op='Add not supported on this list',sg='An Error occurred while retrieving and parsing the list of your friends\n\n',di='Animation',ii='Animation$1',Fh='Animation;',em='AnswerWrapper',Ee='Application encountered a problem contacting StreamSpin\nPlease reload the application\n\nIf the problem persist StreamSpin may be down for maintenance\n\n',kn='ArithmeticException',Ej='ArrayList',mn='ArrayStoreException',ql='AttrImpl',bf='BODY',on='Boolean',uf='Both username and password has to be filled out',gc='Bottom',zj='Button',yj='ButtonBase',tl='CDATASectionImpl',uc='CENTER',Bo="Can't overwrite cause",pg='Cancel',Eo='Cannot set a new parent without first clearing the old parent',Aj='CellPanel',Bp='Center',rl='CharacterDataImpl',vf='Check',rn='Class',sn='ClassCastException',Fj='ClickListenerCollection',nj='ClippedImagePrototype',gl='CommandCanceledException',hl='CommandExecutor',kl='CommandExecutor$1',ll='CommandExecutor$2',il='CommandExecutor$CircularIterator',wl='CommentImpl',vj='ComplexPanel',jc='Content',Di='ContentFetchedHandler$ContentFetchedEvent',fm='ContentPopup',gm='ContentPopup$1',yl='DOMException',ui='DOMImpl',wi='DOMImplSafari',vi='DOMImplStandard',ol='DOMItem',oo='DOMMouseScroll',zl='DOMParseException',ig='Damn!!\nAn Exception getting content from streamspin..\n\n',ck='DecoratedPopupPanel',dk='DecoratorPanel',Al='DocumentFragmentImpl',Bl='DocumentImpl',ij='DocumentRootImpl',jj='DocumentRootImplSafari',tn='Double',aj='DynamicHeightFeature',Cl='ElementImpl',tg='Empty Friend List',gf='Enable debug Mode',ej='Enum',Ei='Event$2',Ai='EventObject',ni='Exception',Fg='Exception!\nCould not parse content update: \n\n',hf='Exit',Cd='Failed to parse: ',oj='FocusImpl',pj='FocusImplOld',qj='FocusImplSafari',xj='FocusWidget',rh='For input string: "',hm='Friend',lg='GPS Default: ',mg='GPS Threshhold: ',bj='Gadget',fk='HTML',gk='HasHorizontalAlignment$HorizontalAlignmentConstant',hk='HasVerticalAlignment$VerticalAlignmentConstant',ko='HashMap',lo='HashSet',jk='HorizontalPanel',Fd='INPUT',zf='Id: ',un='IllegalArgumentException',vn='IllegalStateException',kk='Image',lk='Image$State',mk='Image$UnclippedState',pp='Index: ',ln='IndexOutOfBoundsException',aq='Inner',cj='IntrinsicFeature',dj='IntrinsicFeature$2',qi='JavaScriptException',si='JavaScriptObject$',ek='Label',Ap='Left',nk='ListBox',im='Location',bg='Login Screen',mo='MapEntryImpl',of='Menu',ok='MenuBar',pk='MenuBar$1',qk='MenuBar$2',rk='MenuBar_MenuBarImages_generatedBundle',sk='MenuItem',fc='Middle',ug='No Friends have been retrieved from StreamSpin',ff='No Interests Profiles found',df='No Predefined Locations',ef='No Service Subscriptions found',no='NoSuchElementException',pl='NodeImpl',Dl='NodeListImpl',vo='Null widget handle. If you are creating a composite, ensure that initWidget() has been called.',wn='NullPointerException',pn='Number',xn='NumberFormatException',vc='ONE_WAY_CORNER',bi='Object',Cn='Object;',af='Off',Fe='On',uj='Panel',wk='PasswordTextBox',Cb='Popup',xk='PopupListenerCollection',bk='PopupPanel',yk='PopupPanel$AnimationType',zk='PopupPanel$ResizeAnimation',Ak='PopupPanel$ResizeAnimation$1',El='ProcessingInstructionImpl',jm='Profile',Dp='Right',Bk='RootPanel',Dk='RootPanel$1',Ck='RootPanel$DefaultRootPanel',oi='RuntimeException',gp='Self-causation not permitted',ng='Send Message',km='ServiceProfile',kf='Set Location',mf='Set Profile',Ao="Should only call onAttach when the widget is detached from the browser's document",Co="Should only call onDetach when the widget is attached to the browser's document",ak='SimplePanel',Fk='SimplePanel$1',An='StackTraceElement;',lf='Start Service',mm='StartService',rf='Status: <b>Offline<\/b>',qf='Status: <b>Online<\/b>',nm='StreamSpinClient',xm='StreamSpinClient$1',ym='StreamSpinClient$2',zm='StreamSpinClient$3',Am='StreamSpinClient$3$1',Bm='StreamSpinClient$4',Cm='StreamSpinClient$5',sm='StreamSpinClient$mainTopWindowListBoxContentupdate',tm='StreamSpinClient$mainTopWindowListBoxContentupdate$1',om='StreamSpinClient$setLocation',pm='StreamSpinClient$setLocation$1',rm='StreamSpinClient$setProfile',qm='StreamSpinClient$startService',um='StreamSpinClient$startUpLoadingScreen',vm='StreamSpinClient$startUpLoadingScreen$1',Dm='StreamSpinClientGadgetImpl',Em='StreamSpinContact',Fm='StreamSpinContact$1',an='StreamSpinContact$2',ic='String',yi='String;',zn='StringBuffer',ki='StringBufferImpl',li='StringBufferImplAppend',wo='Style names cannot be empty',al='TextArea',vk='TextBox',uk='TextBoxBase',sl='TextImpl',Bg='The Message was not sent:\n\n',yg='The Msg Ans: ',Do="This widget's parent does not implement HasWidgets",mi='Throwable',hi='Timer',ml='Timer$1',ec='Top',rj='UIObject',Bn='UnsupportedOperationException',cf='Use GPS',kg='User id: ',cn='UserInfo',dn='UserMessage',en='UserMessage$1',fn='UserMessage$2',gn='UserMessage$3',hn='UserMessage$4',bl='VerticalPanel',tj='Widget',dl='Widget;',el='WidgetCollection',fl='WidgetCollection$WidgetIterator',jf='Write Message',Fl='XMLParserImpl',cm='XMLParserImplSafari',bm='XMLParserImplStandard',jn='XmlParser',kp='[',qn='[C',Eh='[Lcom.google.gwt.animation.client.',cl='[Lcom.google.gwt.user.client.ui.',xi='[Ljava.lang.',fj='[[D',mp=']',zd=']]>',De='__gwt_gadget_content_div',he='_blank',eg='a problem.. the google url-translation feature has failed..',nf='absolute',jp='align',Fb='aria-activedescendant',oc='aria-haspopup',gi='blur',we='border-left-width',yf='border-top-width',jb='bottom',cp='button',yp='cellPadding',xp='cellSpacing',gq='center',ri='change',qh='class ',to='className',fd="clear.cache.gif' style='",Ci='click',wc='clip',Ah='cmd cannot be null',bc='colSpan',ci='com.google.gwt.animation.client.',pi='com.google.gwt.core.client.',ji='com.google.gwt.core.client.impl.',ti='com.google.gwt.dom.client.',Fi='com.google.gwt.gadgets.client.',Bi='com.google.gwt.gadgets.client.event.',ei='com.google.gwt.user.client.',gj='com.google.gwt.user.client.impl.',kj='com.google.gwt.user.client.ui.',mj='com.google.gwt.user.client.ui.impl.',xl='com.google.gwt.xml.client.',nl='com.google.gwt.xml.client.impl.',dm='com.streamspin.client.',Dh='com.streamspin.client.StreamSpinClient',Eg='content',po='contextmenu',hj='dblclick',gh='defaulton',ro='div',yn='error',Ag='false',sj='focus',bh='friend',uh='g',dp='gwt-Button',hc='gwt-DecoratedPopupPanel',Ep='gwt-DecoratorPanel',cq='gwt-HTML',mb='gwt-Image',bq='gwt-Label',ob='gwt-ListBox',tb='gwt-MenuBar',Bb='gwt-MenuBarPopup',lc='gwt-MenuItem',sc='gwt-PasswordTextBox',sp='gwt-PopupPanel',Dc='gwt-TextArea',qc='gwt-TextBox',dg='gwt-uid-',Dg='headline',uo='height',ul='hidden',yb='hideFocus',vb='horizontal',ge='http://',fg='http://webclient.streamspin.com/Default.aspx?type=',ac='id',Ef='images/ajax-loader.gif" /> ',ag='images/daisy.gif',nb='img',hd='input',oh='interface ',ai='java.lang.',zi='java.util.',Dj='keydown',ik='keypress',tk='keyup',xf='lat',Fo='left',Ek='load',fh='location',dh='locations',wf='lon=',jl='losecapture',Ab='menuPopup',rb='menubar',mc='menuitem',Ec='message',kb='middle',Bh='moduleStartup',vl='mousedown',am='mousemove',lm='mouseout',wm='mouseover',bn='mouseup',eo='mousewheel',Cg='msg',wg='msg=',qo='must be positive',tc='name',eq='normal',fq='nowrap',Db='null',gb='offsetHeight',ve='offsetWidth',Ch='onModuleLoadStart',pb='option',wb='outline',fi='overflow',Ed='parsererror',rc='password',tp='popupContent',bp='position',lh='profile',kh='profiles',wp='px',dd='px ',Ac='px)',zc='px, ',bd='px; background: url(',ad='px; height: ',sh='radix ',xg='rcv',yc='rect(',Bc='rect(0px, 0px, 0px, 0px)',xc='rect(auto, auto, auto, auto)',ib='right',qb='role',nn='scroll',ke='select',nc='selected',nh='serviceprofile',mh='serviceprofiles',jh='startservice',ih='startservices',zh='startup',be='style',dc='subMenuIcon',Eb='subMenuIcon-selected',ep='submit',hp='table',ip='tbody',Fp='td',pc='text',Dd='text/xml',Cc='textarea',jd='toString',ap='top',zp='tr',hh='treshhold',zb='true',fp='type',ch='uid',sf='uid=',cc='vAlign',tf='value',ub='vertical',lb='verticalAlign',up='visibility',vp='visible',ae='white-space: pre; border: 2px solid #c77; padding: 0 1em 0 1em; margin: 1em; background-color: #fdd; color: black',dq='whiteSpace',yo='width',Fc='width: ',so='width:0px;width:1',wh='{',yh='}';var _,hq=[0,-9223372036854775808],iq=[16777216,0],jq=[4294967295,9223372032559808512];function l7(a){return this===(a==null?null:a)}
...
function dZ(){}
_=dZ.prototype=new j7();_.gC=hZ;_.tS=iZ;_.tI=72;_.a=null;_.b=0;_.c=null;function z1(b){var a;v1(b);Fs((vs(),b.n.y),F1(E1)+ze);FK(b.g,b.f);FK(b.g,b.n);FK(b.g,b.a);uI(b.g,b.f,(nK(),qK));uI(b.g,b.n,oK);uI(b.g,b.a,rK);b.g.y.style[yo]=Ae;a=DZ(new CZ(),b);zF(a,25000);zJ(b.j,yZ(new sZ(),b));b.j.y.size=20;b.j.y.style[yo]=Ae;gS(b.k,b.j);b.k.y.style[uo]=Be;b.k.y.style[yo]=Ae;x1(b,(u4(),w4));gS(b.h,b.g);gS(b.h,b.k);gS(b.h,b.i);b.h.y.style[uo]=Ce;b.h.y.style[yo]=Ae;DH((eQ(),iQ(null)),b.h);iQ(De);$wnd._IG_AdjustIFrameHeight()}
function v1(p){var a,c,d,e,f,g,h,i,j,k,l,m,n,o;g=null;try{g=c4((h4(),p.m.a))}catch(a){a=eC(a);if(lw(a,19)){d=a;$wnd.alert(Ee+F8(d))}else throw a}c=rM(new dM(),true);tM(c,vN(new uN(),Fe,p.l));tM(c,vN(new uN(),af,p.l));m=rM(new dM(),true);tM(m,vN(new uN(),cf,p.l));if(g.c.b==0){tM(m,vN(new uN(),df,p.l))}for(f=a_(new E$(),g.c);f.a<f.b.Cb();){e=iw(d_(f),20);tM(m,vN(new uN(),e.c,w0(new q0(),e.b,e.a)))}o=rM(new dM(),true);if(g.f.b==0){tM(o,vN(new uN(),ef,p.l))}for(l=a_(new E$(),g.f);l.a<l.b.Cb();){k=iw(d_(l),21);tM(o,vN(new uN(),k.a,a1(new F0(),k.b,k.c)))}n=rM(new dM(),true);if(g.d.b==0){tM(n,vN(new uN(),ff,p.l))}for(j=a_(new E$(),g.d);j.a<j.b.Cb();){i=iw(d_(j),22);tM(n,vN(new uN(),i.b,B0(new A0(),i.a)))}h=rM(new dM(),true);tM(h,wN(new uN(),gf,c));tM(h,vN(new uN(),hf,p.l));tM(h,vN(new uN(),jf,p.o));tM(h,wN(new uN(),kf,m));tM(h,wN(new uN(),lf,o));tM(h,wN(new uN(),mf,n));tM(p.f,wN(new uN(),of,h));p.f.b=false;p.f.y.style[yo]=pf}
function x1(b,a){if(a.a){b.i.y.innerHTML=qf}else{b.i.y.innerHTML=rf}}
...
function a0(){var a;a=new yX();a.a=null;t2(q2(new e2()),2,a,Dv(aC,0,1,[sf+D1]));zF(n0(new g0(),a,this.a).c,500)}
function CZ(){}
_=CZ.prototype=new qF();_.gC=FZ;_.wb=a0;_.tI=76;_.a=null;function c0(b,a){b.a=a;return b}
function e0(){return Fz}
function f0(a){if(mt(this.a.e.y,tf).length>0&&mt(this.a.d.y,tf).length>0){E1=mt(this.a.e.y,tf);C1=mt(this.a.d.y,tf);FH((eQ(),iQ(null)),this.a.c);t2(q2(new e2()),8,this.a.m,Dv(aC,0,1,[]));k1(new e1(),this.a)}else{$wnd.alert(uf)}}
function b0(){}
...
function l0(){var a,b,c;if(this.a.a.a!=null){wF(this);EL(this.a.b.j,vf,this.a.a.a,-1);if(this.a.a.a.length){c=a4((h4(),this.a.a.a));for(b=a_(new E$(),c);b.a<b.b.Cb();){a=iw(d_(b),23);EL(this.a.b.j,a.b,a.a,-1)}}}}
function h0(){}
_=h0.prototype=new qF();_.gC=k0;_.wb=l0;_.tI=78;_.a=null;function w0(c,b,a){c.b=b;c.a=a;return c}
function y0(){var a,b;a=new yX();t2(q2(new e2()),5,a,Dv(aC,0,1,[wf+this.b,xf+this.a,sf+D1]));b=(t0(),xF(),new r0());zF(b,1000)}
...
function D0(){$wnd.alert(zf+this.a)}
function E0(){return eA}
function A0(){}
_=A0.prototype=new j7();_.ab=D0;_.gC=E0;_.tI=81;_.a=0;function a1(c,b,a){c.a=b;c.b=a;return c}
function c1(){this.b=this.b+Af+D1+Bf+this.a+Cf+hD(zC((new Date()).getTime()));$wnd.open(this.b,he,null)}
function d1(){return fA}
function F0(){}
_=F0.prototype=new j7();_.ab=c1;_.gC=d1;_.tI=82;_.a=0;_.b=null;function k1(d,c){var a,b,e;d.a=c;fP(d);d.l=false;sP(d);b=d;a=aK(new FJ());a.y.innerHTML=Df+$moduleBase+Ef+Ff||Cp;yR(a,Cp+(qH(),rH).clientWidth*0.95,Cp+($wnd.devicePixelRatio?rH.clientHeight:$wnd.innerHeight)*0.9);vQ(d,a);lP(d);e=g1(new f1(),d,b);zF(e,1000);return d}
...
function f1(){}
_=f1.prototype=new qF();_.gC=i1;_.wb=j1;_.tI=84;_.a=null;_.b=null;function o1(a){a.h=fS(new dS());a.g=EK(new CK());a.k=fS(new dS());a.j=AL(new zL(),false);a.f=qM(new dM());a.i=tL(new sL());a.n=aK(new FJ());a.c=fS(new dS());a.e=mR(new gR());a.d=eO(new dO());a.b=lI(new gI());a.a=nL(new eL(),$moduleBase+ag);a.m=new yX();a.l=new kZ();a.o=new oZ();a.jb(new nu());a.kb(new wu());Fs((vs(),a.n.y),bg);a.b.y.innerHTML=cg;zJ(a.b,c0(new b0(),a));gS(a.c,a.n);gS(a.c,a.e);gS(a.c,a.d);gS(a.c,a.b);DH((eQ(),iQ(null)),a.c);return a}
...
function s2(k,f,d){var a,c,e,g,h,i,j,l;c=Cp;for(h=d,i=0,j=h.length;i<j;++i){g=h[i];c+=nd+g}if(!k.a){$wnd.alert(eg)}l=fg+f+gg+E1+hg+C1+c;try{Eu(l,yu(new xu(),l2(new k2(),k)),10)}catch(a){a=eC(a);if(lw(a,19)){e=a;$wnd.alert(ig+F8(e))}else throw a}}
...
function j2(){if(this.a.b!=null){this.b.a=this.a.b;this.a.b=null;wF(this)}}
function f2(){}
...
function b3(){var q,r,s,t,u,v,w,x,y;u=jg;u+=kg+this.g+ee;for(r=a_(new E$(),this.c);r.a<r.b.Cb();){q=iw(d_(r),20);u+=uY(q)}u+=lg+this.a+ee;u+=mg+this.b+ee;for(w=a_(new E$(),this.f);w.a<w.b.Cb();){v=iw(d_(w),21);u+=gZ(v)}for(t=a_(new E$(),this.d);t.a<t.b.Cb();){s=iw(d_(t),22);u+=AY(s)}for(y=a_(new E$(),this.e);y.a<y.b.Cb();){x=iw(d_(y),24);u+=aZ(x)}return u}
function v2(){}
_=v2.prototype=new j7();_.gC=a3;_.tS=b3;_.tI=0;_.a=null;_.b=0;_.g=0;function y3(c){var a,b;fP(c);c.l=false;c.g=EK(new CK());c.h=fS(new dS());c.d=EK(new CK());c.e=dR(new cR());c.j=mI(new gI(),ng);c.a=mI(new gI(),pg);c.f=AL(new zL(),true);c.b=sab(new rab());c.i=c;a=new yX();t2(q2(new e2()),6,a,Dv(aC,0,1,[sf+D1]));b=e3(new d3(),c,a);zF(b,1000);return c}
function B3(f){var a,c,d,e;FK(f.g,f.a);FK(f.g,f.j);gS(f.h,f.e);gS(f.h,f.g);FK(f.d,f.f);FK(f.d,f.h);yR(f.d,qg,rg);zJ(f.j,j3(new i3(),f));zJ(f.a,o3(new n3(),f));if(f.c.length){try{f.b=b4((h4(),f.c))}catch(a){a=eC(a);if(lw(a,19)){c=a;$wnd.alert(sg+F8(c))}else throw a}}if(f.b.b==0)EL(f.f,tg,ug,-1);else{for(e=a_(new E$(),f.b);e.a<e.b.Cb();){d=iw(d_(e),25);EL(f.f,d.b,Cp+d.a,-1)}}yR(f.f,Be,Cp+($wnd.devicePixelRatio?(qH(),rH).clientHeight:$wnd.innerHeight)*0.8);f.f.y.size=14;yR(f.e,Ae,Cp+(($wnd.devicePixelRatio?(qH(),rH).clientHeight:$wnd.innerHeight)*0.8-30));yR(f.g,Ae,vg);yR(f.d,Ae,Ae)}
function C3(b,c){var a,d;a=new yX();t2(q2(new e2()),3,a,Dv(aC,0,1,[wg+b,xg+c,sf+D1]));d=t3(new s3(),a);zF(d,1000)}
...
function m3(b){var a;for(a=0;a<(vs(),this.a.f.y).children.length;++a){if(FL(this.a.f,a)){C3(mt(this.a.e.y,tf),e7(DL(this.a.f,a),10,-2147483648,2147483647))}}}
function i3(){}
