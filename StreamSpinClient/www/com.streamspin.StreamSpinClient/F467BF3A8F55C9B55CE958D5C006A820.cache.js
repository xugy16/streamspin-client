...
function ws(c,a){var b;b=bt(new at(),a);BU(c.a,b)}
...
function uT(){}
_=uT.prototype=new pY();_.gC=yT;_.tS=zT;_.tI=68;_.a=null;_.b=0;_.c=null;function eV(e,d){var a,c,f,g;f=d;g=oe+d+pe;try{Bs(g,vs(new us(),zU(new yU(),e,f)),10)}catch(a){a=hz(a);if(hu(a,19)){c=a;$wnd.alert(qe+c.E())}else throw a}if(e.l==null)return eV(e,d);else return e.l}
function kV(m){var b,d,f,h,j,l;l=eV(m,8);EV((bW(),l));$wnd.alert(re);b=AH(new mH(),true);CH(b,EI(new DI(),se,m.a));CH(b,EI(new DI(),te,m.a));f=AH(new mH(),true);CH(f,EI(new DI(),ue,m.a));j=AH(new mH(),true);h=AH(new mH(),true);d=AH(new mH(),true);CH(d,FI(new DI(),xe,b));CH(d,EI(new DI(),ye,m.m));CH(d,EI(new DI(),ze,m.k));CH(d,FI(new DI(),Ae,f));CH(d,FI(new DI(),Be,j));CH(d,FI(new DI(),Ce,h));CH(m.d,FI(new DI(),De,d));m.d.b=false;m.d.r.style[tm]=Ee;iF(m.g,pU(new oU(),m));Eq((uq(),m.g.r),Fe);dN(m.g,af);Eq(m.n.r,cf);mG(m.e,m.d);mG(m.e,m.n);mG(m.e,m.g);dE(m.e,m.d,(AF(),DF));dE(m.e,m.n,BF);dE(m.e,m.g,EF);m.e.r.style[tm]=df;iF(m.i,uU(new tU(),m));m.i.r.size=5;m.i.r.style[tm]=df;m.c.r[mc]=ef!=null?ef:Dn;sM(m.c,true);m.c.r.style[tm]=df;m.c.r.style[om]=ff;qN(m.j,m.i);qN(m.j,m.c);m.j.r.style[om]=gf;m.j.r.style[tm]=df;hV(m,(kW(),mW));qN(m.f,m.e);qN(m.f,m.j);qN(m.f,m.h);m.f.r.style[om]=hf;m.f.r.style[tm]=df;mD((mL(),qL(null)),m.f);qL(jf);$wnd._IG_AdjustIFrameHeight()}
function hV(b,a){if(a.a){b.h.r.innerHTML=kf}else{b.h.r.innerHTML=lf}}
function lV(a){iH(a.i,mf,of,-1);hV(a,(kW(),lW))}
function mV(){return yx}
function oV(a){}
function nV(a){}
function AT(){}
_=AT.prototype=new ps();_.gC=mV;_.db=oV;_.cb=nV;_.tI=0;_.l=null;function DT(){$wnd.alert(pf)}
...
function tU(){}
_=tU.prototype=new pY();_.gC=wU;_.hb=xU;_.tI=74;_.a=null;function zU(b,a,c){b.a=a;b.b=c;return b}
function BU(b,a){b.a.l=a.a;if(b.b==8)kV(b.a)}
function CU(){return wx}
function yU(){}
_=yU.prototype=new pY();_.gC=CU;_.tI=0;_.a=null;_.b=0;function EU(a){a.f=pN(new nN());a.e=lG(new jG());a.j=pN(new nN());a.i=gH(new fH(),false);a.c=lM(new kM());a.d=zH(new mH());a.g=BD(new vD(),qf);a.h=aH(new FG());a.n=pF(new oF());pN(new nN());wM(new oM());nJ(new mJ());AD(new vD());AG(new rG(),$moduleBase+rf);a.b=t3(new s3());a.a=new BT();aU(new FT(),a);a.m=fU(new eU(),a);a.k=kU(new jU(),a);a.cb(new ks());a.db(new ts());eV(a,8);return a}
