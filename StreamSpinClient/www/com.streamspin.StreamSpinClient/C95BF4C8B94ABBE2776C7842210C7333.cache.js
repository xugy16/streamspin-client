...
function CY(a){DY();tM(a,false);a.e=lI(new jI());a.f=wP(new uP());a.b=lI(new jI());a.c=sO(new rO());a.h=yF(new sF(),se);a.a=yF(new sF(),bg);a.d=hJ(new gJ(),true);a.g=a;mI(a.e,a.a);mI(a.e,a.h);xP(a.f,a.c);xP(a.f,a.e);mI(a.b,a.d);mI(a.b,a.f);iP(a.b,Eo+(DE(),FE).clientWidth*0.9,Eo+FE.clientHeight*0.85);iH(a.h,sY(new rY(),a));nJ(a.d,cg,cg,-1);nJ(a.d,eg,eg,-1);nJ(a.d,fg,fg,-1);nJ(a.d,gg,gg,-1);nJ(a.d,hg,hg,-1);nJ(a.d,ig,ig,-1);nJ(a.d,jg,jg,-1);nJ(a.d,cg,cg,-1);nJ(a.d,eg,eg,-1);nJ(a.d,fg,fg,-1);nJ(a.d,kg,kg,-1);nJ(a.d,lg,mg,-1);kP(a.d,ng);nJ(a.d,hg,hg,-1);nJ(a.d,ig,ig,-1);nJ(a.d,jg,jg,-1);iP(a.d,Ae,Eo+FE.clientHeight*0.8);a.d.w.size=14;iJ(a.d,xY(new wY(),a));iP(a.c,xe,pg);aN(a,a.b);xM(a);bN(a);return a}
