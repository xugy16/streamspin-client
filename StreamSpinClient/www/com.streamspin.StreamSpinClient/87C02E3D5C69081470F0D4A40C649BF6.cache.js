...
function cZ(e,d){var a,c,f;if(!e.a){$wnd.alert(Af)}f=Bf+d+Cf;$wnd.alert(f);try{lu(f,fu(new eu(),BY(new AY(),e)),10)}catch(a){a=dB(a);if(xv(a,20)){c=a;$wnd.alert(Df+t4(c))}else throw a}}
