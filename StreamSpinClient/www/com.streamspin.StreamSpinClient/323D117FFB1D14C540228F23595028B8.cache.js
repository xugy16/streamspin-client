...
function vU(e){var a,c,d,f;try{f=(oQ(),CS(pQ,e.k));d=rt(AR((BS(),f.a.documentElement)),21);Et(ER(new DR(),d.a.getElementsByTagNameNS(je,ke)));tM(e.b,d.a.nodeValue+le+null.xb()+le+null.xb().xb());$wnd.alert(d.a.nodeValue+me+null.xb()+ne+null.xb().xb())}catch(a){a=qy(a);if(ut(a,20)){c=a;$wnd.alert(oe+c.ab()+le+gt(my,0,31,0,0))}else throw a}$wnd.alert(e.k)}
