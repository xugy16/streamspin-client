...
function BT(){}
_=BT.prototype=new uW();_.gC=aU;_.tI=0;function dU(j){var a,c,d,e,f,g,h,i,k;hU=DT(new BT(),x1(new w1()),(pU(),x1(new w1()),x1(new w1()),x1(new w1())));try{k=(oP(),xR(pP,j));i=tt(zQ((wR(),k.a.documentElement)),20);d=DQ(new CQ(),FQ(DQ(new CQ(),i.a.getElementsByTagNameNS(kf,lf)),0).a.childNodes).a.length;tt(FQ(DQ(new CQ(),i.a.getElementsByTagNameNS(kf,mf)),0),20);tt(FQ(DQ(new CQ(),i.a.getElementsByTagNameNS(kf,of)),0),20);DQ(new CQ(),i.a.getElementsByTagNameNS(kf,mf)).a.length;for(f=0;f<~~(d/2)-1;++f){h=tt(FQ(DQ(new CQ(),i.a.getElementsByTagNameNS(kf,pf)),f),20);$wnd.alert(qf+f+rf+FQ(DQ(new CQ(),h.a.childNodes),0).a.nodeValue+rf+h.a.getAttribute(sf));z1(hU.a,dS(new cS(),sW(h.a.getAttribute(sf),10,-2147483648,2147483647),FQ(DQ(new CQ(),h.a.childNodes),0).a.nodeValue))}$wnd.alert(tf);for(e=f0(new d0(),hU.a);e.a<e.b.sb();){g=tt(i0(e),21);$wnd.alert(g.b+uf+g.a)}}catch(a){a=ry(a);if(wt(a,19)){c=a;$wnd.alert(vf+c.D()+wf+it(ny,0,31,0,0))}else throw a}return null}
