...
function f2(e){var a,c,d;bK(e.f,e.a);bK(e.f,e.i);mR(e.g,e.d);mR(e.g,e.f);bK(e.c,e.e);bK(e.c,e.g);DQ(e.c,pg,qg);CI(e.i,z1(new y1(),e));dL(e.e,rg,rg,-1);dL(e.e,sg,sg,-1);dL(e.e,tg,tg,-1);dL(e.e,ug,ug,-1);dL(e.e,vg,vg,-1);dL(e.e,wg,wg,-1);dL(e.e,xg,xg,-1);dL(e.e,yg,yg,-1);dL(e.e,Ag,Ag,-1);dL(e.e,Bg,Bg,-1);dL(e.e,Cg,Cg,-1);dL(e.e,Dg,Eg,-1);FQ(e.e,Fg);dL(e.e,ah,ah,-1);dL(e.e,bh,bh,-1);dL(e.e,ch,ch,-1);try{e.b=(p2(),(n2=o$(new n$()),n2))}catch(a){a=fC(a);if(rw(a,20)){c=a;$wnd.alert(dh+B6(c))}else throw a}if(e.b.b==0)dL(e.e,fh,gh,-1);for(d=C8(new A8(),e.b);d.a<d.b.zb();){Bw(F8(d));dL(e.e,null.Bb(),eq+null.Bb(),-1)}DQ(e.e,Ae,eq+xG().clientHeight*0.8);e.e.x.size=14;DK(e.e,E1(new D1(),e));DQ(e.d,ze,hh);DQ(e.f,ze,ih);DQ(e.c,ze,ze)}
