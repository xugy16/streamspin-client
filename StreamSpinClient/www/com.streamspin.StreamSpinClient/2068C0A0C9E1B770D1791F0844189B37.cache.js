...
function BZ(a){if(lt(this.a.e.x,qc).length>0&&lt(this.a.d.x,qc).length>0){e1=lt(this.a.e.x,qc);d1=lt(this.a.d.x,qc);y1(v1(new j1()),8,this.a.o);r0(new l0(),this.a)}else{$wnd.alert(zf)}}
function xZ(){}
